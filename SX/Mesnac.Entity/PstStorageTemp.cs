...
namespace Mesnac.Entity
{
    ...
    public partial class PstStorageTempArrayList : NBear.Common.EntityArrayList<Mesnac.Entity.PstStorageTemp>
    {
    }
    ...
    [NBear.Common.EmbeddedEntityConfigurationAttribute("<?xml version=\"1.0\" encoding=\"utf-16\"?>\r\n<EntityConfiguration xmlns:xsi=\"http://w" +
        ...
        "name=\"Mesnac.Entity.PstStorageTemp\" isReadOnly=\"false\" isAutoPreLoad=\"false\" isB" +
        "atchUpdate=\"false\" isRelation=\"false\" mappingName=\"PstStorageTemp\" batchSize=\"10" +
        ...
        " />\r\n    <Property name=\"NewNum\" type=\"System.Nullable`1[System.Int32]\" isInheri" +
        ...
        "Name=\"NewNum\" mappingColumnType=\"System.Nullable`1[System.Int32]\" sqlType=\"int\" " +
        "isPrimaryKey=\"false\" isNotNull=\"false\" />\r\n    <Property name=\"NewWeight\" type=\"" +
        "System.Nullable`1[System.Decimal]\" isInherited=\"false\" isReadOnly=\"false\" isComp" +
        "oundUnit=\"false\" isContained=\"false\" isQuery=\"false\" isFriendKey=\"false\" isLazyL" +
        "oad=\"false\" isRelationKey=\"false\" isIndexProperty=\"false\" isIndexPropertyDesc=\"f" +
        "alse\" isSerializationIgnore=\"false\" mappingName=\"NewWeight\" mappingColumnType=\"S" +
        "ystem.Nullable`1[System.Decimal]\" sqlType=\"decimal\" isPrimaryKey=\"false\" isNotNu" +
        "ll=\"false\" />\r\n  </Properties>\r\n</EntityConfiguration>")]
    public partial class PstStorageTemp : NBear.Common.Entity
    {

        protected static NBear.Common.EntityConfiguration _PstStorageTempEntityConfiguration;
        ...
        protected global::System.Decimal? _NewWeight;

        public static @__Columns _ = new @__Columns();

        public static bool operator ==(global::Mesnac.Entity.PstStorageTemp left, global::Mesnac.Entity.PstStorageTemp right) { return ((object)left) != null ? left.Equals(right) : ((object)right) == null ? true : false; }


        public static bool operator !=(global::Mesnac.Entity.PstStorageTemp left, global::Mesnac.Entity.PstStorageTemp right) { return ((object)left) != null ? !left.Equals(right) : ((object)right) == null ? false : true; }
        ...
        public global::System.Decimal? NewWeight
        {
            get
            {
            ...
            set
            {
                this.OnPropertyChanged("NewWeight", this._NewWeight, value);
                this._NewWeight = value;
            }
        }

        public override NBear.Common.EntityConfiguration GetEntityConfiguration()
        {
            if ((PstStorageTemp._PstStorageTempEntityConfiguration == null))
            {
                PstStorageTemp._PstStorageTempEntityConfiguration = NBear.Common.MetaDataManager.GetEntityConfiguration("Mesnac.Entity.PstStorageTemp");
            }
            return PstStorageTemp._PstStorageTempEntityConfiguration;
        }
        ...
        public override void SetPropertyValues(System.Data.IDataReader reader)
        {
            ...
            {
                this._NewWeight = reader.GetDecimal(15);
            }
        ...
        public override void SetPropertyValues(System.Data.DataRow row)
        {
            ...
            {
                this._NewWeight = ((System.Nullable<decimal>)(row[15]));
            }
            this.ReloadQueries(false);
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if ((false == typeof(global::Mesnac.Entity.PstStorageTemp).IsAssignableFrom(obj.GetType())))
            {
                return false;
            }
            ...
            return ((this.isAttached && ((global::Mesnac.Entity.PstStorageTemp)(obj)).isAttached)
                        && base.Equals(obj));
        }
        ...
        public class @__Columns
        {
            ...
            protected NBear.Common.PropertyItem _Barcode = new NBear.Common.PropertyItem("Barcode", "Mesnac.Entity.PstStorageTemp");

            protected NBear.Common.PropertyItem _DeptCode = new NBear.Common.PropertyItem("DeptCode", "Mesnac.Entity.PstStorageTemp");

            protected NBear.Common.PropertyItem _DeptName = new NBear.Common.PropertyItem("DeptName", "Mesnac.Entity.PstStorageTemp");

            protected NBear.Common.PropertyItem _StorageID = new NBear.Common.PropertyItem("StorageID", "Mesnac.Entity.PstStorageTemp");

            protected NBear.Common.PropertyItem _StorageName = new NBear.Common.PropertyItem("StorageName", "Mesnac.Entity.PstStorageTemp");

            protected NBear.Common.PropertyItem _StoragePlaceID = new NBear.Common.PropertyItem("StoragePlaceID", "Mesnac.Entity.PstStorageTemp");

            protected NBear.Common.PropertyItem _StoragePlaceName = new NBear.Common.PropertyItem("StoragePlaceName", "Mesnac.Entity.PstStorageTemp");

            protected NBear.Common.PropertyItem _MaterCode = new NBear.Common.PropertyItem("MaterCode", "Mesnac.Entity.PstStorageTemp");

            protected NBear.Common.PropertyItem _MaterialName = new NBear.Common.PropertyItem("MaterialName", "Mesnac.Entity.PstStorageTemp");

            protected NBear.Common.PropertyItem _ProcDate = new NBear.Common.PropertyItem("ProcDate", "Mesnac.Entity.PstStorageTemp");

            protected NBear.Common.PropertyItem _InputDate = new NBear.Common.PropertyItem("InputDate", "Mesnac.Entity.PstStorageTemp");

            protected NBear.Common.PropertyItem _Num = new NBear.Common.PropertyItem("Num", "Mesnac.Entity.PstStorageTemp");

            protected NBear.Common.PropertyItem _RealWeight = new NBear.Common.PropertyItem("RealWeight", "Mesnac.Entity.PstStorageTemp");

            protected NBear.Common.PropertyItem _Remark = new NBear.Common.PropertyItem("Remark", "Mesnac.Entity.PstStorageTemp");

            protected NBear.Common.PropertyItem _NewNum = new NBear.Common.PropertyItem("NewNum", "Mesnac.Entity.PstStorageTemp");

            protected NBear.Common.PropertyItem _NewWeight = new NBear.Common.PropertyItem("NewWeight", "Mesnac.Entity.PstStorageTemp");
            ...
            public NBear.Common.PropertyItem NewWeight
            {
                get
                {
                    if ((aliasName == null))
                    ...
                    {
                        return new NBear.Common.PropertyItem("NewWeight", _NewWeight.EntityConfiguration, _NewWeight.PropertyConfiguration, aliasName);
                    }
                }
            }
        }
