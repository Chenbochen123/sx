...
namespace Mesnac.Entity {
    ...
    public partial class PpmStorageArrayList : NBear.Common.EntityArrayList<Mesnac.Entity.PpmStorage> {
    }
    
    [System.SerializableAttribute()]
    [NBear.Common.EmbeddedEntityConfigurationAttribute("<?xml version=\"1.0\" encoding=\"utf-16\"?>\r\n<EntityConfiguration xmlns:xsi=\"http://w" +
        "ww.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" " +
        "name=\"Mesnac.Entity.PpmStorage\" isReadOnly=\"false\" isAutoPreLoad=\"false\" isBatch" +
        "Update=\"false\" isRelation=\"false\" mappingName=\"PpmStorage\" batchSize=\"10\">\r\n  <P" +
        ...
        "perties>\r\n</EntityConfiguration>")]
    public partial class PpmStorage : NBear.Common.Entity {
        
        protected static NBear.Common.EntityConfiguration _PpmStorageEntityConfiguration;
		...
		public static bool operator ==(global::Mesnac.Entity.PpmStorage left, global::Mesnac.Entity.PpmStorage right) { return ((object)left) != null ? left.Equals(right) : ((object)right) == null ? true : false; }


		public static bool operator !=(global::Mesnac.Entity.PpmStorage left, global::Mesnac.Entity.PpmStorage right) { return ((object)left) != null ? !left.Equals(right) : ((object)right) == null ? false : true; }
        ...
        public override NBear.Common.EntityConfiguration GetEntityConfiguration() {
            if ((PpmStorage._PpmStorageEntityConfiguration == null)) {
                PpmStorage._PpmStorageEntityConfiguration = NBear.Common.MetaDataManager.GetEntityConfiguration("Mesnac.Entity.PpmStorage");
            }
            return PpmStorage._PpmStorageEntityConfiguration;
        }
        ...
        public override bool Equals(object obj) {
            ...
            if ((false == typeof(global::Mesnac.Entity.PpmStorage).IsAssignableFrom(obj.GetType()))) {
                return false;
            }
            if ((((object)(this)) == ((object)(obj)))) {
                return true;
            }
            return ((((this.isAttached && ((global::Mesnac.Entity.PpmStorage)(obj)).isAttached) 
                        && (this.Barcode == ((global::Mesnac.Entity.PpmStorage)(obj)).Barcode)) 
                        && (this.StorageID == ((global::Mesnac.Entity.PpmStorage)(obj)).StorageID)) 
                        && (this.StoragePlaceID == ((global::Mesnac.Entity.PpmStorage)(obj)).StoragePlaceID));
        }
        ...
        public class @__Columns {
            ...
            protected NBear.Common.PropertyItem _Barcode = new NBear.Common.PropertyItem("Barcode", "Mesnac.Entity.PpmStorage");
            
            protected NBear.Common.PropertyItem _StorageID = new NBear.Common.PropertyItem("StorageID", "Mesnac.Entity.PpmStorage");
            
            protected NBear.Common.PropertyItem _StoragePlaceID = new NBear.Common.PropertyItem("StoragePlaceID", "Mesnac.Entity.PpmStorage");
            
            protected NBear.Common.PropertyItem _ProductNo = new NBear.Common.PropertyItem("ProductNo", "Mesnac.Entity.PpmStorage");
            
            protected NBear.Common.PropertyItem _MaterCode = new NBear.Common.PropertyItem("MaterCode", "Mesnac.Entity.PpmStorage");
            
            protected NBear.Common.PropertyItem _ProcDate = new NBear.Common.PropertyItem("ProcDate", "Mesnac.Entity.PpmStorage");
            
            protected NBear.Common.PropertyItem _Num = new NBear.Common.PropertyItem("Num", "Mesnac.Entity.PpmStorage");
            
            protected NBear.Common.PropertyItem _PieceWeight = new NBear.Common.PropertyItem("PieceWeight", "Mesnac.Entity.PpmStorage");
            
            protected NBear.Common.PropertyItem _RealWeight = new NBear.Common.PropertyItem("RealWeight", "Mesnac.Entity.PpmStorage");
            
            protected NBear.Common.PropertyItem _RecordDate = new NBear.Common.PropertyItem("RecordDate", "Mesnac.Entity.PpmStorage");
            
            protected NBear.Common.PropertyItem _FactoryID = new NBear.Common.PropertyItem("FactoryID", "Mesnac.Entity.PpmStorage");
