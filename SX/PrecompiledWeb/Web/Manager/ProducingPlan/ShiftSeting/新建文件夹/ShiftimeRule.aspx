<%@ page language="C#" autoeventwireup="true" inherits="Manager_ProducingPlan_ShiftSeting_ShiftimeRule, App_Web_vi5vqyds" %>
            ...
            <ext:Panel ID="Panel8" runat="server" Region="South" Split="true">
                <Items>
                    <ext:GridPanel ID="gpShiftRule" runat="server" Title="规律" Height="230">
                        <Store>
                            <ext:Store ID="sShiftRule" runat="server" PageSize="99" OnReadData="ShiftRuleRefresh">
                                <Model>
                                    <ext:Model ID="Model3" IDProperty="ObjID" Name="PptSetTime" runat="server">
                                        <Fields>
                                            <ext:ModelField Name="ObjID" Type="Int" />
                        ...
                        <ColumnModel ID="ColumnModel3" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="Column9" runat="server" Text="中" Flex="1" DataIndex="ShiftClass1ID">
                                    <Editor>
                                ...
                                <ext:Column ID="Column11" runat="server" Text="夜" Flex="1" DataIndex="ShiftClass2ID">
                                    <Editor>
                                ...
                                <ext:Column ID="Column12" runat="server" Text="早" Flex="1" DataIndex="ShiftClass3ID">
                                    <Editor>
