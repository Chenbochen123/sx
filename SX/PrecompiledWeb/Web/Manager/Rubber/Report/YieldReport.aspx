<%@ page language="C#" autoeventwireup="true" inherits="Manager_Rubber_Report_YieldReport, App_Web_wycfotos" %>
                        ...
                        <Columns>
                            ...
                            <ext:Column ID="EquipName" runat="server" Text="机台" DataIndex="EquipName" Flex="1" />
                             <ext:Column ID="Column1" runat="server" Text="配方类型" DataIndex="itemname" Flex="1" />
                                <ext:Column ID="Column2" runat="server" Text="SAP版本号" DataIndex="sapversionid" Flex="1" />
