<%@ page language="C#" autoeventwireup="true" inherits="Manager_Rubber_Report_RubberStoreOutDetailReport, App_Web_wycfotos" %>
                        ...
                        <Items>
                            <ext:Container ID="container1" runat="server" Layout="FormLayout" ColumnWidth=".2"
                               ...
                               <ext:FieldContainer ID="FieldContainer1" runat="server" FieldLabel="扫描开始时间" Layout="HBoxLayout" LabelAlign="Right" Flex="1">
                                    ...
                                    <ext:ComboBox ID="cbxShiftClass" runat="server"  FieldLabel="班组"
                                        LabelAlign="Right">
                                        <Items>
                            ...
                            <ext:Container ID="container3" runat="server" Layout="FormLayout" ColumnWidth=".2"
                                Padding="5">
                                <Items>
                                    <ext:TriggerField ID="txtToStorageCheckName" runat="server" FieldLabel="领料单位" LabelAlign="Right"
                                        Flex="1" Editable="false">
                                        <Triggers>
                                            <ext:FieldTrigger Icon="Clear" HideTrigger="true" />
                                            <ext:FieldTrigger Icon="Search" />
