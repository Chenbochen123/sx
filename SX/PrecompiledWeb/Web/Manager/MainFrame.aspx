<%@ page language="C#" autoeventwireup="true" inherits="Manager_MainFrame, App_Web_wckwqw14" %>
...
<body>
    <iframe id ="iframe1" width="980px" frameborder="0" height="80px" runat="server" style="display:none"></iframe>
    ...
    <div id="foot_div" class='foot'>
      青岛弯弓信息技术有限公司&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;V&nbsp;<%= Vision() %>&nbsp;&nbsp;&nbsp;&nbsp;在线人数：<%Response.Write(Application["count"]); %>
    </div>
