<%@ page language="C#" autoeventwireup="true" inherits="Manager_BasicInfo_RubberInfo_RubberTyrePart, App_Web_npi04ekm" %>
    ...
    <form id="fmRubberType" runat="server">
        ...
        <ext:Viewport ID="vwUnit" runat="server" Layout="border">
            <Items>
                                ...
                                <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        ...
                                        <ext:Container ID="container_2" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:TextField ID="txt_tyre_part_name" runat="server" FieldLabel="部件名称" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                            ...
                            <Model>
                                <ext:Model ID="model" runat="server">
                                    <Fields>
                                        ...
                                        <ext:ModelField Name="TyrePartName" />
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="obj_id" runat="server" Text="部件编号" DataIndex="ObjID" Width="220"  />
                            <ext:Column ID="tyre_part_name" runat="server" Text="部件名称" DataIndex="TyrePartName" Width="220"  />
                ...
                <ext:Window ID="winModify" runat="server" Icon="MonitorEdit" Closable="false" Title="修改轮胎部件信息"
                    ...
                    <Items> 
                        <ext:FormPanel ID="pnlEdit" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                <ext:TextField ID="modify_obj_id" runat="server" FieldLabel="部件编号"   LabelAlign="Left" ReadOnly=true Hidden=true Enabled="true" />
                                <ext:TextField ID="modify_tyre_part_name" runat="server" FieldLabel="部件名称" MaxLength="25"  AllowBlank=false LabelAlign="Left" IsRemoteValidation="true" IndicatorText="*" IndicatorCls="red-text" >
                                     <RemoteValidation OnValidation="CheckTyrePart" />
                                </ext:TextField>
                ...
                <ext:Window ID="winAdd" runat="server" Icon="MonitorAdd" Closable="false" Title="添加轮胎部件信息"
                    Width="320" Height="240" Resizable="false" Hidden="true" Modal="false" BodyStyle="background-color:#fff;"
                    BodyPadding="5" Layout="Form">
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5">
                            ...
                            <Items>
                                <ext:TextField ID="add_tyre_part_name" runat="server" FieldLabel="部件名称" MaxLength="25" AllowBlank=false LabelAlign="Left" IsRemoteValidation="true" IndicatorText="*" IndicatorCls="red-text" >
                                    <RemoteValidation OnValidation="CheckTyrePart" />
                                </ext:TextField>
                ...
                <ext:Hidden ID="hidden_tyre_part_name" runat=server />
