<%@ page language="C#" autoeventwireup="true" inherits="Manager_BasicInfo_DepartmentInfo_Department, App_Web_fyhjs0sr" %>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="hr_code" runat="server" Text="HR编码" DataIndex="HRCode" Width="80"  />
                            <ext:Column ID="display_id" runat="server" Text="显示序号" DataIndex="DisplayId" Width="80"  />
                    ...
                    <Items> 
                        <ext:FormPanel ID="pnlEdit" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                ...
                                <ext:TriggerField ID="modify_erp_code" runat="server" FieldLabel="ERP编码" LabelAlign="Left" Editable="false"   >
                                                    <Triggers>
                                ...
                                <ext:TextField ID="modify_hr_code" runat="server" FieldLabel="HR编码" LabelAlign="Left" />
                    ...
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" MonitorValid="true" BodyPadding="5">
                            ...
                            <Items>
                                ...
                                <ext:TriggerField ID="add_erp_code" runat="server" FieldLabel="ERP编码" LabelAlign="Left" Editable="false"   >
                                                    <Triggers>
                                                        <ext:FieldTrigger Icon="Search" />
                                                    </Triggers>
                                                    <Listeners>
                                ...
                                <ext:TextField ID="add_hr_code" runat="server" FieldLabel="HR编码" LabelAlign="Left" />
