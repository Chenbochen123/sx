<%@ page language="C#" autoeventwireup="true" inherits="Manager_ShopStorage_RubInJar, App_Web_ampjtxsw" %>
    ...
    <script type="text/javascript">
        ...
        var Manager_BasicInfo_CommonPage_QueryBasUser_Request = function (record) {//用户返回值处理
            if (!App.winAdd.hidden) {
                ...
                App.hiddenUserID.setValue(record.data.UserName);
            }
                ...
                <TopBar>
                    <ext:Toolbar runat="server" ID="tbMminjar">
                        <Items>
                            ...
                            <ext:Button runat="server" Icon="LockEdit" Text="审核" ID="Button1">
                                <Listeners>
                        ...
                        <Model>
                            <ext:Model ID="model" runat="server" IDProperty="JarID">
                                <Fields>
                                    ...
                                    <ext:ModelField Name="handLename" />
                ...
                <ColumnModel ID="colModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column ID="RealWeight" runat="server" Text="投入重量" DataIndex="RealWeight" Flex="1" />
                          <ext:Column ID="Column1" runat="server" Text="已用重量" DataIndex="Usedweigh" Flex="1" />
                        <ext:Column ID="handLename" runat="server" Text="经办人" DataIndex="handLename" Flex="1" />
