<%@ page language="C#" autoeventwireup="true" inherits="Manager_Technology_Manage_MaterialRecipeDetail_Mixing, App_Web_a5rwyiqa" %>
                        ...
                        <ext:GridPanel ID="gridPanelMinxing" Region="Center" runat="server" Frame="true">
                            ...
                            <ColumnModel ID="columnModel" runat="server">
                                ...
                                <Columns>
                                    ...
                                    <ext:Column ID="TermCode" DataIndex="TermCode" runat="server" Text="条件设定" Width="200" Sortable="false" FocusOnToFront>
                                        <Editor>
                                    ...
                                    <ext:Column ID="MixingTime" DataIndex="MixingTime" runat="server" DecimalPrecision="0" Text="时间" Align="Center" Width="60" Sortable="false">
                                        <Editor>
                                    ...
                                    <ext:Column ID="MixingTemp" DataIndex="MixingTemp" runat="server" DecimalPrecision="0" Text="温度" Align="Center" Width="60" Sortable="false">
                                        <Editor>
                                            <ext:NumberField ID="NumberField4" runat="server" />
                                        </Editor>
                                        <Renderer Handler="if (!value){return ''};if (value==0) {return '';} else {return value;}" />
                                    </ext:Column>
                                    <ext:Column ID="MixingEnergy" DataIndex="MixingEnergy" runat="server" DecimalPrecision="0" Text="能量" Align="Center" Width="60" Sortable="false">
                                        <Editor>
                                            <ext:NumberField ID="NumberField5" runat="server" />
                                        </Editor>
                                        <Renderer Handler="if (!value){return ''};if (value==0) {return '';} else {return value;}" />
                                    </ext:Column>
                                    <ext:Column ID="MixingPower" DataIndex="MixingPower" runat="server" DecimalPrecision="0" Text="功率" Align="Center" Width="60" Sortable="false">
                                        <Editor>
                                            <ext:NumberField ID="NumberField6" runat="server" />
                                        </Editor>
                                        <Renderer Handler="if (!value){return ''}; if (value==0) {return '';} else {return value;}" />
                                    </ext:Column>
                                    <ext:Column ID="ActionCode" DataIndex="ActionCode" runat="server" Text="动作" Width="200" Sortable="false">
                                        <Editor>
                                    ...
                                    <ext:Column ID="MixingSpeed" DataIndex="MixingSpeed" runat="server" Text="转速" DecimalPrecision="0" Align="Center" Width="60" Sortable="false" ToolTip="单机表头可批量修改">
                                        <Editor>
                                            <ext:NumberField ID="NumberField7" runat="server" MinValue="0" />
                                        </Editor>
                                        <Renderer Handler="if (!value){return ''}; if (value==0) {return '';} else {return value;}" />
                                    </ext:Column>
                                    <ext:Column ID="MixingPress" DataIndex="MixingPress" runat="server" Text="压力" DecimalPrecision="0" Align="Center" Width="60" Sortable="false" ToolTip="单机表头可批量修改">
                                        <Editor>
