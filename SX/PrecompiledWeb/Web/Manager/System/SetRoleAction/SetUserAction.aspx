<%@ page language="C#" autoeventwireup="true" inherits="Manager_System_SetRoleAction_SetUserAction, App_Web_5whikgut" %>
                        ...
                        <ext:GridPanel ID="GridPanel1" runat="server" Flex="2" Region="Center" Collapsible="false" MultiSelect="true" FolderSort="true"
                            ...
                            <ColumnModel ID="columnModel" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="DeptCode" DataIndex="DeptCode" runat="server" Text="部门" Flex="1" />
                                </Columns>
                            </ColumnModel>
                            <SelectionModel>
