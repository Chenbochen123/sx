<%@ page language="C#" autoeventwireup="true" inherits="Manager_RubberQuality_BasicInfo_DealNotion, App_Web_1dvad4ic" %>
...
<body>
    ...
    <ext:Viewport ID="vwUnit" runat="server" Layout="border">
        <Items>
            ...
            <ext:Panel ID="pnlMainType" runat="server" Region="North" AutoHeight="true">
                ...
                <Items>
                    <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                        ...
                        <Items>
                            <ext:TextField ID="txtDealNotion" runat="server" FieldLabel="处理方式" LabelAlign="Right">
                                <ToolTips>
            ...
            <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                ...
                <ColumnModel ID="colModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column ID="clMainTypeName" runat="server" Text="处理方式" DataIndex="DealNotion"
                            Width="150" />
                        <ext:Column ID="Column1" runat="server" Text="备注" DataIndex="Remark" Width="200" />
            ...
            <ext:Window ID="winSave" runat="server" Icon="MonitorAdd" Closable="false" Title="维护处理方式"
                ...
                <Items>
                    <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5">
                        ...
                        <Items>
                            <ext:TextField ID="txtObjID" runat="server" FieldLabel="编号" LabelAlign="Right" Text=""
                                Disabled="true" EmptyText="自动生成" AllowBlank="true" />
                            <ext:TextField ID="txtDeal" runat="server" FieldLabel="处理方式" AllowBlank="false" LabelAlign="Right"
                                MaxLength="50" />
