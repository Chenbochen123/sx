<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Manager_Technology_Manage_MaterialRecipeDetail_Default" %>
                        ...
                        <ext:Toolbar runat="server" ID="barUser">
                            <Items>
                                ...
                                <ext:Button runat="server" Icon="DiskEdit" Text="编辑" ID="btnCanSave">
                                    <Listeners>
                                        <Click Handler="SetCanSave(1);"></Click>
                                    </Listeners>
                                </ext:Button>
                                ...
                                <ext:Button runat="server" Icon="DiskEdit" Text="编辑工艺" ID="btnCanSaveNew">
                                    <Listeners>
                                        <Click Handler="SetCanSave(2);"></Click>
                                    </Listeners>
                                </ext:Button>

                                <ext:Button runat="server" ID="btnEditSuJieJiWeight" Icon="BrickEdit" Text="车间调整权限" Visible= "false">
                                    <Listeners>
