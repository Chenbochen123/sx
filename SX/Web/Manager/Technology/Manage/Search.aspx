<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Search.aspx.cs" Inherits="Manager_Technology_Manage_Search" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_delete = function (btn, record) {
            ...
            App.direct.pnlList_Delete(record.data.RecipeEquipCode, record.data.RecipeMaterialCode, record.data.RecipeVersionID, {
                        ...
                        <ext:Container ID="container1" runat="server" Layout="AnchorLayout" AutoHeight="true" Padding="5">
                            <Items>
                                <ext:Container ID="container4" runat="server" Layout="HBoxLayout" Padding="5">
                                    <Items>
                                        <ext:DateField ID="txtBeginTime" runat="server" FieldLabel="修改开始时间" Flex="1" LabelAlign="Right" Hidden="true"/>
                                        <ext:DateField ID="txtEndTime" runat="server" FieldLabel="修改结束时间" Flex="1" LabelAlign="Right" Hidden="true"  />
                        ...
                        <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center" Frame="true" Title="机台配方基本信息">
                            <Store>
                                <ext:Store ID="store" runat="server" PageSize="50">
                                    ...
                                    <Model>
                                        <ext:Model ID="model" runat="server" Name="gridPanelCenterStoreModel" IDProperty="RecipeEquipCode,RecipeMaterialCode,RecipeVersionID">
                                            <Fields>
                            ...
                            <ext:CommandColumn ID="cmdCol" runat="server" Align="Center" Text="操作" Width="65">
                                <Commands>
                                    <ext:GridCommand Icon="TableDelete" CommandName="Delete" Text="删除" />
                                </Commands>
                                <Listeners>
                                    <Command Handler="return cmdcol_click(command, record);" />
                                </Listeners>
                            </ext:CommandColumn>
                                </Columns>
                            </ColumnModel>
                            ...
                            <TopBar>
                                <ext:Toolbar runat="server" ID="Toolbar1">
                                    <Items>
                                        ...
                                        <ext:Button runat="server" Icon="BookEdit" Text="修改车数" ID="Button1" TextAlign="Left" Flex="1">
                                            <Listeners>
                                                <Click Fn="Save2"></Click>
                                            </Listeners>
                                        </ext:Button>
                                    </Items>
                                </ext:Toolbar>
                                    ...
                                    <Items>
                                        <ext:CheckboxGroup ID="CheckboxGroup4" runat="server" ColumnsNumber="1" Flex="1" AnchorHorizontal="true">
                                            <Items>
                                                ...
                                                <ext:TextField runat="server" ReadOnly="false" Flex="1" LabelAlign="Right" FieldLabel="每架车数" Name="ShelfLotCount" AllowBlank="false" ID="txtcheshu"/>
                                                ...
                                                <ext:TextField runat="server" ReadOnly="true" Flex="1" LabelAlign="Right" FieldLabel="工艺版本号" Name="RearchCode" />
                                                <ext:TextField runat="server" ReadOnly="true" Flex="1" LabelAlign="Right" FieldLabel="用户版本号" Name="UseredtCode" />
