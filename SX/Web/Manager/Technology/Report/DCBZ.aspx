<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DCBZ.aspx.cs" Inherits="Manager_Technology_Report_DCBZ" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_edit = function (record) {
            ...
            App.modifyRecipeType.setValue(record.data.RecipeType);
            App.modifyDCTime.setValue(record.data.BZTime);
            App.modifyJZTime.setValue(record.data.JZTime);
...
<body>
            ...
            <Items>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                           ...
                           <ext:Column ID="Column1" runat="server" Text="配方类型" DataIndex="ItemName" Width="150"  />
                             <ext:Column ID="Column2" runat="server" Text="单次时间" DataIndex="BZTime" Width="150"  />
                            <ext:Column ID="Column3" runat="server" Text="进胶时间" DataIndex="JZTime" Width="150"  />
                ...
                <ext:Window ID="winModify" runat="server" Icon="MonitorEdit" Closable="false" Title="修改信息"
                    ...
                    <Items> 
                        ...
                        <ext:ComboBox ID="modifyRecipeType" runat="server" Flex="1" FieldLabel="配方类型"  LabelAlign="Left" SelectOnTab="true" Editable="false"   ReadOnly ="true"/>
                      
                               <ext:TextField ID="modifyDCTime" runat="server" FieldLabel="单次时间" AllowBlank=false LabelAlign="Left" IndicatorText="*" IndicatorCls="red-text"  />
                                <ext:TextField ID="modifyJZTime" runat="server" FieldLabel="进胶时间" LabelAlign="Left" />
                           </Items>
                             <Listeners>
 ...
 <ext:ComboBox ID="addRecipeType" runat="server" LabelAlign="left" Flex="1" FieldLabel="配方类型" SelectOnTab="true" Editable="false" />
                                ...
                                <ext:TextField ID="add_DCTime" runat="server" FieldLabel="单次时间" AllowBlank=false LabelAlign="Left" IndicatorText="*" IndicatorCls="red-text"  />
                                <ext:TextField ID="add_JZTime" runat="server" FieldLabel="进胶时间" LabelAlign="Left" />
                                                     </Items>
                            <Listeners>
