<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConReport.aspx.cs" Inherits="Manager_Technology_Report_ConReport" %>
                            ...
                            <ext:Model ID="model" runat="server">
                                <Fields>
                                   ...
                                   <ext:ModelField Name="planid" />
                                      ...
                                      <ext:ModelField Name="sumDoneAllRtime" />

                                      <ext:ModelField Name="sumDoneRtime" />
                                      <ext:ModelField Name="sumBwbTime" />
                                      <ext:ModelField Name="sumrealweight" />
                                          <ext:ModelField Name="avgrealweight" />
                ...
                <ColumnModel ID="colModel" runat="server">
                    <Columns>
                        <ext:RowNumbererColumn ID="rowNumCol" runat="server" Width="35" />
                         <ext:Column ID="RecipeMaterialName" runat="server" Text="计划编号" DataIndex="planid" Width="135"/>
                          <ext:Column ID="Column3" runat="server" Text="配方名称" DataIndex="matername" Width="135"/>
                          <ext:Column ID="EquipName" runat="server" Text="机台名称" DataIndex="equipname" Width="135"/>
                          <ext:Column ID="LotTotalWeight" runat="server" Text="班次"  DataIndex="shiftname" Width="135" />
                          <ext:Column ID="Column1" runat="server" Text="配方时间"  DataIndex="sumDoneAllRtime" Width="135" />
                          <ext:Column ID="Column2" runat="server" Text="炼胶时间"  DataIndex="sumDoneRtime" Width="135" />
                            <ext:Column ID="Column4" runat="server" Text="间隔时间"  DataIndex="sumBwbTime" Width="135" />
                                         <ext:Column ID="Column6" runat="server" Text="均重"  DataIndex="avgrealweight" Width="135" />
                              <ext:Column ID="Column5" runat="server" Text="总重"  DataIndex="sumrealweight" Width="135" />
                                           <ext:Column ID="Column7" runat="server" Text="数量"  DataIndex="num" Width="135" />
