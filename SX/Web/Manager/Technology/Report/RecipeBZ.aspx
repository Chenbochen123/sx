<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecipeBZ.aspx.cs" Inherits="Manager_Technology_Report_RecipeBZ" %>
...
<body>
            ...
            <Items>
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                           ...
                           <ext:Column ID="Column1" runat="server" Text="配方类型" DataIndex="ItemName" Width="150"  />
                             <ext:Column ID="Column2" runat="server" Text="标准配方时间" DataIndex="BZTime" Width="150"  />
                ...
                <ext:Window ID="winModify" runat="server" Icon="MonitorEdit" Closable="false" Title="修改信息"
                    ...
                    <Items> 
                        ...
                        <ext:ComboBox ID="modifyRecipeType" runat="server" LabelAlign="Right" Flex="1" FieldLabel="配方类型" SelectOnTab="true" Editable="false" />
                      
                               <ext:TextField ID="modifyDCTime" runat="server" FieldLabel="标准配方时间" AllowBlank=false LabelAlign="Left" IndicatorText="*" IndicatorCls="red-text"  />
 ...
 <ext:ComboBox ID="addRecipeType" runat="server" LabelAlign="left" Flex="1" FieldLabel="配方类型" SelectOnTab="true" Editable="false" />
                                ...
                                <ext:TextField ID="add_DCTime" runat="server" FieldLabel="标准配方时间" AllowBlank=false LabelAlign="Left" IndicatorText="*" IndicatorCls="red-text"  />
                                                     </Items>
                            <Listeners>
