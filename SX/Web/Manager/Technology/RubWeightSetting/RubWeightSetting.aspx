<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RubWeightSetting.aspx.cs" Inherits="Manager_Technology_RubWeightSetting_RubWeightSetting" %>
                ...
                <ext:Window ID="winModify" runat="server" Icon="MonitorEdit" Closable="false" Title="修改设备胶料称锁定信息"
                    ...
                    <Items> 
                        ...
                        <ext:FormPanel ID="pnlNotice" runat="server" Width="125" BodyPadding="5" Margins="0 0 0 6">
                            <Items>
                                <ext:TextArea runat="server" Height="157" ReadOnly="true"
Text="101 天然胶
102 合成胶
103 再生胶
104 其他原材料
