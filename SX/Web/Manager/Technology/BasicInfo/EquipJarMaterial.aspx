<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EquipJarMaterial.aspx.cs" Inherits="Manager_Technology_BasicInfo_EquipJarMaterial" %>
                                    ...
                                    <Items>
                                        <ext:Container ID="container2" runat="server" Layout="FormLayout" Padding="5" ColumnWidth=".45">
                                            <Items>
                                                ...
                                                <ext:TriggerField ID="txtMaterialMinorName" runat="server" FieldLabel="物料细类" LabelAlign="Right" Editable="false" Hidden="true">
                                                    <Triggers>
                      ...
                      <%--              <ext:Column ID="Priority" DataIndex="Priority" runat="server" Text="料仓优先级" Width="80" />
                                    ...
                                    <ext:CommandColumn ID="commandCol" runat="server" Width="60" Text="操作" Align="Center">
                                        <Commands>
                                            ...
                                            <ext:GridCommand Icon="TableDelete" CommandName="Delete" Text="清空" Hidden="true">
                                                <ToolTip Text="清空本条数据" />
                                            </ext:GridCommand>
                                        </Commands>
                                        <PrepareToolbar />
                            ...
                            <Items>
                                <ext:Container ID="container11" runat="server" Layout="FormLayout" Padding="5" ColumnWidth=".5">
                                    <Items>
                                        ...
                                        <ext:TextField ID="TextJarNum" runat="server" LabelAlign="Right" FieldLabel="料仓号" />
                                    </Items>
                                </ext:Container>
                                ...
                                <ext:Container ID="container14" runat="server" Layout="FormLayout" Padding="5" ColumnWidth=".5">
                                    <Items>
                                     <ext:TriggerField ID="winModifytxtMaterialName" runat="server" FieldLabel="物料名称" LabelAlign="Right" Editable="false">
                                        ...
                                        <ext:TriggerField ID="winModifytxtStorageName" runat="server" FieldLabel="仓库名称" LabelAlign="Right" Editable="false"  Hidden="true">
                                            <Triggers>
                                                <ext:FieldTrigger Icon="Search" />
                                            </Triggers>
                                            <Listeners>
                                        ...
                                        <ext:TriggerField ID="winModifytxtStoragePlaceName" runat="server" FieldLabel="库位名称" LabelAlign="Right" Editable="false"  Hidden="true">
                                            <Triggers>
                                                <ext:FieldTrigger Icon="Search" />
                                            </Triggers>
                                            <Listeners>
                                        ...
                                        <ext:TextField ID="winModifytxtWork" runat="server" LabelAlign="Right" FieldLabel="工位" ReadOnly="false"  Hidden="true" />
                                            <ext:NumberField ID="TextWeight" runat="server" LabelAlign="Right" FieldLabel="最大单包重量kg" ReadOnly="false"  Hidden="true"/>
                                    </Items>
                                </ext:Container>
                                <ext:Container ID="container15" runat="server" Layout="FormLayout" Padding="5" ColumnWidth=".5">
                                    <Items>
                                       
                                        <ext:Checkbox ID="winMadifycbDeleteFlag" runat="server" LabelAlign="Right" FieldLabel="是否可用" Checked="true"  Hidden="true" />
                                     <ext:TextField ID="TextCD" runat="server" LabelAlign="Right" FieldLabel="产地（6位数字加|间隔）" ReadOnly="false"  Hidden="true"/>
                                    </Items>
                                </ext:Container>
                            </Items>
                        </ext:Container>
