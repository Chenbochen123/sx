<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RubberSplitReset.aspx.cs" Inherits="Manager_ShopStorage_RubberSplitReset" %>
...
<body>
    ...
    <ext:ResourceManager ID="rmChkBill" runat="server" />
        ...
        <Items>
                    ...
                    <ext:Toolbar runat="server" ID="tbStorage">
                        <Items>
                           ...
                           <%-- <ext:ToolbarSeparator ID="tsMiddle" />
                            <ext:Button runat="server" Icon="LockEdit" Text="解锁" ID="Button1">
                                <DirectEvents>
                                    <Click OnEvent="btnUnLock_Click">
                                        <EventMask ShowMask="true" Msg="解锁..." MinDelay="50">
                                        </EventMask>
                                    </Click>
                                </DirectEvents>
                            </ext:Button>
                    ...
                    <ext:GridPanel ID="pnlList" runat="server" Cls="x-grid-custom" Region="Center">
                        <Store>
                            <ext:Store ID="store" runat="server" PageSize="10" AutoLoad="false">
                                ...
                                <Model>
                                    <ext:Model ID="model" runat="server" IDProperty="BarcodeSplit">
                                        <Fields>
                                            ...
                                            <ext:ModelField Name="ShelfID" />
                                            <ext:ModelField Name="FState"  />
                        ...
                        <ColumnModel ID="colModel" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="Column5" runat="server" Text="状态" DataIndex="FState" />
                                <ext:Column ID="Column1" runat="server" Text="拆分条码号" DataIndex="BarcodeSplit" Width="140" />
                                <ext:Column ID="Barcode" runat="server" Text="条码号" DataIndex="Barcode" Width="140" />
                                <ext:Column ID="Column45" runat="server" Text="架子号" DataIndex="ShelfID" />
                                ...
                                <ext:Column ID="Column2" runat="server" Text="重量" DataIndex="Weight" Flex="1" />
                                <ext:Column ID="Column3" runat="server" Text="操作日期" DataIndex="OperTime" Flex="1" />
                            ...
                            <ext:RowSelectionModel ID="rowSelectMuti" runat="server" Mode="Single">
                                <DirectEvents>
                                    <SelectionChange OnEvent="rowSelectMuti_SelectionChange">
                                        <ExtraParams>
                                            <ext:Parameter Name="BarcodeSplit" Value="selected[0].get('BarcodeSplit')" Mode="Raw" />
                                        </ExtraParams>
                                    </SelectionChange>
                                </DirectEvents>
            ...
            <ext:Hidden ID="hiddenBarcodeSplit" runat="server"></ext:Hidden>
        </Items>
    </ext:Viewport>
    </form>
</body>
