<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShopAdjust.aspx.cs" Inherits="Manager_ShopStorage_ShopAdjust" %>
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server" ID="tbShopAdjust">
                            <Items>
                                ...
                                <ext:Button runat="server" Icon="LockEdit" Text="撤销调拨" ID="Button2">
                                    <Listeners>
                                        <Click Handler="CancelShopAdjust();" />
                                    </Listeners>
                                </ext:Button>
                                    ...
                                    <DirectEvents>
                                        <SelectionChange OnEvent="rowSelectMuti_SelectionChange">
                                            <ExtraParams>
                                                ...
                                                <ext:Parameter Name="OrderID" Value="selected[0].get('OrderID')" Mode="Raw" />
                                            </ExtraParams>
                                        </SelectionChange>
                                    </DirectEvents>
