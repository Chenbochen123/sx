<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterialStoreIn.aspx.cs" Inherits="Manager_Storage_MaterialStoreIn" %>
                ...
                <TopBar>
                    <ext:Toolbar runat="server" ID="tbChkBill">
                        <Items>
                            ...
                            <ext:Button runat="server" Icon="LockEdit" Text="审核入库" ID="Button1">
                                <Listeners>
                        ...
                        <ext:GridPanel ID="pnlList" runat="server">
                            ...
                            <ColumnModel ID="colModel" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="lockedFlag" runat="server" Text="是否入库" DataIndex="LockedFlag" Flex="1">
                                    ...
                                    <ext:CommandColumn ID="commandCol" runat="server" Width="120" Text="操作" Align="Center">
                                        <Commands>
                                            ...
                                            <ext:GridCommand Icon="TableEdit" CommandName="Filed" Text="归档" Hidden="true" />
                                            <ext:CommandSeparator />
                                        </Commands>
