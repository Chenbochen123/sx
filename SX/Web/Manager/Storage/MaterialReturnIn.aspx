<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterialReturnIn.aspx.cs" Inherits="Manager_Storage_MaterialReturnIn" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_edit = function (record) {
            ...
            var url = "Storage/MaterialReturnInInsert.aspx?BillNo=" + BillNo;
            var tabid = "Manager_Storage_MaterialReturnInInsert";
        ...
        var commandcolumn_direct_chkresultflag = function (btn) {
            ...
            App.direct.btnBatchChk_Click({
                success: function (result) {
                    if (result == "false1") {
                        Ext.Msg.alert('操作', "退库日期已经超出库房的期间，请检查！");
                        return;
                    }
        ...
        var SendChkResultFlag = function () {
            ...
            if (section && section.length == 0) {
                ...
                Ext.Msg.confirm("提示", '确定要审核退库吗？', function (btn) { commandcolumn_direct_chkresultflag(btn) });
            }
        }
        ...
        var commandcolumn_direct_cancelchkresult = function (btn) {
            ...
            App.direct.btnCancelChk_Click({
                success: function (result) {
                    if (result == "false1") {
                        Ext.Msg.alert('操作', "退库日期已经超出库房的期间，不能撤销！");
                        return;
                    }
                    else if (result == "false") {
                        Ext.Msg.alert('操作', "库存数量不足，不能撤销退库！");
                        return;
                    }
    ...
    <ext:Viewport ID="vpChkBill" runat="server" Layout="border">
        <Items>
            <ext:Panel ID="pnChkBill" runat="server" Region="North" Height="90">
                <TopBar>
                    <ext:Toolbar runat="server" ID="tbChkBill">
                        <Items>
                            ...
                            <ext:Button runat="server" Icon="LockEdit" Text="审核退库" ID="Button1">
                                <Listeners>
                    ...
                    <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                        <Items>
                            <ext:Container ID="container1" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                Padding="5">
                                <Items>
                                    <ext:TextField ID="txtBillNo" runat="server" FieldLabel="退库单号" LabelAlign="Right" />
                            ...
                            <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                Padding="5">
                                <Items>
                                    <ext:TriggerField ID="txtFactoryID" runat="server" FieldLabel="退回厂家" LabelAlign="Right"
                                        Editable="false">
                                        <Triggers>
                            ...
                            <ext:Container ID="container3" runat="server" Layout="FormLayout" ColumnWidth=".34"
                                Padding="5">
                                <Items>
                                    <ext:ComboBox ID="cbxFiledFlag" OnDirectChange="cbxFiledFlag_change" runat="server" FieldLabel="是否归档" LabelAlign="Right" Visible="false">
                                        <SelectedItems>
                        ...
                        <ext:GridPanel ID="pnlList" runat="server">
                                    ...
                                    <Model>
                                        <ext:Model ID="model" runat="server" IDProperty="BillNo">
                                            <Fields>
                                                ...
                                                <ext:ModelField Name="ReturninDate" Type="Date" />
                            ...
                            <ColumnModel ID="colModel" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="billNo" runat="server" Text="退库单号" DataIndex="BillNo" Flex="1" />
                                    ...
                                    <ext:DateColumn ID="returninDate" runat="server" Text="退库日期" DataIndex="ReturninDate"
                                    ...
                                    <ext:Column ID="lockedFlag" runat="server" Text="是否退库" DataIndex="LockedFlag" Flex="1">
                ...
                <ext:Panel ID="pnlSouth" runat="server" Region="South" Title="退货单明细数据" Height="200" Icon="Basket" Layout="Fit" Collapsible="true" 
                        ...
                        <ext:GridPanel ID="pnlDetailList" runat="server" MarginsSummary="0 5 5 5">
                            ...
                            <ColumnModel ID="ColumnModelDetail" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="InputWeight" runat="server" Text="实际重量" DataIndex="ReturninWeight" Flex="1" />
                                </Columns>
                            </ColumnModel>
                            <SelectionModel>
