<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterialStorageAdjustPrint.aspx.cs" Inherits="Manager_Storage_MaterialStorageAdjustPrint" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        var btnPrint_Click = function () {
            var url = "Storage/BarcodePrint.aspx?Str=" + App.hiddenBillNo.getValue() + "," + App.hiddenStorageID.getValue() + "," + App.hiddenStoragePlaceID.getValue() + "," + App.txtBarcode1.getValue() + "," + App.hiddenOrderID.getValue() + "," + App.txtShelfPieceWeight1.getValue() + "," + App.txtNum1.getValue() + "," + App.txtFacBarcode1.getValue() + "," + App.txtInBarcode1.getValue() + "," + App.txtBatch1.getValue() + "," + App.txtProductPlace1.getValue() + "," + App.txtChkDate1.getValue().toLocaleString().substring(0, 11) + "," + App.txtStartNum1.getValue(); 
    ...
    <ext:Viewport ID="vpPrint" runat="server" Layout="border">
        <Items>
                    ...
                    <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                        <Items>
                            <ext:Container ID="container1" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                Padding="5">
                                <Items>
                                    <ext:TextField ID="txtBillNo" runat="server" FieldLabel="调拨单号" LabelAlign="Right" />
                    ...
                    <ext:GridPanel ID="pnlList" runat="server">
                                ...
                                <Model>
                                    <ext:Model ID="model" runat="server" IDProperty="BillNo,Barcode">
                                        <Fields>
                                            ...
                                            <ext:ModelField Name="AdjustWeight" />
                        ...
                        <ColumnModel ID="colModel" runat="server">
                            <Columns>
                                ...
                                <ext:DateColumn ID="inStockDate" runat="server" Text="调拨日期" DataIndex="AdjustDate" Flex="1" Format="yyyy-MM-dd HH:mm:ss" />
                                <ext:Column ID="StorageName" runat="server" Text="库房" DataIndex="StorageName" Flex="1" />
                                <ext:Column ID="AdjustNum" runat="server" Text="数量" DataIndex="AdjustNum" Flex="1" />
                                <ext:Column ID="AdjustWeight" runat="server" Text="重量" DataIndex="AdjustWeight" Flex="1" />
            ...
            <ext:Window ID="winSet" runat="server" Icon="MonitorEdit" Closable="true" Title="生成流转卡设置"
                Width="320" Height="425" Resizable="false" Hidden="true" Modal="false" BodyStyle="background-color:#fff;"
                ...
                <Items>
                    <ext:FormPanel ID="FormPanel1" runat="server" BodyPadding="5">
                        ...
                        <Items>
                            <ext:TextField ID="txtBillNo1" runat="server" FieldLabel="单据号" ReadOnly="true" Visible="false" />
                            ...
                            <ext:DateField ID="txtChkDate1" runat="server" FieldLabel="检验时间" />
                            ...
                            <ext:TextField ID="txtStartNum1" runat="server" FieldLabel="起始流水号" Vtype="integer" LabelAlign="Left" IndicatorText="*" IndicatorCls="red-text" AllowBlank="false" Text="1" />
                        </Items>
                        <Listeners>
