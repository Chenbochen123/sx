<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterialChkPassed.aspx.cs" Inherits="Manager_Storage_RedirectPage_MaterialChkPassed" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryMaterial_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryMaterial_Window.close();
            return false;
        }
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="material_code" runat="server" Text="物料编码" DataIndex="MaterialCode" Width="170"  />
                            <ext:Column ID="material_name" runat="server" Text="物料名称" DataIndex="MaterialName" Width="90"  />
