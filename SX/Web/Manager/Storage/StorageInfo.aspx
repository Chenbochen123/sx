<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageInfo.aspx.cs" Inherits="Manager_Storage_StorageInfo" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var gridPanelCellDblClick = function (grid, td, tdindex, record, tr, trindex, e, fn) {
            ...
            if (record.data.BillType == "1003") {//领料单详情
                ...
                parent.addTab(tabid, "领料单查询", url, true);
            }
                        ...
                        <Items>
                            <ext:Container ID="container1" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                ...
                                <Items>
                                    ...
                                    <ext:TextField ID="txtBarcode" runat="server" FieldLabel="条码号" LabelAlign="Left" />
                                         <%--  <ext:DateField ID="txtBeginTime" runat="server" FieldLabel="入库开始时间" LabelAlign="Left" Editable="false" />--%>
                            ...
                            <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                ...
                                <Items>
                                    ...
                                    <ext:TextField ID="txtFactory" runat="server" FieldLabel="供应商" LabelAlign="Left" />
                                       <ext:Checkbox ID="Checkbox1" runat="server" BoxLabelAlign="After" OnDirectCheck="Search_Change" BoxLabel="只显示过期和即将过期数据" Checked="false" />
                              
                                       <%--       <ext:DateField ID="txtEndTime" runat="server" FieldLabel="入库结束时间" LabelAlign="left" Editable="false" />--%>
                    ...
                    <ext:GridPanel ID="pnlList" runat="server">
                        ...
                        <ColumnModel ID="colModel" runat="server">
                            ...
                            <Columns>
                                ...
                                <ext:Column ID="Column1" runat="server" Text="批次" DataIndex="Batch" Width="70" />
                                ...
                                <ext:Column ID="Status" runat="server" Text="使用状态" DataIndex="Status" Flex="1" />
