...
public partial class Manager_Storage_MaterialStorageAdjustInsert : Mesnac.Web.UI.Page
{
    ...
    protected void AddStoreIn(object sender, DirectEventArgs e)
    {
        ...
        {
            PstStorage storage = storageManager.GetListByWhere(PstStorage._.Barcode == pstStorages.Updated[i].Barcode && PstStorage._.StorageID == hiddenSourceStorageID.Text && PstStorage._.StoragePlaceID == hiddenSourceStoragePlaceID.Text)[0];
    ...
    public string IsEdit()
    {
        try
        {
            PstMaterialAdjust adjust = adjustManager.GetById(hiddenBillNo.Text);

            if (adjust.ChkResultFlag == "1")
                return "false";
            else
                return "true";
        }
    ...
    public string btnSave_Click()
    {
        ...
        {
            PstStorage storage = storageManager.GetListByWhere(PstStorage._.Barcode == adjustDetailCounts[i].Barcode && PstStorage._.StorageID == hiddenSourceStorageID.Text && PstStorage._.StoragePlaceID == adjustDetailCounts[i].SourceStoragePlace)[0];
