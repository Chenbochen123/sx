<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterialStorageAdjust.aspx.cs" Inherits="Manager_Storage_MaterialStorageAdjust" %>
                            ...
                            <ext:Container ID="container3" runat="server" Layout="FormLayout" ColumnWidth=".34"
                                ...
                                <Items>
                                    ...
                                    <ext:TextField ID="txtSAPBillNo" runat="server" FieldLabel="SAP单号" LabelAlign="Right" />
                                      <ext:TextField ID="TextField1" runat="server" FieldLabel="源库房" LabelAlign="Right" />
                                </Items>
                            </ext:Container>
                        </Items>
                        <Listeners>
                            ...
                            <Columns>
                                ...
                                <ext:DateColumn ID="inStockDate" runat="server" Text="领料日期" DataIndex="AdjustDate"
                                 ...
                                 <ext:Column ID="SourceStorageName" runat="server" Text="源库房" DataIndex="SourceStorageName" Flex="1" />
                                     <ext:Column ID="Column2" runat="server" Text="源库位" DataIndex="SourceStoragePlaceName" Flex="1" />
                                    <ext:Column ID="TargetStorageName" runat="server" Text="目的库房" DataIndex="TargetStorageName" Flex="1" />
                                <ext:Column ID="Column3" runat="server" Text="目的库位" DataIndex="TargetStoragePlaceName" Flex="1" />
