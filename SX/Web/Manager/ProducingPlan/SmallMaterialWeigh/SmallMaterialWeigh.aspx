<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SmallMaterialWeigh.aspx.cs"
    Inherits="Manager_ProducingPlan_SmallMaterialWeigh_SmallMaterialWeigh" %>
                    ...
                    <ext:GridPanel ID="pnlList" runat="server">
                                ...
                                <Model>
                                    <ext:Model ID="model" runat="server" IDProperty="PlanID">
                                        <Fields>
                                            ...
                                            <ext:ModelField Name="RealStartTime"  Type="String" />
                                            <ext:ModelField Name="RealEndtime"  Type="String" />
                                        </Fields>
                                    </ext:Model>
                                </Model>
                            </ext:Store>
                        ...
                        <ColumnModel ID="colModel" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="Column3" runat="server" Text="开始称量时间" DataIndex="RealStartTime"
                                    Width="150" />
                                <ext:Column ID="Column4" runat="server" Text="称量结束时间" DataIndex="RealEndtime"
                                    Width="150"/>
