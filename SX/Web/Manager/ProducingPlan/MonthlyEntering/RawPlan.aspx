<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RawPlan.aspx.cs" Inherits="Manager_ProducingPlan_MonthlyEntering_RawPlan" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>月度原材料使用计划</title>
        ...
        var Manager_BasicInfo_CommonPage_QueryMaterial_Request = function (record) {
            ...
            var thisIsDefaultWindow = function (record) {
                if ((!App.AddRubPlanWin) || (App.AddRubPlanWin.hidden)) {
                    ...
                    App.txtMaterialMinorID.setValue(record.data.MaterialCode);
                    App.txtMateral.setValue(record.data.MaterialName);
                }
            }
...
<body>
    ...
    <ext:Hidden ID="hidden_update_materialCode" runat="server" />
    <ext:Window ID="AddRubPlanWin" runat="server" Icon="MonitorAdd" Closable="false"
        Title="添加原材料计划信息" Width="280" Height="180" Resizable="false" Hidden="true" Modal="false"
        ...
        <Items>
            <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5">
                <Items>
                    ...
                    <ext:TextField ID="txtPlanNum" runat="server" FieldLabel="月总使用量" AllowBlank="false"
                        LabelAlign="Right">
                    </ext:TextField>
    ...
    <ext:Window ID="ModifyRubPlanWin" runat="server" Closable="false" Icon="Add" Title="修改物料使用计划信息"
        Width="350" Height="160" Hidden="true" Modal="false">
        <Items>
            <ext:FormPanel ID="FormPanel1" runat="server" BodyPadding="5">
                <Items>
                    <ext:TextField ID="txtUpMaterialName" runat="server" FieldLabel="物料名称" ReadOnly="true"
                    ...
                    <ext:TextField ID="txtUpPlanNum" runat="server" FieldLabel="月总使用量" AllowBlank="false"
                        LabelAlign="Right" />
                </Items>
                <Listeners>
        ...
        <Items>
                            ...
                            <ext:Container ID="Container5" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                <Items>
                                    ...
                                    <ext:Container ID="Container1" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                        Padding="5">
                                        <Items>
                                            <ext:TriggerField ID="txtMateral" runat="server" Flex="1" Editable="false" FieldLabel="物料"
                                                LabelAlign="Right">
                                                <Triggers>
                                                    <ext:FieldTrigger Icon="Clear" HideTrigger="true" />
                                                    <ext:FieldTrigger Icon="Search" />
            ...
            <ext:GridPanel ID="GridPanel1" runat="server" Region="Center">
                ...
                <ColumnModel ID="ColumnModel2" runat="server">
                    <Columns>
                        <ext:Column ID="Column1" runat="server" Text="物料名称" Width="150" DataIndex="MaterialName">
                        </ext:Column>
                        <ext:Column ID="Column2" runat="server" Text="月总使用量" Width="150" DataIndex="PlanNum">
                        </ext:Column>
                        <ext:Column ID="Column4" runat="server" Text="累计使用量" Width="100" DataIndex="RealWeight">
                        </ext:Column>
                        <ext:ComponentColumn ID="ComponentColumn1" DataIndex="Num" runat="server" Text="使用率">
                            <Component>
