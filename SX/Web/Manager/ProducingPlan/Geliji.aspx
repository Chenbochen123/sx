<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Geliji.aspx.cs" Inherits="Manager_ProducingPlan_Geliji" %>
    ...
    <ext:Viewport ID="vwUnit" runat="server" Layout="BorderLayout">
        <Items>
                        ...
                        <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true" BodyPadding="5">
                            ...
                            <Items>
                                <ext:Container ID="container1" runat="server" Layout="FormLayout" ColumnWidth=".25"
                                    Padding="5">
                                    <Items>
                                        <ext:DateField ID="datetime" runat="server" Disabled="false" Width="300" AnchorHorizontal="100%" FieldLabel="开始日期" />
                                ...
                                <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".25"
                                    ...
                                    <Items>
                                        ...
                                        <ext:TextField ID="txtyongliang" runat="server" Disabled="false" Width="300" AnchorHorizontal="100%" FieldLabel="隔离剂用量" />
                                    </Items>
                                </ext:Container>
                                <ext:Container ID="container3" runat="server" Layout="FormLayout" ColumnWidth=".25"
                                    ...
                                    <Items>
                                         ...
                                         <ext:ComboBox ID="cbxxinghao" runat="server" Disabled="false" Width="300" AnchorHorizontal="100%" FieldLabel="隔离剂型号" />
                                    </Items>
                                </ext:Container>
            ...
            <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                           ...
                           <%-- <ext:Column runat="server" ID="Column1" DataIndex="Equip_name" Text="机台" MenuDisabled="true" />--%>
                            ...
                            <ext:Column runat="server" ID="Column3" DataIndex="Mater_name" Text="隔离剂" MenuDisabled="true" />
              ...
              <ext:Window ID="winSave" runat="server" Icon="MonitorAdd" Closable="false" Title="隔离剂信息维护" Width="550" Height="500" Resizable="false" Modal="true" BodyStyle="background-color:#fff;" BodyPadding="5" Layout="FormLayout">
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5" Layout="FormLayout">
                            ...
                            <Items>
                                ...
                                <ext:FieldSet ID="FieldSet1" runat="server" Title="隔离剂信息维护">
                                    <Items>
                                        ...
                                        <%--<ext:ComboBox ID="cbxequip1" runat="server" Disabled="false" Width="230" AnchorHorizontal="100%" FieldLabel="机台" />--%>
                                         <ext:ComboBox ID="cbxxinghao1" runat="server" Disabled="false" Width="230" AnchorHorizontal="100%" FieldLabel="隔离剂型号" />
                                                </Items>
                                        </ext:FieldContainer>
                                        ...
                                        <ext:TextField ID="txtyongliang1" runat="server" Disabled="false" Width="230" AnchorHorizontal="100%" FieldLabel="隔离剂用量" />
