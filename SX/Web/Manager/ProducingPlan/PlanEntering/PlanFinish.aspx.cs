...
public partial class Manager_ProducingPlan_PlanEntering_PlanFinish : Mesnac.Web.UI.Page
{
    #region 权限定义
    ...
    public object GridPanelBindData(string action, Dictionary<string, object> extraParams)
    {
        ...
        dic.Add("@plandate", Convert.ToDateTime(txtBeginTime.Text).ToString("yyyy-MM-dd"));
        dic.Add("@shiftid", txtPptShift.SelectedItem.Value);
        dic.Add("@depcode", txtDep.SelectedItem.Value);
        DataSet ds = pptPlanManager.GetDataSetByStoreProcedure("proc_getplanlist", dic);
    ...
    protected void btnExportSubmit_Click(object sender, EventArgs e)
    {
        ...
        dic.Add("@shiftid", txtPptShift.SelectedItem.Value);
        dic.Add("@depcode", txtDep.SelectedItem.Value);
        DataTable dt = pptPlanManager.GetDataSetByStoreProcedure("proc_getplanlist", dic).Tables[0];
        ...
        new Mesnac.Util.Excel.ExcelDownload().ExcelFileDown(dt, "计划完成信息");
    }
