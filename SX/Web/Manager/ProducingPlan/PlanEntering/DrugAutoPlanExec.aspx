<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DrugAutoPlanExec.aspx.cs"
    Inherits="Manager_ProducingPlan_PlanEntering_DrugAutoPlanExec" %>
        ...
        <Items>
            <ext:FormPanel ID="pnlEdit" runat="server" Flex="1" BodyPadding="5">
                <Items>
                    ...
                    <ext:TextField ID="txtPlanNum" runat="server" FieldLabel="计划车数" LabelAlign="Left" AllowBlank="false"
                        />
