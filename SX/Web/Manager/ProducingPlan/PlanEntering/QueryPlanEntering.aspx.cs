...
public partial class Manager_ProducingPlan_PlanEntering_QueryPlanEntering : Mesnac.Web.UI.Page
{
    PptPlanManager pptPlanManager =null;
    ...
    public void Init()
    {
        WhereClip where = PptPlan._.PlanDate == DateTime.Now.ToShortDateString();
        pptPlanManager.GetListByWhere(where);



        WhereClip where1 = PmtRecipe._.AuditFlag == 1&PmtRecipe._.RecipeState==1;
        pmtRecipeManager.GetListByWhere(where1);
