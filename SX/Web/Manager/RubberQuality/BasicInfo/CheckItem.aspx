<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckItem.aspx.cs" Inherits="Manager_RubberQuality_BasicInfo_CheckItem" %>
            ...
            <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                ...
                <ColumnModel ID="colModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column ID="Column1" runat="server" Text="序号" DataIndex="Display_id" Width="50" />
                ...
                <Items>
                    <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5">
                        ...
                        <Items>
                            ...
                            <ext:TextField ID="txtxuhao" runat="server" FieldLabel="序号" LabelAlign="Right"
                                 AllowBlank="true" />
