...
//    if (App.FileUploadFieldNorthExcel.getValue() == '') {
//        Ext.Msg.alert('提示', '请选择上传文件');
//        return false;
//    }
//    if (App.DateFieldNorthCheckDate.getValue() == null) {
//        Ext.Msg.alert('提示', '请选择检验日期');
//        return false;
//    }
//    if (App.TimeFieldNorthCheckTime.getValue() == null) {
//        Ext.Msg.alert('提示', '请选择检验时间');
//        return false;
//    }
//    if (App.ComboBoxNorthCheckShiftId.getValue() == null) {
//        Ext.Msg.alert('提示', '请选择检验班组');
//        return false;
//    }
