<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MixerFaultMain.aspx.cs" Inherits="Manager_Equipment_StopManage_MixerFault_MixerFaultMain" %>
        ...
        <ext:Viewport ID="vwUnit" runat="server" Layout="border">
            <Items>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    <Store>
                        <ext:Store ID="store" runat="server" PageSize="50" RemoteSort="true"> 
                            <Proxy>
