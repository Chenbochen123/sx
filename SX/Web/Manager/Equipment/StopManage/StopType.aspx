<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StopType.aspx.cs" Inherits="Manager_Equipment_StopManage_StopType" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_click_confirm = function (command, record) {
            if (command == "Edit") {
                App.direct.pnlList_Edit(command, record.data.Mp_ikindcode, {
                    success: function () { },
                    failure: function () { }
                });
            }
        ...
        var commandcolumn_direct_delete = function (btn, record) {
            ...
            var Mp_ikindcode = record.data.Mp_ikindcode;
            App.direct.commandcolumn_direct_delete(Mp_ikindcode, {
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="vwUnit" runat="server" Layout="border">
            <Items>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="clMainTypeName" runat="server" Text="大类名称" DataIndex="PARAM_NAME" Width="150"/>
                            <ext:Column ID="clTypeCode" runat="server" Text="类型代码" DataIndex="Mp_ikindcode" Width="100"/>
                            <ext:Column ID="clTypeName" runat="server" Text="类型名称" DataIndex="Mp_ikindname" Width="150"/>
                ...
                <ext:Window ID="winSave" runat="server" Icon="MonitorAdd" Closable="false" Title="维护停机小类"
