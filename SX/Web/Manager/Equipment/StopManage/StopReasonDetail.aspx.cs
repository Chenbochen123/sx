...
where Mp_startdate<='" + DateFieldNorthEndDate.SelectedDate.ToString("yyyy-MM-dd") + "' and Mp_startdate>='" + DateFieldNorthBeginDate.SelectedDate.ToString("yyyy-MM-dd") + "' and Mp_mkindcode is not null group by param_Name ";
