<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SapSparePart.aspx.cs" Inherits="Manager_Equipment_SapSparePart_SapSparePart" %>
    ...
    <script type="text/javascript">
        ...
        var Manager_BasicInfo_CommonPage_QueryBasUser_Request = function (record) {//领用人返回值处理
            if (!App.winAdd.hidden) {
                App.add_receive_user.setValue(record.data.UserName);
                App.hidden_receive_user.setValue(record.data.WorkBarcode);
            }
            else if (!App.winModify.hidden) {
                App.modify_receive_user.setValue(record.data.UserName);
                App.hidden_receive_user.setValue(record.data.WorkBarcode);
            }
        }
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                            ...
                            <Model>
                                <ext:Model ID="model" runat="server">
                                    <Fields>
                                        ...
                                        <ext:ModelField Name="ReceiveUser" />
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="receive_no" runat="server" Text="入库单号" DataIndex="ReceiveNo" Width="110"  />
                            <ext:DateColumn Format="yyyy-MM-dd" ID="receive_date" runat="server" Text="入库日期" DataIndex="ReceiveDate" Width="120"  />
                            ...
                            <ext:Column ID="store_in_num" runat="server" Text="入库数量" DataIndex="StoreInNum" Width="60"  />
                            <ext:Column ID="receive_user" runat="server" Text="接收人" DataIndex="ReceiveUser" Width="100"  />
                            <ext:DateColumn Format="yyyy-MM-dd" runat="server" Text="记录时间" DataIndex="RecordDate" Width="100"  />
                                    ...
                                    <Items>
                                        <ext:Container ID="Container3" runat="server" Layout="FormLayout" ColumnWidth=".5" Padding="5">
                                            <Items>
                                                ...
                                                <ext:TextField ID="modify_receive_no" runat="server" FieldLabel="入库单号" LabelAlign="Left" ReadOnly="true"/>
                                                <ext:DateField ID="modify_receive_date" runat="server" FieldLabel="入库日期" LabelAlign="Left" Editable="false"/>
                                        ...
                                        <ext:Container ID="Container4" runat="server" Layout="FormLayout" ColumnWidth=".5" Padding="5">
                                            <Items>
                                                <ext:NumberField ID="modify_number" runat="server" FieldLabel="入库数量" MinValue="1" LabelAlign="Left"/>
                                ...
                                <ext:Container ID="Container2" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container runat="server" Layout="FormLayout" ColumnWidth=".5" Padding="5">
                                            <Items>
                                                <%--<ext:TextField ID="add_receive_no" runat="server" FieldLabel="入库单号" LabelAlign="Left"/>--%>
                                                <ext:DateField ID="add_receive_date" runat="server" FieldLabel="入库日期" LabelAlign="Left" Editable="false"/>
                                        ...
                                        <ext:Container runat="server" Layout="FormLayout" ColumnWidth=".5" Padding="5">
                                            <Items>
                                                <ext:NumberField ID="add_number" runat="server" FieldLabel="入库数量" MinValue="1" LabelAlign="Left"/>
