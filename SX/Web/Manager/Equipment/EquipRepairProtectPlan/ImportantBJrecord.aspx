<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImportantBJrecord.aspx.cs" Inherits="Manager_Equipment_EquipRepairProtectPlan_ImportantBJrecord" %>
    ...
    <script type="text/javascript">
        ...
        var cmdcol_click = function (command, record) {
            if (command == "Delete") {
                ...
                App.direct.pnlList_Add(record.data.Serialid, record.data.INO, record.data.Workshop, record.data.EquipName, record.data.BJName, record.data.BJCode,
                    record.data.changeBJ, record.data.lastdate, record.data.reson, record.data.memo,
                    {
                        success: function () { },
                        failure: function () { }
                    });
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="Column2" runat="server" Text="备件名称" DataIndex="BJName" Width="100">
                                <Editor>
                                    <ext:TextField runat="server" AllowBlank="false" />
                                </Editor>
                            </ext:Column>
                            <ext:Column ID="Column5" runat="server" Text="备件编码" DataIndex="BJCode" Width="100">
                                <Editor>
                                    <ext:TextField runat="server" AllowBlank="false" />
                                </Editor>
                            </ext:Column>
                            <ext:Column ID="Column10" runat="server" Text="更换部位" DataIndex="changeBJ" Width="100">
                                <Editor>
                                    <ext:TextField runat="server" AllowBlank="false" />
                                </Editor>
                            </ext:Column>
                            <ext:DateColumn ID="DateColumn4" runat="server" Text="更换日期" DataIndex="lastdate" Width="150" Format="yyyy-MM-dd">
                                <Editor>
                                    <ext:DateField
                                        runat="server"
                                        AllowBlank="false"
                            ...
                            <ext:Column ID="Column6" runat="server" Text="更换原因" DataIndex="reson" Width="200">
                                <Editor>
                                    <ext:TextField runat="server" AllowBlank="false" />
                                </Editor>
                            </ext:Column>
