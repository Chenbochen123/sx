            ...
            <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="BJ_code" runat="server" Text="备件代码" DataIndex="BJ_code" Width="120" />
                            <ext:Column ID="Column3" runat="server" Text="备件名称" DataIndex="BJ_name" Width="270" />
                            <ext:Column ID="Column7" runat="server" Text="规格型号" DataIndex="BJ_specType" Width="120" />
                            <ext:Column ID="Column12" runat="server" Text="标准单位" DataIndex="Unit_name" Width="60" />
                            <ext:Column ID="clOil_name" runat="server" Text="备件分类" DataIndex="BJ_tpname" Width="120" />
                            <ext:Column ID="Column11" runat="server" Text="最高储备定额" DataIndex="high_reserve" Width="85" />
                                ...
                                <ext:FieldSet runat="server" Title="备件信息维护" Layout="AnchorLayout" DefaultAnchor="100%">
                                    <Items>
                                        ...
                                        <ext:FieldContainer ID="FieldContainer6" runat="server" Layout="HBoxLayout" AnchorHorizontal="100%">
                                            <Items>
                                                <ext:TextField ID="txthigh" runat="server" Width="200" LabelAlign="Right" Enabled="true" FieldLabel="最高储备定额" AllowBlank="false" InputType="Number" />
                                                <ext:TextField ID="txtlow" runat="server" Width="200" LabelAlign="Right" Enabled="true" FieldLabel="最低储备定额" AllowBlank="false" InputType="Number" />
                                            </Items>
                                        </ext:FieldContainer>
                                        <ext:FieldContainer ID="FieldContainer5" runat="server" Layout="HBoxLayout" AnchorHorizontal="100%">
                                            <Items>
                                                ...
                                                <ext:TextField ID="txtprice" runat="server" Width="200" LabelAlign="Right" Enabled="true" FieldLabel="计划价格"  AllowBlank="false"  InputType="Number"/>
                                            </Items>
                                        </ext:FieldContainer>
