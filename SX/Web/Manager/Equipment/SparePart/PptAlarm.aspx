<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PptAlarm.aspx.cs" Inherits="Manager_Equipment_SparePart_PptAlarm" %>
            ...
            <Items>
                        ...
                        <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true" BodyPadding="5">
                            ...
                            <Items>
                                <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".3"
                                    Padding="5">
                                    <Items>
                                       <ext:DateField ID="daDateTime" runat="server" FieldLabel="日期" Width="300" Editable="false" AllowBlank="false" />
                                    </Items>
                                </ext:Container>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            <ext:Column ID="clEquip" runat="server" Text="报警时间" DataIndex="opertime" Width="150" />
                            <ext:Column ID="clShiftName" runat="server" Text="报警内容" DataIndex="AlarmStr" Width="150" />
                            <ext:Column ID="clStartTime" runat="server" Text="机台" DataIndex="EquipName" Width="100" />
                        </Columns>
                    </ColumnModel>
<%--                    <SelectionModel>
