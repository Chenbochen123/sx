<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MainType.aspx.cs" Inherits="Manager_Equipment_SparePart_MainType" %>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="vwUnit" runat="server" Layout="border">
            <Items>
                <ext:Panel ID="pnlMainType" runat="server" Region="North" AutoHeight="true">
                    ...
                    <Items>
                        <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                            ...
                            <Items>
                                <ext:TextField ID="txtSparePartMainTypeName" runat="server" FieldLabel="大类名称" LabelAlign="Right">
                                    <ToolTips>
                ...
                <ext:Window ID="winSave" runat="server" Icon="MonitorAdd" Closable="false" Title="维护备件大类"
                    ...
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5">
                            ...
                            <Items>
                                <ext:TextField ID="txtObjID" runat="server" FieldLabel="大类编号" LabelAlign="Right" Text="" Disabled="true" EmptyText="自动生成" AllowBlank="true"/>
                                <ext:TextField ID="txtMainTypeName" runat="server" FieldLabel="大类名称" AllowBlank="false" LabelAlign="Right" MaxLength="60"/>
