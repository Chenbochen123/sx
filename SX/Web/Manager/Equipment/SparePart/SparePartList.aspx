<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SparePartList.aspx.cs" Inherits="Manager_Equipment_SparePart_SparePartList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var cmdcol_click = function (command, record) {
            if (command == "Edit") {
                App.direct.pnlList_Edit(record.data.BJ_tpcode, {
                    success: function () { },
                    failure: function () { }
                });
            }
        ...
        var deleteStopRecord = function (btn, record) {
            ...
            var BJ_tpcode = record.data.BJ_tpcode;
            App.direct.pnlList_Delete(BJ_tpcode, {
                success: function () { },
                failure: function () { }
            });
        }
    ...
    <ext:Hidden ID="hidden_fault_reason" runat="server" />
        <ext:Viewport ID="vwUnit" runat="server" Layout="border">
            <Items>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    <Store>
                        <ext:Store ID="store" runat="server" PageSize="50">
                            <Model>
                                <ext:Model ID="model" runat="server" IDProperty="BJ_tpcode">
                                    <Fields>
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            <ext:Column ID="BJ_tpcode" runat="server" Text="备件分类代码" DataIndex="BJ_tpcode" Width="120"/>
                            <ext:Column ID="BJ_tpname" runat="server" Text="备件分类名称" DataIndex="BJ_tpname" Width="300"/>
                ...
                <ext:Window ID="winSave" runat="server" Icon="MonitorAdd" Closable="false" Title="备件分类维护" Width="550" Height="500" Resizable="false" Modal="true" BodyStyle="background-color:#fff;" BodyPadding="5" Layout="FormLayout">
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5" Layout="FormLayout">
                            ...
                            <Items>
                                ...
                                <ext:FieldSet ID="FieldSet1" runat="server" Title="备件分类维护">
                                    <Items>
                                        <ext:FieldContainer ID="FieldContainer12"  runat="server" Layout="HBoxLayout"  AnchorHorizontal="100%">
                                            <Items>
                                         
                                                <ext:FieldContainer ID="FieldContainer1" runat="server" FieldLabel="备件分类代码" >
                                                    <Items>
                                                        <ext:TextField ID="txtbjcode" runat="server" Width="100" AllowBlank="false"/>
                                                    </Items>
                                                </ext:FieldContainer>
                                                <ext:FieldContainer ID="FieldContainer7" runat="server" FieldLabel="备件分类名称" >
                                                    <Items>
                                                        <ext:TextField ID="txtbjname" runat="server" Width="100" AllowBlank="false"/>
                                                    </Items>
                                                </ext:FieldContainer>
                                            </Items>
                                        </ext:FieldContainer>
