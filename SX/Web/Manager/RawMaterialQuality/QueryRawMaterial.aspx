<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryRawMaterial.aspx.cs" Inherits="Manager_BasicInfo_RawMaterialQuality_QueryRawMaterial" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_RawMaterialQuality_QueryRawMaterial_Request(record);
            parent.App.Manager_RawMaterialQuality_QueryRawMaterial_Window.close();
            return false;
        }
                                ...
                                <ext:Container ID="container_Query" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container1" runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                                            <Items>
                                                <ext:TextField ID="txtMaterialName" runat="server" FieldLabel="原材料名称" LabelAlign="Right" >
                                                    <Listeners>
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="material_code" runat="server" Text="物料编码" DataIndex="MaterialCode" Width="120"  />
                            <ext:Column ID="material_name" runat="server" Text="物料名称" DataIndex="MaterialName" Width="130"  />
