<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CJItem.aspx.cs" Inherits="Manager_BasicInfo_RubberInfo_CJItem" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_edit = function (record) {
            var ObjID = record.data.ID;
            var MaterialCode = record.data.Name;
          
            App.modify_MN.setValue(record.data.Name);
         
            App.modify_ID.setValue(record.data.ID);
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            <ext:RowNumbererColumn ID="rowNumCol" runat="server" Width="35" />
                                   <ext:Column ID="Column4" runat="server" Text="编号" DataIndex="ID" Width="150" />
                        
                            <ext:Column ID="MaterialName" runat="server" Text="掺用原因" DataIndex="Name" Width="150"  />
                    ...
                    <Items> 
                        <ext:FormPanel ID="pnlEdit" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                    ...
                                    <ext:TextField ID="modify_MN" runat="server" FieldLabel="掺用原因" LabelAlign="Left"  />
                    ...
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5">
                            ...
                            <Items>
                                ...
                                <ext:TextField ID="add_SetWeight" runat="server" FieldLabel="掺胶原因" AllowBlank=false LabelAlign="Left" IndicatorText="*" IndicatorCls="red-text"  />
                             </Items>
                            <Listeners>
