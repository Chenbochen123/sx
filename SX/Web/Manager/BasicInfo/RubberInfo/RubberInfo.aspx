<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RubberInfo.aspx.cs" Inherits="Manager_BasicInfo_RubberInfo_RubberInfo" %>
                        ...
                        <ext:Panel ID="Panel1" runat="server" Height="400">
                            ...
                            <Items>
                                <ext:GridPanel ID="AllUserPnl"  runat="server"  MultiSelect="true" Title="所有用户列表" TitleAlign="Center" Flex="1" Margins="0 2 0 0">
                                    <Store>
                                        <ext:Store ID="AllUserStore" runat="server" PageSize="50">
                                            <Proxy>
