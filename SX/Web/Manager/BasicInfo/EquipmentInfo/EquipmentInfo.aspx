<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EquipmentInfo.aspx.cs" Inherits="Manager_BasicInfo_EquipmentInfo_EquipmentInfo" %>
                                ...
                                <ext:Container ID="Container1" runat="server" Layout="FormLayout" ColumnWidth=".5" Padding="1" >
                                    <Items>
                                       <ext:CheckboxGroup ID="CheckboxGroup1" runat="server" ColumnsNumber="2" Flex="1" AnchorHorizontal="true">
                                        ...
                                        <ext:TextField LabelAlign="left" ID="add_remark" runat="server" FieldLabel="设备分组" />
