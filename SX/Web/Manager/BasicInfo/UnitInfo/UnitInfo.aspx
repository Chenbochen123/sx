<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UnitInfo.aspx.cs" Inherits="Manager_BasicInfo_UnitInfo_UnitInfo" %>
    ...
    <form id="fmUnit" runat="server">
        ...
        <ext:Viewport ID="vwUnit" runat="server" Layout="border">
            <Items>
                                ...
                                <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container_1" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:TextField ID="txt_obj_id" Vtype="integer" runat="server" FieldLabel="单位编号" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                                        <ext:Container ID="container_2" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:TextField ID="txt_unit_name" runat="server" FieldLabel="单位名称" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                                    ...
                                    <%--<Listeners>
                                        <ValidityChange Handler="#{btn_search}.setDisabled(!valid);#{btn_history_search}.setDisabled(!valid);#{btnExport}.setDisabled(!valid);" />
                                    </Listeners>--%>
                                </ext:FormPanel>
                            </Items>
                        </ext:Panel>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="obj_id" runat="server" Text="单位编号" DataIndex="ObjID" Width="150"  />
                            <ext:Column ID="unit_name" runat="server" Text="单位名称" DataIndex="UnitName" Width="150"  />
                ...
                <ext:Window ID="winModify" runat="server" Icon="MonitorEdit" Closable="false" Title="修改单位信息"
                    ...
                    <Items> 
                        <ext:FormPanel ID="pnlEdit" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                <ext:TextField ID="modify_obj_id" runat="server" FieldLabel="单位编号"   LabelAlign="Left" ReadOnly=true Hidden=true Enabled="true" />
                                <ext:TextField ID="modify_unit_name" runat="server" FieldLabel="单位名称" LabelAlign="Left" MaxLength="50" AllowBlank=false IndicatorText="*" IndicatorCls="red-text" IsRemoteValidation=true   >
                                    <RemoteValidation  OnValidation = "CheckUnitName" />
                                </ext:TextField>
                ...
                <ext:Window ID="winAdd" runat="server" Icon="MonitorAdd" Closable="false" Title="添加单位信息"
                    ...
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5">
                            ...
                            <Items>
                                <ext:TextField ID="add_unit_name" runat="server" FieldLabel="单位名称"  LabelAlign="Left" MaxLength="50" AllowBlank=false IndicatorText="*" IndicatorCls="red-text" IsRemoteValidation=true  >
                                    <RemoteValidation  OnValidation = "CheckUnitName" />
                                </ext:TextField>
                ...
                <ext:Hidden ID="hidden_unit_name"  runat="server"></ext:Hidden>
