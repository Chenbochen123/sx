<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkCoefficientInfo.aspx.cs" Inherits="Manager_BasicInfo_WorkInfo_WorkCoefficientInfo" %>
    ...
    <form id="fmUnit" runat="server">
        ...
        <ext:Viewport ID="vwUnit" runat="server" Layout="border">
            <Items>
                        ...
                        <ext:Panel ID="pnlWorkQuery" runat="server" AutoHeight="true">
                            <Items>
                                <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:ComboBox ID="cmoWorkName" Editable="false" runat="server" FieldLabel="岗位名称"
                                                LabelAlign="Right">
                                            </ext:ComboBox>
                                    </Items>
                                </ext:FormPanel>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center"> 
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="WorkID" runat="server" Text="岗位编号" DataIndex="WorkID" Width="120"  />
                            <ext:Column ID="WorkName" runat="server" Text="岗位名称" DataIndex="WorkName" Width="120"  />
                            <ext:Column ID="Coefficient" runat="server" Text="系数" DataIndex="Coefficient" Width="120"  />
                            <ext:Column ID="DeleteFlag" runat="server" Text="删除标志" DataIndex="DeleteFlag" Width="120"  Hidden="true"/>
                ...
                <ext:Window ID="winModify" runat="server" Icon="MonitorEdit" Closable="false" Title="修改岗位系数信息"
                    ...
                    <Items> 
                        <ext:FormPanel ID="pnlEdit" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                <ext:TextField ID="modify_ObjID" runat="server" FieldLabel="编号"   LabelAlign="Left" ReadOnly="true" Hidden="true"/>
                                <ext:TextField ID="modify_WorkID" runat="server" FieldLabel="岗位编号"   LabelAlign="Left" ReadOnly="true"  Enabled="true" />
                                <ext:TextField ID="modify_WorkName" runat="server" FieldLabel="岗位名称" LabelAlign="Left" ReadOnly="true"  Enabled="true" >
                                </ext:TextField>
                                <ext:TextField ID="modify_Coefficient" runat="server" FieldLabel="系数" LabelAlign="Left"  AllowBlank="false" IndicatorText="*" IndicatorCls="red-text" >
                                </ext:TextField>
                ...
                <ext:Window ID="winAdd" runat="server" Icon="MonitorAdd" Closable="false" Title="添加岗位系数信息"
                    Width="320" Height="240" Resizable="false" Hidden="true" Modal="false" BodyStyle="background-color:#fff;"
                    BodyPadding="5" Layout="Form">
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5">
                            ...
                            <Items>
                                <ext:ComboBox ID="add_WorkName" Editable="false" runat="server" FieldLabel="岗位名称"  LabelAlign="Left">
                                </ext:ComboBox>
                                <ext:TextField ID="add_Coefficient" runat="server" FieldLabel="系数"   LabelAlign="Left" MaxLength="10" Enabled="true" AllowBlank=false IndicatorText="*" IndicatorCls="red-text"/>
