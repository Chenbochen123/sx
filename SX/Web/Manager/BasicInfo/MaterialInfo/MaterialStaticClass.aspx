<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterialStaticClass.aspx.cs" Inherits="Manager_BasicInfo_MaterialInfo_MaterialStaticClass" %>
    ...
    <form id="fmUnit" runat="server">
        ...
        <ext:Viewport ID="vwUnit" runat="server" Layout="border">
            <Items>
                                ...
                                <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container_1" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:TextField ID="txt_obj_id" Vtype="integer" runat="server" FieldLabel="统计分类编号" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                                        <ext:Container ID="container_2" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:TextField ID="txt_static_class_name" runat="server" FieldLabel="统计分类名称" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="obj_id" runat="server" Text="统计分类编号" DataIndex="ObjID" Width="150"  />
                            <ext:Column ID="marjor_type_name" runat="server" Text="统计分类名称" DataIndex="StaticClassName" Width="150"  />
                ...
                <ext:Window ID="winModify" runat="server" Icon="MonitorEdit" Closable="false" Title="修改统计分类信息"
                    ...
                    <Items> 
                        <ext:FormPanel ID="pnlEdit" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                <ext:TextField ID="modify_obj_id" runat="server" FieldLabel="统计分类编号"   LabelAlign="Left" ReadOnly=true Hidden=true Enabled="true" />
                                <ext:TextField ID="modify_static_class_name" runat="server" FieldLabel="统计分类名称" MaxLength="25"  AllowBlank=false LabelAlign="Left" IndicatorText="*" IndicatorCls="red-text"  />
                ...
                <ext:Window ID="winAdd" runat="server" Icon="MonitorAdd" Closable="false" Title="添加统计分类信息"
                    Width="320" Height="240" Resizable="false" Hidden="true" Modal="false" BodyStyle="background-color:#fff;"
                    BodyPadding="5" Layout="Form">
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5">
                            ...
                            <Items>
                                <ext:TextField ID="add_static_class_name" runat="server" FieldLabel="统计分类名称" MaxLength="25"  AllowBlank=false LabelAlign="Left" IndicatorText="*" IndicatorCls="red-text" />
                ...
                <ext:Hidden ID="hidden_static_class_name" runat="server" />
