<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkPositionInfo.aspx.cs" Inherits="Manager_BasicInfo_WorkPositionInfo_WorkPositionInfo" %>
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server" ID="barWork">
                            <Items>
                                ...
                                <ext:Button runat="server" IconCls="PageWhiteExcel" Text="导出" ID="btnExport">
                                    <ToolTips>
                                ...
                                <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container_1" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:TextField ID="txt_obj_id" Vtype="integer" runat="server" FieldLabel="岗位编号" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                                        <ext:Container ID="container_2" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:TextField ID="txt_work_name" runat="server" FieldLabel="岗位名称" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center"> 
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="obj_id" runat="server" Text="岗位编号" DataIndex="ObjID" Width="120"  />
                            <ext:Column ID="work_name" runat="server" Text="岗位名称" DataIndex="WorkName" Width="120"  />
<%--                            <ext:Column ID="hr_code" runat="server" Text="HR编码" DataIndex="HRCode" Width="120"  />
                            <ext:Column ID="erp_code" runat="server" Text="ERP编码" DataIndex="ERPCode" Width="120"  />--%>
                ...
                <ext:Window ID="winModify" runat="server" Icon="MonitorEdit" Closable="false" Title="修改岗位基础信息"
                    ...
                    <Items> 
                        <ext:FormPanel ID="pnlEdit" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                <ext:TextField ID="modify_obj_id" runat="server" FieldLabel="岗位编号"   LabelAlign="Left" ReadOnly=true Hidden=true Enabled="true" />
                                <ext:TextField ID="modify_work_name" runat="server" FieldLabel="岗位名称" LabelAlign="Left" MaxLength="50" IsRemoteValidation="true" AllowBlank=false IndicatorText="*" IndicatorCls="red-text" >
                                     <RemoteValidation OnValidation="CheckWorkName" />
                                </ext:TextField>
                                <ext:TextField ID="modify_hr_code" runat="server" FieldLabel="HR编码"   LabelAlign="Left" MaxLength="10" Enabled="true"  Hidden="true"/>
                                <ext:TextField ID="modify_erp_code" runat="server" FieldLabel="ERP编码"   LabelAlign="Left" MaxLength="10" Enabled="true"  Hidden="true" />
                ...
                <ext:Window ID="winAdd" runat="server" Icon="MonitorAdd" Closable="false" Title="添加岗位基础信息"
                    Width="320" Height="240" Resizable="false" Hidden="true" Modal="false" BodyStyle="background-color:#fff;"
                    BodyPadding="5" Layout="Form">
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5">
                            ...
                            <Items>
                                <ext:TextField ID="add_work_name" runat="server" FieldLabel="岗位名称" LabelAlign="Left" MaxLength="50" IsRemoteValidation="true" AllowBlank=false IndicatorText="*" IndicatorCls="red-text">
                                    <RemoteValidation OnValidation="CheckWorkName" />
                                </ext:TextField>
<%--                                <ext:TextField ID="add_hr_code" runat="server" FieldLabel="HR编码"   LabelAlign="Left" MaxLength="10" Enabled="true" />
                                <ext:TextField ID="add_erp_code" runat="server" FieldLabel="ERP编码"   LabelAlign="Left" MaxLength="10" Enabled="true" />--%>
