<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuerySysRole.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QuerySysRole" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QuerySysRole_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QuerySysRole_Window.close();
            return false;
        }
                                ...
                                <ext:Container ID="container_Query" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container1" runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                                            <Items>
                                                <ext:TextField ID="txtShowName" runat="server" FieldLabel="角色名称" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                                    </Items>
                                </ext:Container>
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="RoleName" DataIndex="RoleName" runat="server" Text="角色名称" Width="120" />
