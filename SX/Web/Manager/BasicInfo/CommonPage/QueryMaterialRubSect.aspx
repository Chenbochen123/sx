<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryMaterialRubSect.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryMaterialRubSect" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryMaterialRubSect_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryMaterialRubSect_Window.close();
            return false;
        }
                                ...
                                <ext:Container ID="container_Query" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container1" runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                                            <Items>
                                                <ext:TextField ID="txtSectName" runat="server" FieldLabel="胶料段数名称" LabelAlign="Right" />
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                        ...
                        <ext:Store ID="store" runat="server" PageSize="10">
                            ...
                            <Model>
                                <ext:Model ID="model" runat="server">
                                    <Fields>
                                        <ext:ModelField Name="SectCode" />
                                        <ext:ModelField Name="SectName" />
                                    </Fields>
                                </ext:Model>
                            </Model>
                        </ext:Store>
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="SectCode" DataIndex="SectCode" runat="server" Text="胶料段数编号" Width="80" />
                            <ext:Column ID="SectName" DataIndex="SectName" runat="server" Text="胶料段数名称" Width="80"/>
