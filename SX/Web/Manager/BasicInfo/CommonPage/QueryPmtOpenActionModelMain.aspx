<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryPmtOpenActionModelMain.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryPmtOpenActionModelMain" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryPmtOpenActionModelMain_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryPmtOpenActionModelMain_Window.close();
            return false;
        }
                                ...
                                <ext:Container ID="container_Query" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container1" runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                                            <Items>
                                                <ext:TextField ID="txtModelName" runat="server" FieldLabel="模板名称" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                                    </Items>
                                </ext:Container>
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                            ...
                            <Model>
                                <ext:Model ID="model" runat="server">
                                    <Fields>
                                        ...
                                        <ext:ModelField Name="ModelCreateUser" />
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="ModelName" DataIndex="ModelName" runat="server" Text="模板名称" Width="80" />
                            <ext:DateColumn Format="yyyy-MM-dd" ID="ModelValidDate" DataIndex="ModelValidDate" runat="server" Text="有效时间" Width="80" />
