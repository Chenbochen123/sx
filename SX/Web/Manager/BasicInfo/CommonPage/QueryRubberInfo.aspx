<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryRubberInfo.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryRubberInfo" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryRubberInfo_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryRubberInfo_Window.close();
            return false;
        }
                                    ...
                                    <Items>
                                        <ext:Container ID="container1" runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                                            <Items>
                                                ...
                                                <ext:ComboBox ID="txtRubType" runat="server" FieldLabel="胶料分类" LabelAlign="Right" Editable="false" />
                                            </Items>
                                        </ext:Container>
                                    </Items>
                                </ext:Container>
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="RubCode" DataIndex="RubCode" runat="server" Text="胶料编码" Width="60" />
                            <ext:Column ID="RubName" DataIndex="RubName" runat="server" Text="胶料名称" Width="120" />
                            <ext:Column ID="RubTypeCode" DataIndex="RubTypeCode" runat="server" Text="胶料分类" Width="60" />
