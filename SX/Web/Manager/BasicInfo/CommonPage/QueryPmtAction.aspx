<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryPmtAction.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryPmtAction" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryPmtAction_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryPmtAction_Window.close();
            return false;
        }
                                ...
                                <ext:Container ID="container_Query" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container1" runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                                            <Items>
                                                <ext:TextField ID="txtCode" runat="server" FieldLabel="动作代码" LabelAlign="Right" />
                                                <ext:TextField ID="txtShowName" runat="server" FieldLabel="动作名称" LabelAlign="Right" />
                                                <ext:TextField ID="txAddress" runat="server" FieldLabel="动作地址" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                                    </Items>
                                </ext:Container>
