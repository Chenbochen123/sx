<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryPageMethod.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryPageMethod" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryPageMethod_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryPageMethod_Window.close();
            return false;
        }
                                ...
                                <ext:Container ID="container_Query" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container1" runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                                            <Items>
                                                <ext:TextField ID="txtShowName" runat="server" FieldLabel="操作简述" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                                    </Items>
                                </ext:Container>
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="PageName" DataIndex="PageName" runat="server" Text="功能模块" Width="120" />
                            <ext:Column ID="ShowName" DataIndex="ShowName" runat="server" Text="操作简述" Flex="1" />
