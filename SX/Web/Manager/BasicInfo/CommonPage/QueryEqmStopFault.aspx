<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryEqmStopFault.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryEqmStopFault" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryEqmStopFault_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryEqmStopFault_Window.close();
            return false;
        }
                                ...
                                <ext:Container ID="container_Query" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container1" runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                                            <Items>
                                                <ext:TextField ID="txtFaultName" runat="server" FieldLabel="停机故障点" LabelAlign="Right" >
                                                    <Listeners>
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="type_code" runat="server" Text="故障点编码" DataIndex="FaultCode" Width="120"  />
                            <ext:Column ID="spare_part_name" runat="server" Text="故障点名称" DataIndex="FaultName" Width="130"  />
