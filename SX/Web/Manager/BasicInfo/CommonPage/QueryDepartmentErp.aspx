<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryDepartmentErp.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryDepartmentErp" %>
<%@ Register Assembly="Ext.Net" Namespace="Ext.Net" TagPrefix="ext" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="head" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Erp接口部门信息</title>
    <!--通用-->
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryDepartmentErp_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryDepartmentErp_Window.close();
            return false;
        }
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="DepName" runat="server" Text="部门名称" DataIndex="DepName" Width="70"  />
                            <ext:Column ID="ERPCode" runat="server" Text="ERP编号" DataIndex="ERPCode" Width="90"  />
