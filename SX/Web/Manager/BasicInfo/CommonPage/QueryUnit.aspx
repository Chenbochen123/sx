<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryUnit.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryUnit" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryUnit_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryUnit_Window.close();
            return false;
        }
                                ...
                                <ext:Container ID="container_Query" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container1" runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                                            <Items>
                                                <ext:TextField ID="txtUnitName" runat="server" FieldLabel="单位名称" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                                    </Items>
                                </ext:Container>
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="ObjID" DataIndex="ObjID" runat="server" Text="单位编号" Width="80" />
                            <ext:Column ID="UserName" DataIndex="UnitName" runat="server" Text="单位名称" Width="80" />
