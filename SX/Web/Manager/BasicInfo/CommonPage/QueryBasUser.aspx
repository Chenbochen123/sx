<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryBasUser.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryBasUser" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryBasUser_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryBasUser_Window.close();
            return false;
        }
