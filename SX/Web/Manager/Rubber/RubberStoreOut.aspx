<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RubberStoreOut.aspx.cs" Inherits="Manager_Rubber_RubberStoreOut" %>
    ...
    <script type="text/javascript">
        var SetStockFlag = function () {
            ...
            if (section && section.length == 0) {
                ...
                Ext.Msg.confirm("提示", '确定要审核出库吗？', function (btn) { commandcolumn_direct_setstockflag(btn) });
            }
        }
        ...
        var CancelStock = function () {
            ...
            if (section && section.length == 0) {
                ...
                Ext.Msg.confirm("提示", '确定要撤销出库吗？', function (btn) { commandcolumn_direct_cancelstock(btn) });
            }
        }
        ...
        var QueryStorage = function (field, trigger, index) {//库房
            ...
            switch (index) {
                case 0:
                    ...
                    else if (name == "txtToStorageCheckName") {
                        field.getTrigger(0).hide();
                        field.setValue('');
...
<body>
    <form id="form1" runat="server">
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server" ID="tbRubberStorage">
                            <Items>
                                ...
                                <ext:Button runat="server" Icon="LockEdit" Text="出库撤销" ID="Button2">
                                    <Listeners>
                        ...
                        <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                            <Items>
                                ...
                                <ext:Container ID="container3" runat="server" Layout="FormLayout" ColumnWidth=".2"
                                    Padding="5">
                                    <Items>
                                        <ext:TriggerField ID="txtToStorageCheckName" runat="server" FieldLabel="领料单位" LabelAlign="Right" Flex="1" Editable="false">
                                            <Triggers>
                                                <ext:FieldTrigger Icon="Clear" HideTrigger="true" />
                                                <ext:FieldTrigger Icon="Search" />
                                            </Triggers>
                                ...
                                <ext:Container ID="container4" runat="server" Layout="FormLayout" ColumnWidth=".2" Padding="5">
                                    <Items>
                                        ...
                                        <ext:ComboBox ID="cbxStock" OnDirectChange="page_change" runat="server" FieldLabel="是否出库" LabelAlign="Right">
                                            <Items>
                    ...
                    <ext:GridPanel ID="pnlList" runat="server">
                        ...
                        <ColumnModel ID="colModel" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="Column2" runat="server" Text="领料库房" DataIndex="ToStorageName" Flex="1" />
                                <ext:Column ID="Column1" runat="server" Text="领料库位" DataIndex="ToStoragePlaceName" Flex="1" />
                                ...
                                <ext:DateColumn ID="PlanDate" runat="server" Text="生产时间" DataIndex="PlanDate" Flex="1" Format="yyyy-MM-dd HH:mm:ss" />
                                ...
                                <ext:DateColumn ID="RecordDate" runat="server" Text="出库时间" DataIndex="RecordDate" Flex="1" Format="yyyy-MM-dd HH:mm:ss" />
                                <ext:Column ID="Weight" runat="server" Text="出库重量" DataIndex="Weight" Flex="1" />
                                <ext:Column ID="OperPerson" runat="server" Text="出库人" DataIndex="OperPerson" Flex="1" />
                            ...
                            <ext:RowSelectionModel ID="rowSelectMuti" runat="server" Mode="Single">
                                <DirectEvents>
                                    <SelectionChange OnEvent="rowSelectMuti_SelectionChange">
                                        <ExtraParams>
                                            <ext:Parameter Name="StockFlag" Value="selected[0].get('StockFlag')" Mode="Raw" />
        ...
        <ext:Hidden ID="hldname" runat="server"></ext:Hidden>
