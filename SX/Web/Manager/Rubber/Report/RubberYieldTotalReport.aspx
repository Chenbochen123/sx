<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RubberYieldTotalReport.aspx.cs" Inherits="Manager_Rubber_Report_RubberYieldTotalReport" %>
                                ...
                                <ext:FormPanel ID="FormPanel2" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="ctnBeginTime" runat="server" Layout="FormLayout" ColumnWidth=".25" Padding="2">
                                            <Items>
                                                <ext:ComboBox ID="cbxTotalType" runat="server" FieldLabel="统计分类" LabelAlign="Right" Editable="false">
                                                    ...
                                                    <Items>
                                                        <ext:ListItem Text="生产" Value="2" AutoDataBind="true"></ext:ListItem>
                                                        <ext:ListItem Text="自产不合格" Value="3"></ext:ListItem>
                                                        <ext:ListItem Text="质检合格" Value="4"></ext:ListItem>
                                                        <ext:ListItem Text="质检不合格" Value="5"></ext:ListItem>
                                                    </Items>
                                                </ext:ComboBox>
                                            </Items>
                                        </ext:Container>
                                        <ext:Container ID="ctnEndTime" runat="server" Layout="FormLayout" ColumnWidth=".25" Padding="2">
                                            <Items>
                                                <ext:DateField runat="server" ID="txtTotalMonth" Type="Month" FieldLabel="统计月份" LabelAlign="Right" Format="yyyy-MM" Editable="false" AllowBlank="false" />
                                            </Items>
                                        </ext:Container>
                                        ...
                                        <ext:Container ID="Container1" runat="server" Layout="FormLayout" ColumnWidth=".25" Padding="2">
                                            <Items>
                                                 <ext:ComboBox ID="cbxtype" runat="server" FieldLabel="统计方式" LabelAlign="Right" Editable="false">
                                                    <SelectedItems>
                                                        <ext:ListItem Value="1"></ext:ListItem>
                                                    </SelectedItems>
                                                    <Items>
                                                        <ext:ListItem Text="按机台统计" Value="1" AutoDataBind="true"></ext:ListItem>
                                                        <ext:ListItem Text="按主机手统计" Value="2"></ext:ListItem>
                                                    </Items>
                                                </ext:ComboBox>
                                            </Items>
                                        </ext:Container>
