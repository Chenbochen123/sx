...
public partial class Manager_Rubber_Report_RubberBackDetailReport : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, DirectEventArgs e)
    {
        ...
        DataTable dt = rubberStorageManager.GetTableStoreBackDetailReport(queryParams);
        if (dt == null)
        {
        ...
        report.Load(Server.MapPath("RubberBackDetailReport.frx"));
        //绑定数据源
