<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RubberInvalid.aspx.cs" Inherits="Manager_Rubber_RubberInvalid" %>
                    ...
                    <ext:Toolbar runat="server" ID="tbReport">
                        <Items>
                            ...
                            <ext:Button runat="server" Icon="ApplicationEdit" Text="审核" ID="btn_add">
                                <ToolTips>
                                    <ext:ToolTip ID="ttAdd" runat="server" Html="点击进行审核" />
                                </ToolTips>
                                <DirectEvents>
                            ...
                            <ext:Button runat="server" Icon="ApplicationEdit" Text="延期处理" ID="Button2">
                                <ToolTips>
                                    <ext:ToolTip ID="ToolTip1" runat="server" Html="点击进行处理" />
                                </ToolTips>
                                <DirectEvents>
                            ...
                            <ext:Button runat="server" Icon="ApplicationEdit" Text="删除" ID="Button3">
                                <ToolTips>
                                    <ext:ToolTip ID="ToolTip2" runat="server" Html="点击进行处理" />
                                </ToolTips>
                                <DirectEvents>
            ...
            <ext:GridPanel ID="pnlList" runat="server" Collapsible="true" Title="超期物料处理审核" Region="Center">
                ...
                <ColumnModel ID="colModel" runat="server">
                    <Columns>
                        ...
                        <ext:DateColumn ID="Column7" Format="yyyy-MM-dd HH:mm:ss" runat="server" Text="保质期" DataIndex="保质期" Flex="1" />
                        ...
                        <ext:DateColumn Format="yyyy-MM-dd HH:mm:ss" ID="Column25" runat="server" Text="审核日期" DataIndex="审核日期" Flex="1" />
                        <ext:Column ID="Column26" runat="server" Text="备注" DataIndex="备注" Flex="1" />
                    </Columns>
                </ColumnModel>
                <BottomBar>
