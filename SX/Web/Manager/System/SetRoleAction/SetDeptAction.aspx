<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SetDeptAction.aspx.cs" Inherits="Manager_System_SetRoleAction_SetDeptAction" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var setRole = function () {
            ...
            Ext.Msg.confirm("提示", '您确定设置选择部门的权限吗？', function (btn) { doSetRole(btn, depts, actions) });
            return false;
        }
    </script>
</head>
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server" ID="toolbar1">
                            <Items>
                                ...
                                <ext:Button runat="server" Icon="FolderWrench" Text="设置部门权限" ID="btnSetRole">
                                    <Listeners>
