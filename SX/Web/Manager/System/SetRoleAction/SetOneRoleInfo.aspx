<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SetOneRoleInfo.aspx.cs" Inherits="Manager_System_SetRoleAction_SetOneRoleInfo" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var roleItemClick = function (view, record, node, index, event, fn) {
            App.Manager_System_SetRoleAction_SetDeptOneRole_Window.setTitle("设置部门角色[" + record.data.RoleName + "]");
            App.Manager_System_SetRoleAction_SetUserOneRole_Window.setTitle("设置用户角色[" + record.data.RoleName + "]");
    ...
    <script type="text/javascript">
        ...
        Ext.create("Ext.window.Window", {
            id: "Manager_System_SetRoleAction_SetDeptOneRole_Window",
            html: "<iframe src='SetDeptOneRole.aspx' width=100% height=100% scrolling=no  frameborder=0></iframe>",
            bodyStyle: "background-color: #fff;",
            bodyPadding: 5,
            height: 500,
            width: 600,
        ...
        Ext.create("Ext.window.Window", {
            id: "Manager_System_SetRoleAction_SetUserOneRole_Window",
            html: "<iframe src='SetUserOneRole.aspx' width=100% height=100% scrolling=no  frameborder=0></iframe>",
            bodyStyle: "background-color: #fff;",
            bodyPadding: 5,
            height: 500,
            width: 800,
        ...
        var Manager_System_SetRoleAction_SetDeptOneRole_Request = function () {
            App.TreePanel3.store.reload();
        }
        var SetDeptOneRole = function () {
            ...
            var window = App.Manager_System_SetRoleAction_SetDeptOneRole_Window;
        ...
        var Manager_System_SetRoleAction_SetUserOneRole_Request = function () {
            App.TreePanel3.store.reload();
        }
        var SetUserOneRole = function () {
            ...
            var window = App.Manager_System_SetRoleAction_SetUserOneRole_Window;
                                        ...
                                        <ext:GridPanel ID="TreePanel3" runat="server" Flex="1" Region="Center" Collapsible="false" RootVisible="false" MultiSelect="true"
                                            ...
                                            <ColumnModel ID="columnModel1" runat="server">
                                                <Columns>
                                                    ...
                                                    <ext:Column ID="Column2" DataIndex="Remark" runat="server" Text="备注" Flex="1" />
                                                </Columns>
                                            </ColumnModel>
                                        </ext:GridPanel>
                                    </Items>
