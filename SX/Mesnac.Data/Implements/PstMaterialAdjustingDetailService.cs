...
namespace Mesnac.Data.Implements
{
    ...
    public class PstMaterialAdjustingDetailService : BaseService<PstMaterialAdjustingDetail>, IPstMaterialAdjustingDetailService
    {
		#region 构造方法

        public PstMaterialAdjustingDetailService() : base(){ }

        public PstMaterialAdjustingDetailService(string connectStringKey) : base(connectStringKey){ }

        public PstMaterialAdjustingDetailService(NBear.Data.Gateway way) : base(way){ }
        ...
        public class QueryParams
        {
            ...
            public PageResult<PstMaterialAdjustingDetail> pageParams { get; set; }
        }

        public PageResult<PstMaterialAdjustingDetail> GetTablePageDataBySql(QueryParams queryParams)
        {
            PageResult<PstMaterialAdjustingDetail> pageParams = queryParams.pageParams;
            ...
            sqlstr.AppendLine(@"select A.Barcode, A.StorageID, B.StorageName, A.StoragePlaceID, C.StoragePlaceName, A.OrderID, A.RecordDate, 
                                ...
                                from PstMaterialAdjustingDetail A
