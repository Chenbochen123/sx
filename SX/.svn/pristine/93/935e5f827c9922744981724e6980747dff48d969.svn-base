<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Main.aspx.cs" Inherits="Manager_Technology_Manage_MaterialRecipeDetail_Main" %>
            ...
            <Items>
                <ext:Panel ID="pnlMain" runat="server" Header="true" Region="Center" AutoHeight="true" Title="配方基本信息" AutoScroll="true">
                    <Items>
                                    ...
                                    <Items>
                                        <ext:CheckboxGroup ID="CheckboxGroup1" runat="server" ColumnsNumber="3" Flex="1" AnchorHorizontal="true">
                                            <Items>
                                                ...
                                                <ext:TriggerField ID="txtRecipeEquipName" runat="server" Flex="1" FieldLabel="机台名称" LabelAlign="Right" Editable="false" ReadOnly="true">
                                                    <Triggers>
                                             ...
                                             <ext:TextField ID="txtRecipeVersionID" runat="server" LabelAlign="Right" Flex="1" MaxLength="4" FieldLabel="版本号" ReadOnly="true" />
                                                ...
                                                <ext:TextField ID="txtbanben" runat="server" LabelAlign="Right" Flex="1" FieldLabel="工艺版本号"  />
                                                <ext:TextField ID="txtYonghu" runat="server" LabelAlign="Right" Flex="1" FieldLabel="用户版本号"  />
                                                         <ext:ComboBox ID="txtFactory" runat="server" LabelAlign="Right" Flex="1" FieldLabel="配方供应商" SelectOnTab="true" Editable="false"  Hidden="true"/>
                                                <ext:TextField ID="txtB_Version" runat="server" LabelAlign="Right" Flex="1" MaxLength="4" FieldLabel="胶料PLM版本" Editable="false" Readonly="true"  Hidden="true"/>
                                                <ext:TextField ID="txtR_Version" runat="server" LabelAlign="Right" Flex="1" MaxLength="4"  FieldLabel="工艺PLM版本"  Editable="false" Readonly="true"  Hidden="true"/>
                                                        <ext:ComboBox ID="ComboBoxCC" runat="server" LabelAlign="Right" Flex="1" FieldLabel="关闭除尘" SelectOnTab="true" Editable="false"  Hidden="true"/>
                                                                           <ext:ComboBox ID="txJieDuan" runat="server" LabelAlign="Right" Flex="1" FieldLabel="配方阶段" SelectOnTab="true" Editable="false"  Hidden="true" />
                                                        <ext:TextField ID="txtSapVersionId" runat="server" LabelAlign="Right" Flex="1"  FieldLabel="SAP版本号"  SelectOnTab="true" Editable="false"  Hidden="true"/>
                        ...
                        <ext:Panel ID="Panel2" runat="server" Header="true" Layout="AnchorLayout" AutoHeight="true" Title="配方审核信息"  Hidden="true">
                            <Items>
