<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlanFinish.aspx.cs" Inherits="Manager_ProducingPlan_PlanEntering_PlanFinish" %>
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="BorderLayout">
            <Items>
                <ext:Panel ID="Panel20" runat="server" Region="North" AutoHeight="true">
                    ...
                    <Items>
                        <ext:Container ID="container1" runat="server" Layout="HBoxLayout" Padding="5">
                            <Items>
                                <ext:DateField ID="txtBeginTime" runat="server" FieldLabel="生产日期" LabelAlign="Right">
                                </ext:DateField>
                                <ext:ComboBox ID="txtPptShift" runat="server" SelectOnTab="true" Editable="false" LabelAlign="Right" FieldLabel="班次">
                                </ext:ComboBox>
                ...
                <ext:Panel ID="Panel1" runat="server" Region="Center" AutoHeight="true" Layout="BorderLayout" Flex="1">
                    <Items>
                        <ext:GridPanel ID="gridPanel1" runat="server" Region="Center" Frame="true" Title="计划完成信息">
                            <Store>
