<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RubberStoreOutDetailReport.aspx.cs" Inherits="Manager_Rubber_Report_RubberStoreOutDetailReport" %>
                    ...
                    <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                        <Items>
                            <ext:Container ID="container1" runat="server" Layout="FormLayout" ColumnWidth=".3"
                               ...
                               <ext:FieldContainer ID="FieldContainer1" runat="server" FieldLabel="扫描开始时间" Layout="HBoxLayout" LabelAlign="Right" Flex="1">
                                                    <Items>
                                                        ...
                                                        <ext:TextField ID="txtBeginTime2" runat="server" Flex="4">
                                                            <Plugins>
                                    ...
                                    <ext:ComboBox ID="cbxShiftClass" runat="server"  FieldLabel="班组" Hidden="true"
                                        LabelAlign="Right">
                                        <Items>
                            ...
                            <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".3"
                                Padding="5">
                                <Items>
                                  <ext:TriggerField ID="txtEquipCode" runat="server" FieldLabel="机台" LabelAlign="Right"
                                        Editable="false">
                                        <Triggers>
                                 ...
                                 <ext:FieldContainer ID="FieldContainer2" runat="server" FieldLabel="扫描结束时间" Layout="HBoxLayout" LabelAlign="Right" Flex="1">
                                                        <Items>
                                                            <ext:DateField ID="txtEndTime" runat="server" Format="yyyy-MM-dd" Flex="6" />
                                                            <ext:TextField ID="txtEndTime2" runat="server" Flex="4">
                                                                <Plugins>
                                    ...
                                    <ext:ComboBox ID="cbxShift" runat="server" FieldLabel="班次" Hidden="true"
                                        LabelAlign="Right">
                                        <Items>
                                            <ext:ListItem Text="全部" Value="all">
                                            </ext:ListItem>
                            ...
                            <ext:Container ID="container3" runat="server" Layout="FormLayout" ColumnWidth=".3"
                                Padding="5">
                                <Items>
                                    <ext:TriggerField ID="txtToStorageCheckName" runat="server" FieldLabel="领料单位" LabelAlign="Right" Hidden="true"
                            ...
                            <ext:Container ID="container4" runat="server" Layout="FormLayout" ColumnWidth=".2"
                                ...
                                <Items>
                                    <ext:TriggerField ID="txtStorageName" runat="server" FieldLabel="库房名称" LabelAlign="Right"
                                        Flex="1" Editable="false" Hidden="true">
                                        <Triggers>
                                            <ext:FieldTrigger Icon="Clear" HideTrigger="true" />
                                            <ext:FieldTrigger Icon="Search" />
                                        </Triggers>
                            ...
                            <ext:Container ID="container5" runat="server" Layout="FormLayout" ColumnWidth=".2"
                                Padding="5">
                                <Items>
                                    <ext:TriggerField ID="txtMakerPerson" runat="server" FieldLabel="处理人" LabelAlign="Right" Hidden="true"
                                        Editable="false">
                                        <Triggers>
