<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LotReport.aspx.cs" Inherits="Manager_Technology_Report_LotReport" %>
                            ...
                            <Items>
                                ...
                                <ext:Chart ID="Chart1" runat="server" StyleSpec="background:#fff;font-size:9pt" Shadow="true"  Theme="Browser:gradients" Animate="true">
                                    ...
                                    <Axes>
                                        ...
                                        <ext:NumericAxis Position="Bottom" Grid="true" MajorTickSteps="20"  Maximum="315" Minimum="0" Title="时间(S)" />
                                    </Axes>
                                    <Series>
                                    ...
                                    <Items>
                                        <ext:CheckboxGroup ID="CheckboxGroup4" runat="server" ColumnsNumber="1" AnchorHorizontal="true">
                                            <Items>
                                                ...
                                                <ext:TextField ID="txtZhuanzi" runat="server" ReadOnly="true" Flex="1" LabelAlign="Right" FieldLabel="转子温度" InputWidth="100" LabelWidth="60" />
                                                <ext:TextField ID="txtCebi" runat="server" ReadOnly="true" Flex="1" LabelAlign="Right" FieldLabel="侧壁温度" InputWidth="100" LabelWidth="60" />
                                                <ext:TextField ID="txtXieliaomen" runat="server" ReadOnly="true" Flex="1" LabelAlign="Right" FieldLabel="卸料门温度" InputWidth="100" LabelWidth="60" />
                                            </Items>
                                        </ext:CheckboxGroup>
                                    </Items>
                                </ext:Container>
