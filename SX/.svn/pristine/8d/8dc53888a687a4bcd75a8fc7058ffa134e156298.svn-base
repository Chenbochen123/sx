...
namespace Mesnac.Data.Components
{
    ...
    public class PageResult<T> where T : NBear.Common.Entity, new()
    {
        ...
        private NBear.Common.WhereClip wc = NBear.Common.WhereClip.All;             //不调用存储过程分页的条件
        private NBear.Common.OrderByClip obc = NBear.Common.OrderByClip.Default;    //不调用存储过程分页排序
