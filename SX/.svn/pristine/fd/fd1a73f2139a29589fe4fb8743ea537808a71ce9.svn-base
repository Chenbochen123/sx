...
public partial class Manager_System_ShowRoleAction_ShowDeptRole : Mesnac.Web.UI.Page
{
    #region 权限定义
    ...
    public string GetActionInfo(string dept)
    {
        ...
        EntityArrayList<SysDeptRole> lst = sysDeptRoleManager.GetListByWhere(SysDeptRole._.DeptCode == dept);
