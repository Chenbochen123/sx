<%@ page language="C#" autoeventwireup="true" inherits="Manager_ProducingPlan_BarcodeScan_BarCodeMissScan, App_Web_bpijjdo5" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var SetChkFlag = function () {
            ...
            Ext.Msg.confirm("提示", '确定要补充条码吗？', function (btn) { commandcolumn_direct_sendchkflag(btn) });
    ...
    <ext:Viewport ID="Viewport1" runat="server" Layout="BorderLayout">
        <Items>
            ...
            <ext:GridPanel ID="GridPanel1" runat="server" Region="Center" AnimCollapse="true">
                <Store>
                    <ext:Store ID="Store2" runat="server" IgnoreExtraFields="false" PageSize="10">
                        <Proxy>
                    ...
                    <Items> 
                        <ext:FormPanel ID="pnlEdit" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                ...
                                <ext:TextField ID="modify_sbarcode" runat="server" FieldLabel="补充条码" LabelAlign="Left"  AllowBlank="false"  />
                               </Items>
