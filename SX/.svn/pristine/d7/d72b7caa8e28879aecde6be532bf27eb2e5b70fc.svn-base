<%@ page language="C#" autoeventwireup="true" inherits="Manager_Technology_Manage_MaterialRecipe, App_Web_zqfhdfip" %>
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="BorderLayout">
            <Items>
                <ext:Panel ID="Panel20" runat="server" Region="North" AutoHeight="true">
                        ...
                        <ext:Toolbar runat="server" ID="barUser">
                            <Items>
                                ...
                                <ext:ToolbarSeparator ID="toolbarSeparator2" />
                                 <ext:Button runat="server" Icon="DiskDownload" Text="导入配方" ID="Button1" Hidden="false">
                                    <ToolTips>
                    ...
                    <Items>
                        <ext:Container ID="container1" runat="server" Layout="ColumnLayout"  Height="45" Padding="5">
                            <Items>
                    ...
                    <Items>
                        ...
                        <ext:Panel ID="Panel2" runat="server" Region="Center" AutoHeight="true" Layout="BorderLayout">
                            <Items>
                                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center" Frame="true" Title="机台配方基本信息">
                                                ...
                                                <ext:Model ID="model" runat="server" Name="gridPanelCenterStoreModel">
                                                    <Fields>
                                                        ...
                                                        <ext:ModelField Name="AuditFlagName" />
                                                         <ext:ModelField Name="JieDuanName" />
                                                    </Fields>
                                                </ext:Model>
                                            </Model>
                                            <Listeners>
                                    ...
                                    <ColumnModel ID="columnModel" runat="server">
                                        <Columns>
                                            ...
                                            <ext:Column ID="Column1" DataIndex="JieDuanName" runat="server" Text="配方阶段" Align="Center" Width="80" />
                                ...
                                <ext:FormPanel ID="DetailPanel" runat="server" Region="South" Layout="AnchorLayout" Title="配方基本信息" Height="200" AutoScroll="true">
                                    <Items>
                                        ...
                                        <ext:Container ID="container6" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                            <Items>
                                                <ext:Container ID="container7" runat="server" Layout="FormLayout" Padding="5" ColumnWidth=".33">
                                                    <Items>
                                                        <ext:TextField ID="txtRecipeObjID" runat="server" ReadOnly="true" Flex="1" LabelAlign="Right" FieldLabel="配方唯一标示" Name="ObjID" />
                                                    </Items>
                                                </ext:Container>
                                                <ext:Container ID="container8" runat="server" Layout="FormLayout" Padding="5" ColumnWidth=".66">
                                                    <Items>
                                                        <ext:TextField ID="TextField25" runat="server" ReadOnly="true" Flex="1" LabelAlign="Right" FieldLabel="备注" Name="Remark" />
                                                    </Items>
                                                </ext:Container>
                                            </Items>
                                        </ext:Container>
