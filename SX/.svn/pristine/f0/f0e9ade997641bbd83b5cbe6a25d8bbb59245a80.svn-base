<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PressureVessel.aspx.cs" Inherits="Manager_Equipment_EquipRepairProtectPlan_PressureVessel" %>
    ...
    <script type="text/javascript">
        ...
        var cmdcol_click = function (command, record) {
            if (command == "Delete") {
                ...
                App.direct.pnlList_Add(record.data.iid, record.data.serialid, record.data.depname, record.data.Workshop, record.data.equip_name, record.data.use_No,
                    record.data.equip_Code, record.data.made_date1, record.data.fac_no, record.data.Use_pos, record.data.CYCLE, record.data.check_date,
                    record.data.check_next, record.data.Equip_State, record.data.made_fac, record.data.user_date1, record.data.mem2,
                    {
                    success: function () { },
                    failure: function () { }
                });
        ...
        var addEmployee = function () {
            ...
            store.insert(0, {
                ...
                use_No: '',
                equip_Code: '',
                made_date1: Ext.Date.clearTime(new Date()),
                fac_no: '',
                Use_pos: '',
                CYCLE: '',
                ...
                <Store>
                            ...
                            <Model>
                                <ext:Model ID="model" runat="server" IDProperty="iid">
                                    <Fields>
                                        ...
                                        <ext:ModelField Name="made_date1"  Type="Date"/>
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="Column16" runat="server" Text="单位" DataIndex="depname" Width="65">
                                <Editor>
                                    <ext:TextField runat="server" AllowBlank="false" />
                                </Editor>
                            </ext:Column>
                            ...
                            <ext:Column ID="Column5" runat="server" Text="使用证编号" DataIndex="use_No" Width="110">
                                <Editor>
                                    <ext:TextField runat="server" AllowBlank="false" />
                                </Editor>
                            </ext:Column>
                            <ext:Column ID="Column6" runat="server" Text="内部编号" DataIndex="equip_Code" Width="90">
                                <Editor>
                                    <ext:TextField runat="server" AllowBlank="false" />
                                </Editor>
                            </ext:Column>
                            
                            <ext:DateColumn ID="DateColumn3" runat="server" Text="制造日期" DataIndex="made_date1" Width="110" Format="yyyy-MM-dd" >
                                <Editor>
                                    <ext:DateField
                                        runat="server"
                                        AllowBlank="false"
...
<%--                            <ext:DateColumn ID="txtnextdate" runat="server" Text="下次检测日期" DataIndex="check_next" Width="100" Format="yyyy-MM-dd">
                            ...
                            <ext:Column ID="Column2" runat="server" Text="使用状态" DataIndex="Equip_State" Width="100">
                                <Editor>
                                    <ext:TextField runat="server" AllowBlank="true" />
                                </Editor>
                            </ext:Column>
                            <ext:Column ID="Column8" runat="server" Text="生产厂家" DataIndex="made_fac" Width="100">
                                <Editor>
                                    <ext:TextField runat="server" AllowBlank="true" />
                                </Editor>
                            </ext:Column>
                            <ext:DateColumn ID="DateColumn4" runat="server" Text="安装时间" DataIndex="user_date1" Width="110" Format="yyyy-MM-dd" >
                                <Editor>
                                    <ext:DateField
                                        runat="server"
                                        AllowBlank="false"
                            ...
                            <ext:Column ID="Column15" runat="server" Text="备注" DataIndex="mem2" Width="100">
                                <Editor>
                                    <ext:TextField runat="server" AllowBlank="true" />
                                </Editor>
                            </ext:Column>
