<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintReaSon - other.aspx.cs" Inherits="Manager_RubberQuality_BasicInfo_PrintReaSon_other" %>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="MaterialName" runat="server" Text="返回原因" DataIndex="Reason" Width="150"  />
                            <ext:Column ID="marjor_type_name" runat="server" Text="备注" DataIndex="Remark" Width="150"  />
                        
                             <ext:CommandColumn ID="commandCol" runat="server" Width="60" Text="操作" Align="Center">
                                <Commands>
                                    <ext:GridCommand Icon="TableEdit" CommandName="Edit" Text="删除">
                                        <ToolTip Text="删除本条数据" />
                                    </ext:GridCommand>
                        ...
                        <ext:FormPanel ID="pnlEdit" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                    ...
                                    <ext:TextField ID="modify_MN" runat="server" FieldLabel="内容" LabelAlign="Left"  />
                                                          ...
                                                          <ext:CheckboxGroup ID="CheckboxGroupxm" runat="server"   Width="380" Height="150"  FieldLabel="备注" LabelAlign="Left" ColumnsNumber="4" Flex="1" AnchorHorizontal="true">
                                        </ext:CheckboxGroup>
                           </Items>
                           <%--  <Listeners>
                        ...
                        <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5">
                            ...
                            <Items>
                                ...
                                <ext:TextField ID="add_nr" runat="server" FieldLabel="内容" LabelAlign="Left" />
                                                <ext:CheckboxGroup ID="CheckboxGroupAdd" runat="server"   Width="380" Height="150"  FieldLabel="备注" LabelAlign="Left" ColumnsNumber="4" Flex="1" AnchorHorizontal="true">
                                        </ext:CheckboxGroup>
                                                          </Items>
                            <Listeners>
