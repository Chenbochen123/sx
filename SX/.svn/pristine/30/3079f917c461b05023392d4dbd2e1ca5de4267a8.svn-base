<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterialStorageAdjustInsert.aspx.cs" Inherits="Manager_Storage_MaterialStorageAdjustInsert" %>
            ...
            App.direct.btnSave_Click({
                success: function (result) {
                    ...
                    if (result == "false")
                        ...
                        Ext.Msg.alert('操作', "您选择的源库房物料小于您设置的领料数量，请检查！");
...
<body>
    ...
    <ext:Viewport ID="vpAdjustBill" runat="server" Layout="border">
        <Items>
                ...
                <TopBar>
                    <ext:Toolbar runat="server" ID="tbAdjustBill">
                        <Items>
                            ...
                            <ext:Button runat="server" Icon="TableEdit" Text="生成领料单" ID="GenStorageOut" Disabled="true">
                                <Listeners>
                    ...
                    <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                        <Items>
                            <ext:Container ID="container4" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                Padding="5">
                                <Items>
                                    <ext:TextField ID="txtBillNo1" runat="server" FieldLabel="领料单号" Text="(自动生成)" LabelAlign="Left" ReadOnly="true" />
                                    <ext:DateField ID="txtAdjustDate1" runat="server" FieldLabel="领料日期" LabelAlign="Left" IndicatorText="*" IndicatorCls="red-text" AllowBlank="false" />
                                </Items>
                            </ext:Container>
                            <ext:Container ID="container5" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                ...
                                <Items>
                                    ...
                                    <ext:TriggerField ID="txtTargetStorage1" runat="server" FieldLabel="发往库房" LabelAlign="Left" Editable="false" IndicatorText="*" IndicatorCls="red-text"  AllowBlank="false">
                                        <Triggers>
                                            <ext:FieldTrigger Icon="Search" />
                                        </Triggers>
                                        <RemoteValidation OnValidation="CheckField" />
                            ...
                            <ext:Container ID="container6" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                ...
                                <Items>
                                    ...
                                    <ext:TextField ID="txtSourceStorage1" runat="server" FieldLabel="源库房" ReadOnly="true" />
                    ...
                    <ext:GridPanel ID="pnlTempList" runat="server">
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="Column5" runat="server" Text="领料数量" DataIndex="AdjustNum" Flex="1" />
                                <ext:Column ID="Column6" runat="server" Text="领料重量" DataIndex="AdjustWeight" Flex="1" />
            ...
            <ext:Window ID="winModifyDetail" runat="server" Icon="MonitorEdit" Closable="true" Title="修改领料明细信息"
