<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterialStorageAdjust.aspx.cs" Inherits="Manager_ShopStorage_MaterialStorageAdjust" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_edit = function (record) {
            ...
            var url = "ShopStorage/MaterialStorageAdjustInsert.aspx?BillNo=" + BillNo;
            var tabid = "Manager_ShopStorage_MaterialStorageAdjustInsert";
        ...
        var commandcolumn_direct_sendlockedflag = function (btn) {
            ...
            App.direct.btnBatchLocked_Click({
                success: function (result) {
                    if(result=="false")
                        Ext.Msg.alert('操作', "该单据已经审核退库！");
                    else if (result == "false1")
                        Ext.Msg.alert('操作', "您要求的退库数量大于库存数量，请检查！");
                    else
                        Ext.Msg.alert('操作', result);
                },
        ...
        var SetChkResultFlag = function () {
            ...
            if (section && section.length == 0) {
                ...
                Ext.Msg.confirm("提示", '确定要审核退库吗？', function (btn) { commandcolumn_direct_sendlockedflag(btn) });
            }
        }
...
<body>
    ...
    <ext:Viewport ID="vpChkBill" runat="server" Layout="border">
        <Items>
                ...
                <TopBar>
                    <ext:Toolbar runat="server" ID="tbChkBill">
                        <Items>
                            ...
                            <ext:Button runat="server" Icon="LockEdit" Text="撤销退库" ID="Button2">
                                <Listeners>
                        ...
                        <Items>
                            <ext:Container ID="container1" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                ...
                                <Items>
                                    ...
                                    <ext:ComboBox ID="cbxChkResultFlag" runat="server" FieldLabel="是否退库" OnDirectChange="cbxChkResultFlag_change" LabelAlign="Right">
                                        <SelectedItems>
                    ...
                    <ext:GridPanel ID="pnlList" runat="server">
                        ...
                        <ColumnModel ID="colModel" runat="server">
                            <Columns>
                                ...
                                <ext:DateColumn ID="inStockDate" runat="server" Text="退库日期" DataIndex="AdjustDate"
            ...
            <ext:Panel ID="pnlSouth" runat="server" Region="South" Title="退库单明细数据" Height="200" Icon="Basket" Layout="Fit" Collapsible="true" 
                    ...
                    <ext:GridPanel ID="pnlDetailList" runat="server" MarginsSummary="0 5 5 5">
                        ...
                        <ColumnModel ID="ColumnModelDetail" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="AdjustNum" runat="server" Text="退库数量" DataIndex="AdjustNum" Flex="1" />
                                <ext:Column ID="AdjustWeight" runat="server" Text="退库重量" DataIndex="AdjustWeight" Flex="1" />
                            </Columns>
                        </ColumnModel>
                        <SelectionModel>
