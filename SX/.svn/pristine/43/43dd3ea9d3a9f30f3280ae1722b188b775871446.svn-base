<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckRubberQualityEquipCPKReport.aspx.cs"
    Inherits="Manager_RubberQuality_Manage_CheckRubberQualityEquipCPKReport" %>
