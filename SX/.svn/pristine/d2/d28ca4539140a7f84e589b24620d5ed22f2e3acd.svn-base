                                ...
                                <ext:FieldSet ID="FieldSet2" runat="server" Title="计划完成情况">
                                    <Items>
                                        ...
                                        <ext:FieldContainer ID="FieldContainer11" runat="server" Layout="HBoxLayout" AnchorHorizontal="100%">
                                            <Items>
                                                <ext:DateField ID="txtJL_RealDate1" runat="server" FieldLabel="实际校准日期" Width="208"  Editable="false"  allowblank="false"/>
                                                <ext:FieldContainer ID="FieldContainer14" runat="server" FieldLabel="校准工时">
                                                    <Items>
                                                        <ext:TextField ID="txtJL_RealDay1" runat="server" Width="100" Editable="true" allowblank="false"/>
                                                    </Items>
                                                </ext:FieldContainer>
                                            </Items>
                                        </ext:FieldContainer>
                                        <ext:FieldContainer ID="FieldContainer15" runat="server" Layout="HBoxLayout" AnchorHorizontal="100%">
                                            <Items>
                                                <ext:ComboBox ID="cbohandle_name1" runat="server" Disabled="false" Width="208"  FieldLabel="校准人" allowblank="false"/>
