<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryEquipmentPart.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryEquipmentPart" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var gridPanelRefresh = function () {
            App.hidden_equip_type.setValue(parent.App.hidden_equip_type.getValue());
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryEquipPartInfo_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryEquipPartInfo_Window.close();
            return false;
        }
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="viewport" runat="server" Layout="BorderLayout">
            <Items>
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="obj_id" DataIndex="ObjID" runat="server" Text="部件代码" Width="120" />
                            <ext:Column ID="part_name" DataIndex="PartName" runat="server" Text="部件名称" Flex="1" />
                ...
                <ext:Hidden ID="hidden_equip_type" runat="server"></ext:Hidden>
            </Items>
        </ext:Viewport>
    </form>
</body>
