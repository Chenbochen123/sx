...
public partial class Manager_Rubber_Report_RubberAdjustReport : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, DirectEventArgs e)
    {
        ...
        DataTable dt = rubberAdjustManager.GetRubberAdjustReportBySql(queryParams).Tables[0];
        if (dt == null)
        {
        ...
        report.Load(Server.MapPath("RubberAdjustReport.frx"));
        //绑定数据源
