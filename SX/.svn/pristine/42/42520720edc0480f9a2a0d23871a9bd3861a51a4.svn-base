...
public partial class Manager_ProducingPlan_Yaopin : Mesnac.Web.UI.Page
{
    ...
    public System.Data.DataSet GetDataByParas()
    {
        ...
        #region
        sb.AppendLine(@"exec proc_sumXLBag '" + daDateTime.SelectedDate.ToShortDateString() + "','" + daDateTimeEnd.SelectedDate.ToShortDateString() + "',0");
