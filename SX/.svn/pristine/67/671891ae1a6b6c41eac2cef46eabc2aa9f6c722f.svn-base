<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckRubberItemAvgTrendReport.aspx.cs"
    Inherits="Manager_RubberQuality_Manage_CheckRubberItemAvgTrendReport" %>
