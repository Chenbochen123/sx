<%@ page language="C#" autoeventwireup="true" inherits="Manager_RubberQuality_Manage_CheckRubberLBEquipDataReport, App_Web_bsjgrvuf" %>
        ...
        <Items>
            ...
            <ext:Panel runat="server" ID="PanelNorth" Region="North" Layout="ColumnLayout">
                ...
                <Items>
                    ...
                    <ext:ComboBox runat="server" ID="ComboBoxNorthWorkshop" FieldLabel="车间" LabelAlign="Right"
                        Editable="false">
                    </ext:ComboBox>
                    <ext:ComboBox runat="server" ID="ComboBoxNorthItemType" FieldLabel="机台类型" LabelAlign="Right"
                        Editable="false">
                    </ext:ComboBox>
                </Items>
            </ext:Panel>
