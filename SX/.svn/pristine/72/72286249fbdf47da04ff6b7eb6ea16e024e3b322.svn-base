<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MixType.aspx.cs" Inherits="Manager_BasicInfo_EquipmentInfo_MixType" %>
    ...
    <form id="fmUnit" runat="server">
        ...
        <ext:Viewport ID="vwUnit" runat="server" Layout="border">
            <Items>
                                ...
                                <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container_1" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:TextField ID="txt_obj_id" Vtype="integer" runat="server" FieldLabel="密炼类型编号" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                                        <ext:Container ID="container_2" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:TextField ID="txt_mix_name" runat="server" FieldLabel="密炼类型名称" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                            ...
                            <Model>
                                <ext:Model ID="model" runat="server">
                                    <Fields>
                                        ...
                                        <ext:ModelField Name="MixName" />
                                        <ext:ModelField Name="MixCubage" />
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="obj_id" runat="server" Text="密炼类型编号" DataIndex="ObjID" Width="150"  />
                            <ext:Column ID="mix_name" runat="server" Text="密炼类型名称" DataIndex="MixName" Width="150"  />
                            <ext:Column ID="mix_cubage" runat="server" Text="密炼机容积" DataIndex="MixCubage" Width="150"  />
                ...
                <ext:Window ID="winModify" runat="server" Icon="MonitorEdit" Closable="false" Title="修改密炼类型信息"
                    ...
                    <Items> 
                        <ext:FormPanel ID="pnlEdit" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                <ext:TextField ID="modify_obj_id" runat="server" FieldLabel="密炼类型编号"   LabelAlign="Left" ReadOnly=true Hidden=true Enabled="true" />
                                <ext:TextField ID="modify_mix_name" runat="server" FieldLabel="密炼类型名称" LabelAlign="Left" MaxLength="50" AllowBlank=false IndicatorText="*" IndicatorCls="red-text" IsRemoteValidation=true   >
                                    <RemoteValidation  OnValidation = "CheckMixName" />
                                </ext:TextField>
                                <ext:NumberField ID="modify_mix_cubage" runat="server" FieldLabel="密炼机容积" LabelAlign="Left"  MaxLength="50" />
                ...
                <ext:Window ID="winAdd" runat="server" Icon="MonitorAdd" Closable="false" Title="添加密炼类型信息"
                    Width="320" Height="240" Resizable="false" Hidden="true" Modal="false" BodyStyle="background-color:#fff;"
                    BodyPadding="5" Layout="Form">
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5">
                            ...
                            <Items>
                                <ext:TextField ID="add_mix_name" runat="server" FieldLabel="密炼类型名称"  LabelAlign="Left" MaxLength="50" AllowBlank=false IndicatorText="*" IndicatorCls="red-text" IsRemoteValidation=true  >
                                    <RemoteValidation  OnValidation = "CheckMixName" />
                                </ext:TextField>
                                <ext:NumberField ID="add_mix_cubage" runat="server" FieldLabel="密炼机容积" LabelAlign="Left" />
                ...
                <ext:Hidden ID="hidden_mix_name"  runat="server"></ext:Hidden>
