<%@ page language="C#" autoeventwireup="true" inherits="Manager_ProducingPlan_ShiftSeting_ShiftSeting, App_Web_vi5vqyds" %>
                ...
                <TopBar>
                    <ext:Toolbar runat="server" ID="ctl320">
                        <Items>
                            ...
                            <ext:Button runat="server" IconCls="BookAdd" Text="工序" ID="btnPro">
                                <Listeners>
                            ...
                            <ext:Button runat="server" IconCls="Time" Text="时间" ID="btnTime">
                                <Listeners>
                            ...
                            <ext:Button runat="server" IconCls="Anchor" Text="规律" ID="btnRule" >
                                <Listeners>
                            ...
                            <ext:Button runat="server" IconCls="Add" Text="设定" ID="btnSeting">
                                <Listeners>
                            ...
                            <ext:Button runat="server" IconCls="Find" Text="查询" ID="btnSearch">
                                <DirectEvents>
...
<%--                        <ext:Column ID="Column10" runat="server" Text="工序1" Flex="1" DataIndex="facid" />
    ...
    <ext:Window ID="AddShiftWindow" runat="server" Icon="Add" Closable="true" Title="班次设定"
        Width="320" Height="340" Resizable="false" Hidden="true" Modal="false" BodyStyle="background-color:#fff;"
    ...
    <ext:Window ID="winModify" runat="server" Icon="MonitorEdit" Closable="true" Title="修改班次"
        Width="300" Height="340" Hidden="true" Modal="false" BodyStyle="background-color:#fff;"
        Layout="Form">
        <Items>
