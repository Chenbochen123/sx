<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryMaterialMinorType.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryMaterialMinorType" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryMaterialMinorType_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryMaterialMinorType_Window.close();
            return false;
        }
                                ...
                                <ext:Container ID="container_Query" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container1" runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                                            <Items>
                                                <ext:TextField ID="txtMinorTypeName" runat="server" FieldLabel="物料细类名称" LabelAlign="Right" />
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="ObjID" DataIndex="ObjID" runat="server" Text="物料细类编号" Width="80" />
                            <ext:Column ID="minorTypeName" DataIndex="MinorTypeName" runat="server" Text="物料细类名称" Width="80"/>
