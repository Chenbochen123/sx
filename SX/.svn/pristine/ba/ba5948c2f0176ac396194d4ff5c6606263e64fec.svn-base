...
public partial class Manager_ProducingPlan_PlanEntering_DrugAutoPlanExec : Mesnac.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!X.IsAjaxRequest)
        {
            ...
            this.txtPlanDate.Text = DateTime.Now.ToString("yyyy-MM-dd");
            txtAllPlanDate.Text = DateTime.Now.ToString("yyyy-MM-dd");
            this.txtPlanDate.MinDate = DateTime.Now;
            this.txtAllPlanDate.MinDate = DateTime.Now;
    ...
    {
        this.txtPlanDate.Text = DateTime.Now.ToString("yyyy-MM-dd");
        this.txtAllPlanDate.Text = DateTime.Now.ToString("yyyy-MM-dd");
    ...
    protected void BtnModifySave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
           ...
           ,[Oper_datetime],[Plan_EndTime],[Real_StartTime],[Real_Endtime],[Oper_code],[revise_sgn],[SAP_BillNo],[Message],[ShowFlag],[worker_code],[mem_note],[remark],[FanLianNum],[avgtime],[CJName],[CJweight],[shelfnum],[smallcreate],[createPlanFlag],[DeleteFlag],[xlbagweight]) values('" + planNo + "','" + Convert.ToDateTime(date).ToString("yyyy-MM-dd") + "','" + pptPlan.RecipeEquipCode + "','"
                + pptPlan.RecipeMaterialCode + "','" + pptPlan.RecipeMaterialName + "','" + pptPlan.RecipeVersionID + "','','" + pptPlan.ShiftID + "','" + pptPlan.ClassID + "','" + pptPlan.SerialNum + "','" + pptPlan.PriLevel + "','" + pptPlan.RecipeName + "','" + pptPlan.RecipeType + "','','','','" + pptPlan.TotalWeight + "','" + pptPlan.PlanNum + "','" + pptPlan.PlanWeight + "','" + pptPlan.RealNum + "',cast('0' as numeric(12,3)),'" + pptPlan.UrgencyState + "','" + pptPlan.PlanState + "',CONVERT(varchar(19),GETDATE(),120),'','','','" + pptPlan.OperCode + "','','','','',dbo.FuncGetUserName('" + pptPlan.OperCode + "'),'','','','','',cast('0' as numeric(8,3)),'','','','',cast('0' as numeric(12,3)))";
