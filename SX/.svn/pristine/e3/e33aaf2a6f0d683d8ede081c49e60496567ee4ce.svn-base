...
public partial class Manager_Equipment_BJxiaohao : Mesnac.Web.UI.Page
{
    ...
    public System.Data.DataSet GetDataByParas()
    {
        ...
        #region
        sb.AppendLine(@"exec proc_GetBjXiaoHaoDetail '" + daDateTime.SelectedDate.ToString("yyyy-MM-dd") + "','" + daDateTimeEnd.SelectedDate.ToString("yyyy-MM-dd") + "'");
    ...
    protected void btnExportSubmit_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            new Mesnac.Util.Excel.ExcelDownload().ExcelFileDown(ds, "机台备件消耗");
        }
    }
