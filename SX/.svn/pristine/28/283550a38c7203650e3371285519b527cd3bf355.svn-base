<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckRubberQSReport.aspx.cs"
    Inherits="Manager_RubberQuality_Manage_CheckRubberQSReport" %>
    ...
    <ext:Viewport runat="server" ID="Viewport1" Layout="BorderLayout">
        <Items>
            <ext:Panel runat="server" ID="PanelNorth" Region="North">
                ...
                <Items>
                    <ext:Panel runat="server" ID="PanelNorthQuery" Layout="ColumnLayout" Width="700"
                        Frame="false">
                        <Items>
                            ...
                            <ext:DateField runat="server" ID="DateFieldNorthCheckPlanSDate" Format="yyyy-MM-dd"
                                ...
                                InputWidth="110" LabelWidth="100" ColumnWidth="0.35">
                            </ext:DateField>
                            ...
                            <ext:ComboBox runat="server" ID="ComboBoxNorthCheckType" FieldLabel="分类" LabelAlign="Right"
                                AllowBlank="false" Editable="false" EmptyText="请选择..." InputWidth="90" LabelWidth="80"
                                ColumnWidth="0.3" MatchFieldWidth="false">
                                <Items>
                            ...
                            <ext:ComboBox runat="server" ID="ComboBoxNorthCheckShiftClass" FieldLabel="质检班组"
                                ...
                                MatchFieldWidth="false" LabelWidth="100" ColumnWidth="0.35">
                                <ListConfig Width="70" />
                                <Triggers>
                            ...
                            <ext:ComboBox runat="server" ID="ComboBoxNorthCheckShiftId" FieldLabel="质检班次" LabelAlign="Right"
                                ...
                                LabelWidth="100" ColumnWidth="0.35">
                                <ListConfig Width="70" />
                                <Triggers>
                                    <ext:FieldTrigger Icon="Clear" Qtip="清空" />
                                </Triggers>
                            ...
                            <ext:ComboBox runat="server" ID="ComboBoxNorthWorkShop" FieldLabel="生产车间" LabelAlign="Right"
                                LabelWidth="80" InputWidth="90" EmptyText="全部" Editable="false" ColumnWidth="0.3"
