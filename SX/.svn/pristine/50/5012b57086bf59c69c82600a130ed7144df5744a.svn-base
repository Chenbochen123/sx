<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserInfo.aspx.cs" Inherits="Manager_BasicInfo_UserInfo_UserInfo" %>
...
<head id="Head1" runat="server">
       ...
       //-------部门-----查询带回弹出框--BEGIN
        var Manager_BasicInfo_CommonPage_QueryDepartment_Request = function (record) {//部门返回值处理
            if (!App.winAdd.hidden) {
                ...
                App.Ahidden_depart_code.setValue(record.data.DepCode);
            }
    ...
    <script type="text/javascript">
        //-------岗位-----查询带回弹出框--BEGIN
        var Manager_BasicInfo_CommonPage_QueryWorkPosition_Request = function (record) {//岗位返回值处理
            if (!App.winAdd.hidden) {
                App.add_work_id.setValue(record.data.WorkName);
                App.Ahidden_work_id.setValue(record.data.ObjID);
            }
            else if (!App.winModify.hidden) {
     ...
     <script type="text/javascript">
         ...
         var Manager_BasicInfo_CommonPage_QueryShiftClass_Request = function (record) {//返回值处理
             ...
             App.Ahidden_shift_id.setValue(record.data.ObjID);
         }
...
<%--                            <ext:Column ID="erp_code" runat="server" Text="ERP代码" DataIndex="ERPCode" Width="80"  />--%>
                                        ...
                                        <ext:Container  runat="server" Layout="FormLayout" ColumnWidth=".5"
                                            ...
                                            <Items>
                                                ...
                                                <ext:TriggerField ID="add_dept_code" runat="server" FieldLabel="所属部门" LabelAlign="Left" Editable="false" >
                                                   ...
                                                   <ext:TextField ID="Ahidden_depart_code" runat="server" FieldLabel="部门编号"   LabelAlign="Left" Enabled="true" MaxLength="100" ReadOnly="true"  Hidden="true" />
                                            ...
                                            <Items>
                                                 ...
                                                 <ext:TriggerField ID="add_work_id" runat="server" FieldLabel="所属岗位" LabelAlign="Left" Editable="false" >
                                                    ...
                                                    <Listeners>
                                                     ...
                                                     <ext:TextField ID="Ahidden_work_id" runat="server" FieldLabel="岗位编号"   LabelAlign="Left" Enabled="true" MaxLength="100" ReadOnly="true"  Hidden="true"/>
                                                ...
                                                <ext:TriggerField ID="add_shift_id" runat="server" FieldLabel="所属班组" LabelAlign="Left" Editable="false" >
                                                  ...
                                                  <ext:TextField ID="Ahidden_shift_id" runat="server" FieldLabel="班组编号"   LabelAlign="Left" Enabled="true" MaxLength="100" ReadOnly="true" Hidden="true"/>
           ...
           <%-- <ext:Hidden ID="Ahidden_depart_code" runat="server"></ext:Hidden>--%>
              <%-- <ext:Hidden ID="Ahidden_work_id" runat="server"></ext:Hidden>--%>
        <%--       <ext:Hidden ID="Ahidden_shift_id" runat="server"></ext:Hidden>--%>
