<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MixCleanRecord.aspx.cs" Inherits="Manager_Equipment_EquipRepairProtectPlan_MixCleanRecord" %>
    ...
    <script type="text/javascript">
        ...
        var cmdcol_click = function (command, record) {
            if (command == "Delete") {
                ...
                App.direct.pnlList_Add(record.data.serialid, record.data.standid, record.data.workshop, record.data.equipName, record.data.posName,
                    record.data.shiftname,record.data.lastdate,
                    {
                    success: function () { },
                    failure: function () { }
                });
                ...
                <Store>
                            ...
                            <Model>
                                <ext:Model ID="model" runat="server" IDProperty="serialid">
                                    <Fields>
                                        ...
                                        <ext:ModelField Name="standid" Type="Int" />
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="Column1" runat="server" Text="序号" DataIndex="standid" Width="80">
                                <Editor>
                            ...
                            <ext:Column ID="Column5" runat="server" Text="位置" DataIndex="posName" Width="100">
                                <Editor>
                                    <ext:TextField runat="server" AllowBlank="false" />
                                </Editor>
                            </ext:Column>
                            <ext:Column ID="Column6" runat="server" Text="班组" DataIndex="shiftname" Width="200">
                                <Editor>
                                    <ext:TextField runat="server" AllowBlank="false" />
                                </Editor>
                            </ext:Column>
                            <ext:DateColumn ID="DateColumn4" runat="server" Text="最后清洗日期" DataIndex="lastdate" Width="150" Format="yyyy-MM-dd" >
                                <Editor>
                                    <ext:DateField
                                        runat="server"
                                        AllowBlank="false"
