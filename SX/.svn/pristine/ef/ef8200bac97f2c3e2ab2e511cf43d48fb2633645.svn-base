<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShiftConfig.aspx.cs" Inherits="Manager_ProducingPlan_ShiftConfig_ShiftConfig" %>
        ...
        var Manager_BasicInfo_CommonPage_QueryEquipInfo_Request = function (record) {  //机台返回值处理
            ...
            if (type == "Equip") {
                if (!App.AddConfigWin.hidden) {
                    ...
                    App.cboEquipCode.setValue(record.data.EquipName);
...
<body>
    <form id="form1" runat="server">
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server" ID="ctl320">
                            <Items>
                                ...
                                <ext:Button runat="server" Icon="TableEdit" Text="质检状态" ID="btnState">
                                    <ToolTips>
                                        <ext:ToolTip ID="ToolTip5" runat="server" Html="质检状态" />
                                    </ToolTips>
                                    <DirectEvents>
                                        <Click OnEvent="btnStateClick" />
                                    </DirectEvents>
                                </ext:Button>
                        ...
                        <ext:Panel ID="Panel2" runat="server" AutoHeight="true">
                            <Items>
                                <ext:Container ID="Container5" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="Container7" runat="server" Layout="FormLayout" ColumnWidth=".16"
                                            Padding="5">
                                            <Items>
                                                <ext:DateField ID="txtStratShiftDate" runat="server" Editable="false" Vtype="daterange"
                                                    FieldLabel="生产日期" LabelAlign="Right" EnableKeyEvents="true" Format="yyyy-MM-dd" Width="220">
                                                    <Listeners>
                                        ...
                                        <ext:Container ID="Container21" runat="server" Layout="FormLayout" ColumnWidth=".16"
                                            Padding="5">
                                            <Items>
                                                <ext:DateField ID="txtenddate" runat="server" Editable="false" 
                                                    FieldLabel="结束日期" LabelAlign="Right" EnableKeyEvents="true" Format="yyyy-MM-dd" Width="220"/>
                                            </Items>
                                        </ext:Container>
                                        ...
                                        <ext:Container ID="Container1" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            ...
                                            <Items>
                                               ...
                                               <Triggers>
                                                ...
                                                <ext:TriggerField ID="cboEquipCode"
                                                    runat="server" Flex="1" Editable="true" FieldLabel="机台" LabelAlign="Right">
                                                    <Triggers>
                                                        <ext:FieldTrigger Icon="Clear" HideTrigger="true" />
                                                        <ext:FieldTrigger Icon="Search" />
                                                    </Triggers>
                                        ...
                                        <ext:Container ID="Container19" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:ComboBox ID="cbxstate2" runat="server" FieldLabel="质检状态" LabelAlign="Right">
                                                    <Items>
                                                        <ext:ListItem Text="未检" Value="N"></ext:ListItem>
                                                        <ext:ListItem Text="不合格" Value="0"></ext:ListItem>
                                                        <ext:ListItem Text="合格" Value="1"></ext:ListItem>
                                                        <ext:ListItem Text="放行处理" Value="2"></ext:ListItem>
                                                    </Items>
                                                </ext:ComboBox>
                                </Items>
                                        </ext:Container>
                ...
                <ext:GridPanel ID="gpShiftQuery" runat="server" Region="Center" Layout="FitLayout">
                            ...
                            <Model>
                                <ext:Model ID="Model2" runat="server" IDProperty="Barcode">
                                    <Fields>
                                        ...
                                        <ext:ModelField Name="UsedFlag" Type="String" />
                                        <ext:ModelField Name="CheckFlag" Type="String" />
                                        <ext:ModelField Name="Prod_Date" Type="String" />
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="Column14" runat="server" Text="存放位置" Width="70" DataIndex="Position">
                            </ext:Column>
                            <ext:SummaryColumn ID="barcode" runat="server" Text="条码" Width="150" DataIndex="Barcode"
                                SummaryType="Count">
                            ...
                            <ext:Column ID="Column6" runat="server" Width="130" Text="生产时间" DataIndex="Prod_Date">
                        ...
                        <ext:Column ID="Column16" runat="server" Text="使用标志" Width="60" DataIndex="UsedFlag">
                            ...
                            <ext:Column ID="Column7" runat="server" Text="打印时间" Width="130" DataIndex="PrintDate">
                            </ext:Column>
                            <ext:Column ID="Column18" runat="server" Text="数量" Width="40" DataIndex="ShelfNum">
                            </ext:Column>
                            <ext:Column ID="Column1" runat="server" Text="使用标志" Width="60" DataIndex="UsedFlag">
                            </ext:Column>
                            <ext:Column ID="Column8" runat="server" Text="质检状态" Width="60" DataIndex="CheckFlag">
                            </ext:Column>
                                ...
                                <ext:FieldSet ID="FieldSet5" runat="server" Title="其他信息" Layout="AnchorLayout" DefaultAnchor="100%"
                                    ...
                                    <Items>
                                        ...
                                        <ext:Container ID="Container17" runat="server" Layout="HBoxLayout" MarginSpec="5 5 5 5">
                                            <Items>
                                                <ext:ComboBox ID="txtused" Flex="1" runat="server" FieldLabel="使用标志"
                                                    LabelAlign="Right" AllowBlank="false" IndicatorText="*" IndicatorCls="red-text">
                                                    <Items>
                                                        <ext:ListItem Value="0" Text="未用"></ext:ListItem>
                                                        <ext:ListItem Value="1" Text="正用"></ext:ListItem>
                                                        <ext:ListItem Value="2" Text="用完"></ext:ListItem>
                                                    </Items>
                                                </ext:ComboBox>
                                            </Items>
                                        </ext:Container>
                                        <ext:Container ID="Container20" runat="server" Layout="HBoxLayout" MarginSpec="5 5 5 5">
                                            <Items>
                                                ...
                                                <ext:NumberField ID="mem" AllowBlank="false" IndicatorText="*" IndicatorCls="red-text"
                                                    runat="server" Flex="1" FieldLabel="机台编码01存入mem" LabelAlign="Right" DecimalPrecision="3"
        ...
        <ext:Window ID="winState" runat="server" Icon="MonitorAdd" Closable="false" Title="修改质检状态" Width="550" Height="500" Resizable="false" Modal="true" BodyStyle="background-color:#fff;" BodyPadding="5" Layout="FormLayout">
            <Items>
                <ext:FormPanel ID="pnlPlanAdd" runat="server" BodyPadding="5" Layout="FormLayout">
                    ...
                    <Items>
                        ...
                        <ext:FieldSet runat="server" Title="修改质检状态" Layout="AnchorLayout" DefaultAnchor="100%">
                            <Items>
                                <ext:ComboBox ID="cbxState" Flex="1" runat="server" FieldLabel="质检状态"
                                    LabelAlign="Right" AllowBlank="false" IndicatorText="*" IndicatorCls="red-text">
                                    <Items>
                                        <ext:ListItem Value="N" Text="未检"></ext:ListItem>
                                        <ext:ListItem Value="0" Text="不合格"></ext:ListItem>
                                        <ext:ListItem Value="1" Text="合格"></ext:ListItem>
                                        <ext:ListItem Value="2" Text="处理放行"></ext:ListItem>
                                    </Items>
                                </ext:ComboBox>
                            </Items>
                        </ext:FieldSet>
