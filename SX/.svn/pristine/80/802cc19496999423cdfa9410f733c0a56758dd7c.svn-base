<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryWorkPosition.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryWorkPosition" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryWorkPosition_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryWorkPosition_Window.close();
            return false;
        }
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="obj_id" runat="server" Text="岗位编号" DataIndex="ObjID" Width="70"  />
                            <ext:Column ID="dep_name" runat="server" Text="岗位名称" DataIndex="WorkName" Width="90"  />
