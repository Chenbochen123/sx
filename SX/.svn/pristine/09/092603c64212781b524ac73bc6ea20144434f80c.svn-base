<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WenShi.aspx.cs" Inherits="Manager_Equipment_WenShi" %>
                    ...
                    <ext:Panel ID="pnlStorageQuery" runat="server" AutoHeight="true">
                        <Items>
                         ...
                         <ext:Container ID="container3" runat="server" Layout="FormLayout" ColumnWidth=".25"
                                        ...
                                        Padding="5">
                                        <Items>
                                      <ext:Checkbox ID="b_Scan" runat="server" Flex="1" FieldLabel="是否报警"
            ...
            <ext:GridPanel ID="pnlList" runat="server" Cls="x-grid-custom" Region="Center">
                            ...
                            <ext:Model ID="model" runat="server" IDProperty="JarID">
                                <Fields>
                                    ...
                                    <ext:ModelField Name="EquipName" />
                                     ...
                                     <ext:ModelField Name="TempUL" />
                                    <ext:ModelField Name="TempLL" />
                                     <ext:ModelField Name="TAlarm" />
                                      <ext:ModelField Name="HumiValue" />
                                     <ext:ModelField Name="HumiUL" />
                                    <ext:ModelField Name="HumiLL" />
                                     <ext:ModelField Name="HAlarm" />
                                      <ext:ModelField Name="savetime2" />
                ...
                <ColumnModel ID="colModel" runat="server">
                    <Columns>
                        ...
                        <ext:Column ID="Column1" runat="server" Text="温度值" DataIndex="TempValue" Width="100"  />
                        <ext:Column ID="Column2" runat="server" Text="温度上限" DataIndex="TempUL" Width="100"  />
                        <ext:Column ID="Column4" runat="server" Text="温度下限" DataIndex="TempLL" Width="100"  />
                         <ext:Column ID="Column5" runat="server" Text="温度报警" DataIndex="TAlarm" Width="100"  />
                        <ext:Column ID="Column6" runat="server" Text="湿度值" DataIndex="HumiValue" Width="100"  />
                        <ext:Column ID="Column7" runat="server" Text="湿度上限" DataIndex="HumiUL" Width="100"  />
                        <ext:Column ID="Column8" runat="server" Text="湿度下限" DataIndex="HumiLL" Width="100"  />
                         <ext:Column ID="Column9" runat="server" Text="湿度报警" DataIndex="HAlarm" Width="100"  />
                      <ext:Column ID="Column3" runat="server" Text="保存时间" DataIndex="savetime2"  Width="100" />
                    </Columns>
                </ColumnModel>
                <SelectionModel>
