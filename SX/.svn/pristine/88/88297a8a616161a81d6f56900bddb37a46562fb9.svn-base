<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowPmtOpenAction.aspx.cs" Inherits="Manager_Technology_BasicInfo_ShowPmtOpenAction" %>
                        ...
                        <ext:Panel ID="panelNorthQuery" runat="server" Layout="AnchorLayout" AutoHeight="true">
                            <Items>
                                <ext:Container ID="container1" runat="server" Layout="HBoxLayout" Padding="5">
                                    <Items>
                                        <ext:TextField ID="txtCode" runat="server" Flex="1" FieldLabel="开炼动作代码" LabelAlign="Right" />
                                        <ext:TextField ID="txtShowName" runat="server" Flex="1" FieldLabel="开炼动作名称" LabelAlign="Right" />
                                        <ext:TextField ID="txAddress" runat="server" Flex="1" FieldLabel="开炼动作地址" LabelAlign="Right" />
                                    </Items>
                                </ext:Container>
                            </Items>
                        </ext:Panel>
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="ActionCode" DataIndex="ActionCode" runat="server" Text="开炼动作代码" Width="120" />
                            <ext:Column ID="ShowName" DataIndex="ShowName" runat="server" Text="开炼动作名称" Width="160" />
                            <ext:Column ID="ActionAddress" DataIndex="ActionAddress" runat="server" Text="开炼动作地址" Width="120" />
                            <ext:Column ID="Remark" DataIndex="Remark" runat="server" Text="开炼动作备注" Flex="1" />
                        </Columns>
                    </ColumnModel>
                    <BottomBar>
