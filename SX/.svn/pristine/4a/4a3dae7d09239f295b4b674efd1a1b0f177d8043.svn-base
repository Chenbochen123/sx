<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Search.aspx.cs" Inherits="Manager_Technology_ProductReview_Search" %>
                                ...
                                <ext:Container ID="container1" runat="server" Layout="AnchorLayout" AutoHeight="true" Padding="5">
                                    <Items>
                                        <ext:Container ID="container4" runat="server" Layout="HBoxLayout" Padding="5">
                                            <Items>
                                                <ext:DateField ID="txtBeginTime" runat="server" FieldLabel="生产开始时间" Flex="2" LabelAlign="Right" Format="yyyy-MM-dd">
                                                </ext:DateField>
                                                <ext:DateField ID="txtEndTime" runat="server" FieldLabel="生产结束时间" Flex="2" LabelAlign="Right" Format="yyyy-MM-dd">
                                                </ext:DateField>
                        ...
                        <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                            ...
                            <ColumnModel ID="columnModel" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="Column1" DataIndex="DoneAllRtime" runat="server" Text="混炼总时间" Width="80" />
                                    <ext:Column ID="Column2" DataIndex="LotEnergy" runat="server" Text="每车能量" Width="80" />
                                    <ext:Column ID="Column3" DataIndex="BwbTime" runat="server" Text="间隔时间" Width="80" />
                                    <ext:Column ID="Column4" DataIndex="PjTemp" runat="server" Text="排胶温度" Width="80" />
                                    <ext:Column ID="Column5" DataIndex="PolyDisTime" runat="server" Text="加胶时间" Width="80" />
                                    <ext:Column ID="Column6" DataIndex="CBDisTime" runat="server" Text="加炭黑时间" Width="80" />
                                    <ext:Column ID="Column7" DataIndex="OilDisTime" runat="server" Text="加油时间" Width="80" />
                                    ...
                                    <ext:Column ID="ZJSID" DataIndex="USER_NAME" runat="server" Text="操作工" Width="60" />
                                </Columns>
                            </ColumnModel>
                            <SelectionModel>
