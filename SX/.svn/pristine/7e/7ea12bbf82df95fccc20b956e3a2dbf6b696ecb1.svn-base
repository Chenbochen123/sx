<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowPmtTerm.aspx.cs" Inherits="Manager_Technology_BasicInfo_ShowPmtTerm" %>
                        ...
                        <ext:Panel ID="panelNorthQuery" runat="server" Layout="AnchorLayout" AutoHeight="true">
                            <Items>
                                <ext:Container ID="container1" runat="server" Layout="HBoxLayout" Padding="5">
                                    <Items>
                                        <ext:TextField ID="txtCode" runat="server" Flex="1" FieldLabel="条件代码" LabelAlign="Right" />
                                        <ext:TextField ID="txtShowName" runat="server" Flex="1" FieldLabel="条件名称" LabelAlign="Right" />
                                        <ext:TextField ID="txAddress" runat="server" Flex="1" FieldLabel="条件地址" LabelAlign="Right" />
                                    </Items>
                                </ext:Container>
                            </Items>
                        </ext:Panel>
