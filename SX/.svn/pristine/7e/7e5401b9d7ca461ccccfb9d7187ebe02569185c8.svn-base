<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NonAuditMaterial.aspx.cs" Inherits="Manager_Technology_BasicInfo_NonAuditMaterial" %>
...
<head id="Head1" runat="server">
    ...
    <script src="<%= Page.ResolveUrl("./") %>NonAuditMaterial.js?_dc=<%= DateTime.Now.ToString("yyyyMMddHHmmss") %>"></script>
</head>
<body>
    <form id="fmUnit" runat="server">
        ...
        <ext:Viewport ID="vwUnit" runat="server" Layout="border">
            <Items>
                                ...
                                <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container_1" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:TextField ID="txt_obj_id" Vtype="integer" runat="server" FieldLabel="物料编号" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                                        <ext:Container ID="container_2" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:TriggerField ID="txt_material_name" runat="server" Flex="1" FieldLabel="物料名称" LabelAlign="Right" Editable="false">
                                                    <Triggers>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="material_code" runat="server" Text="物料编号" DataIndex="MaterialCode" Width="150"  />
                            <ext:Column ID="material_name" runat="server" Text="物料名称" DataIndex="MaterialName" Width="150"  />
                ...
                <ext:Window ID="winModify" runat="server" Icon="MonitorEdit" Closable="false" Title="修改免审核物料信息"
                    ...
                    <Items> 
                        <ext:FormPanel ID="pnlEdit" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                ...
                                <ext:TriggerField ID="modify_material_name" runat="server" FieldLabel="物料名称" LabelAlign="Left" MaxLength="50" AllowBlank=false IndicatorText="*" IndicatorCls="red-text" >
                                    <Triggers>
                                        <ext:FieldTrigger Icon="Clear" HideTrigger="true" />
                                        <ext:FieldTrigger Icon="Search" />
                                    </Triggers>
                ...
                <ext:Window ID="winAdd" runat="server" Icon="MonitorAdd" Closable="false" Title="添加免审核物料信息"
                    Width="320" Height="240" Resizable="false" Hidden="true" Modal="false" BodyStyle="background-color:#fff;"
                    BodyPadding="5" Layout="Form">
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5">
                            ...
                            <Items>
                                <ext:TriggerField ID="add_material_name" runat="server" FieldLabel="物料名称"  LabelAlign="Left" MaxLength="50" AllowBlank=false IndicatorText="*" IndicatorCls="red-text" >
                                    <Triggers>
                                        <ext:FieldTrigger Icon="Clear" HideTrigger="true" />
                                        <ext:FieldTrigger Icon="Search" />
                                    </Triggers>
                ...
                <ext:Hidden ID="hidden_material_name"  runat="server"></ext:Hidden>
