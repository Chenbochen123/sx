<%@ page language="C#" autoeventwireup="true" inherits="Manager_RubberQuality_Manage_QrigInfo, App_Web_bsjgrvuf" %>
    ...
    <ext:Viewport ID="Viewport1" runat="server" Layout="BorderLayout">
        <Items>
                            ...
                            <ext:Panel runat="server" Layout="FormLayout">
                                <Items>
                                    ...
                                    <ext:Panel runat="server" Layout="ColumnLayout" Border="false">
                                        <Items>
                                            ...
                                            <ext:TextField runat="server" ID="TextFieldQueryZJSID" FieldLabel="主机手" ColumnWidth=".5"
                                                LabelAlign="Right" LabelWidth="60" MaxLength="20" EmptyText="填写编号" />
                                    ...
                                    <ext:Panel ID="Panel1" runat="server" Layout="ColumnLayout" Border="false">
                                        <Items>
                                            <ext:ComboBox runat="server" ID="ComboBoxQueryCheckItemTypeId" FieldLabel="检验项目分类"
                                            ...
                                            <ext:ComboBox runat="server" ID="ComboBoxQueryStandCode" LabelAlign="Right" FieldLabel="检验标准分类"
                                                LabelWidth="80" ColumnWidth=".5" Editable="false" EmptyText="全部">
                                                <Triggers>
                                                    <ext:FieldTrigger Icon="Clear" />
                                                </Triggers>
                                                <Listeners>
                                    ...
                                    <ext:Panel runat="server" Layout="ColumnLayout" Border="false">
                                        <Items>
                                            <ext:ComboBox ID="cboType" runat="server" SelectOnTab="true" Editable="false"  LabelAlign="Right" LabelWidth="60" FieldLabel="配方类型">
                                            </ext:ComboBox>
            ...
            <ext:Panel ID="PanelCenter" runat="server" Region="Center" AutoScroll="true">
                <TopBar>
                    <ext:Toolbar runat="Server">
                        <Items>
                            ...
                            <ext:Button runat="server" ID="ButtonEdit" Text="修改" Icon="PageEdit">
                                <DirectEvents>
                ...
                <Items>
                    <ext:GridPanel runat="server" ID="GridPanelMaster" Collapsible="false" Height="300"
                        ...
                        <Store>
                            <ext:Store runat="server" ID="StoreMaster" PageSize="10" AutoLoad="false" RemoteSort="true"
                        ...
                        <ColumnModel>
                            <Columns>
                                <ext:CheckColumn runat="server" DataIndex="NotQuaCompute" Text="不参与合格率计算" Width="120" />
                                ...
                                <ext:Column runat="server" DataIndex="ClassName" Text="生产班组" Width="60" />
                                <ext:Column runat="server" DataIndex="ZJSID" Text="主机手" Width="60" />
                                <ext:Column runat="server" DataIndex="MaterName" Text="胶料名称" Width="160" />
                                <ext:Column ID="Column1" runat="server" DataIndex="itemname" Text="配方类型" Width="160" />
                                <ext:Column runat="server" DataIndex="SerialId" Text="车次" Width="40" />
                                <ext:Column runat="server" DataIndex="LLSerialID" Text="玲珑车次" Width="60" />
                                <ext:Column runat="server" DataIndex="TestType" Text="检验类型" Width="100" />
                                ...
                                <ext:Column runat="server" DataIndex="CheckShiftName" Text="检验班次" Width="60" />
                                <ext:Column runat="server" DataIndex="StandCode" Text="StandCode" Width="60" Hidden="true" />
                                <ext:Column runat="server" DataIndex="StandTypeName" Text="检验标准分类" Width="100" />
                    ...
                    <ext:GridPanel runat="server" ID="GridPanelDetail" Collapsible="false" Height="160"
                        Frame="false" AutoScroll="true">
                        <TopBar>
                            <ext:Toolbar runat="server">
                                <Items>
                                    <ext:Button runat="server" ID="ButtonDetailEdit" Text="修改明细" Icon="PageEdit">
                                        <DirectEvents>
                                    ...
                                    <ext:Button runat="server" ID="ButtonDetailDelete" Text="删除" Icon="PageDelete">
                                        <DirectEvents>
                        ...
                        <ColumnModel runat="server" ID="ColumnModelDetail">
                            <Items>
                                ...
                                <ext:Column runat="server" DataIndex="StandCode" Text="标准分类" Width="60" />
                                <ext:Column runat="server" DataIndex="StandId" Text="标准编号" Width="60" />
                            </Items>
                        </ColumnModel>
                        <SelectionModel>
