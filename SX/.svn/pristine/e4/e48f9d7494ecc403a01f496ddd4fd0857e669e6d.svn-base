<%@ page language="C#" autoeventwireup="true" inherits="Manager_RubberQuality_BasicInfo_CheckStand, App_Web_1dvad4ic" %>
    ...
    <ext:Viewport ID="Viewport1" runat="server" Layout="BorderLayout">
        <Items>
                ...
                <TopBar>
                    <ext:Toolbar ID="ToolbarNorth" runat="server">
                        <Items>
                            ...
                            <ext:Button runat="server" ID="ButtonHistory" Icon="Magnifier" Text="历史查询">
                                <DirectEvents>
                    ...
                    <ext:FormPanel runat="server" ID="FormPanelNorth" Layout="ColumnLayout">
                        <Items>
                            ...
                            <ext:ComboBox runat="server" ID="ComboBoxNorthStandCode" FieldLabel="分类标准" LabelAlign="Right"
                                Editable="false" />
                                 <ext:ComboBox runat="server" ID="ComboBoxRubType" FieldLabel="配方类型"
            ...
            <ext:Panel runat="server" ID="PanelCenter" Region="Center" AutoScroll="true" Layout="BorderLayout">
                <Items>
                    <ext:GridPanel ID="GridPanelMaster" runat="server" Collapsible="false" Height="320"
                        ...
                        <TopBar>
                            <ext:Toolbar runat="server">
                                <Items>
                                                    ...
                                                    <ext:MenuItem Text="启用" runat="server">
                                                        <DirectEvents>
                                                            <Click OnEvent="ButtonMasterEnabled_Click">
                                                                <EventMask ShowMask="true" Target="CustomTarget" CustomTarget="PanelCenter" />
                                                                <Confirmation ConfirmRequest="true" Title="提示" Message="您确定要【启用】当前质检标准的版本并停用其他版本么？" />
                                                            </Click>
                                                        </DirectEvents>
                                                    </ext:MenuItem>
                                    ...
                                    <ext:Button ID="ButtonDeleteRestore" runat="server" Text="删除复原" Icon="PageEdit">
                                        <DirectEvents>
                            ...
                            <Columns>
                                ...
                                <ext:Column ID="ColumnMasterStandVision" runat="server" Text="版本" DataIndex="StandVision"
                                    Width="45" Draggable="false" MenuDisabled="true" />
                                      <ext:Column ID="Column3" runat="server" Text="配方类型" DataIndex="PmtTypeName"
                                ...
                                <ext:CheckColumn runat="server" ID="CheckColumnChoiceness" Text="是否为精品物料" DataIndex="Choiceness"
                                    Width="100" Draggable="false" MenuDisabled="true" />
                            </Columns>
                        </ColumnModel>
                        <SelectionModel>
                ...
                <Items>
                    <ext:FormPanel runat="server" ID="FormPanelMaster" ShadowMode="Frame">
                        <Items>
                            ...
                            <ext:TextField runat="server" ID="TextFieldMasterLLStandVision" FieldLabel="玲珑版本"
                                MaxLength="50" MaxLengthText="最多不超过50个字符">
                            </ext:TextField>
                              <ext:ComboBox runat="server" ID="RubType" FieldLabel="配方类型" EmptyText="请选择..."
                                AllowBlank="false" />
                            ...
                            <ext:TimeField runat="server" ID="TimeFieldMasterRegDateTime" EmptyText="选择生效时间"
                                Text="00:00:00" FieldLabel="生效时间" Format="HH:mm:ss" AllowBlank="false" />
            ...
            <ext:Window runat="server" ID="WindowDetail" Closable="false" Height="300" Width="350"
                Resizable="false" Hidden="true" Modal="false">
                <Items>
                    <ext:FormPanel runat="server" ID="FormPanelDetail" ShadowMode="Frame">
                        <Items>
                            <ext:ComboBox runat="server" ID="ComboBoxDetailItemCd" FieldLabel="检验项目" EmptyText="请选择..."
                            ...
                            <ext:Checkbox runat="server" ID="CheckBoxDetailIfMin" FieldLabel="允许下限" />
                            <ext:NumberField runat="server" ID="NumberFieldDetailPermMax" FieldLabel="上限值" EmptyText="请填写..."
                                AllowBlank="false" DecimalPrecision="3" />
                            <ext:Checkbox runat="server" ID="CheckBoxDetailIfMax" FieldLabel="允许上限" />
                            <ext:Checkbox runat="server" ID="CheckBoxDetailJudgeResult" FieldLabel="是否合格" Hidden="true" />
                            <ext:ComboBox runat="server" ID="ComboBoxDetailDealCode" FieldLabel="处理意见" EmptyText="请选择..."
                                AllowBlank="false" Editable="false" Hidden="true" />
                            <ext:TextField runat="server" ID="TextFieldDetailDrawMark" FieldLabel="划胶标识" MaxLength="20"
                                MaxLengthText="最长20个字符" Hidden="true" />
                            <ext:NumberField runat="server" ID="NumberFieldDetailGrade" FieldLabel="等级" EmptyText="请填写"
                                AllowBlank="false" AllowDecimals="false" MinValue="1" MinText="最小值：1" MaxValue="999"
                                MaxText="最大值：999" Hidden="true" />
                            <ext:TextField runat="server" ID="TextFieldDetailCardMark2" FieldLabel="子标识" MaxLength="20"
                                MaxLengthText="最长20个字符" Hidden="true" />
                            <ext:ComboBox runat="server" ID="ComboBoxDetailQuaFrequency" FieldLabel="检验频率" EmptyText="请选择..."
                                AllowBlank="false" Editable="false">
                                <Items>
                                    <ext:ListItem Text="100%" Value="100%" />
                                    <ext:ListItem Text="50%" Value="50%" />
                                    <ext:ListItem Text="33%" Value="33%" />
            ...
            <ext:Window runat="server" ID="WindowMasterCopy" Closable="false" Height="350" Width="450"
                Resizable="false" Hidden="true" Modal="false">
                <Items>
                    <ext:FormPanel runat="server" ID="FormPanelMasterCopy">
                        <Items>
                            <ext:TriggerField ID="TriggerFieldMasterCopyFromMaterName" runat="server" FieldLabel="复制源胶料"
                                Width="320" LabelWidth="90" LabelAlign="Right" ReadOnly="true" />
                            ...
                            <ext:TimeField runat="server" ID="TimeFieldMasterCopyToRegDateTime" EmptyText="选择生效时间"
                                Text="00:00:00" FieldLabel="生效时间" Format="HH:mm:ss" AllowBlank="false" LabelWidth="90" />
                        </Items>
                        <Listeners>
                ...
                <Items>
                    <ext:FormPanel runat="server" ID="FormPanelAudit" ShadowMode="Frame">
                        <Items>
                            ...
                            <ext:TextField runat="server" ID="TextFieldAuditLLStandVision" FieldLabel="玲珑版本" />
                            ...
                            <ext:TextArea runat="server" ID="TextAreaAuditAuditMemo" FieldLabel="审核意见" Rows="5"
