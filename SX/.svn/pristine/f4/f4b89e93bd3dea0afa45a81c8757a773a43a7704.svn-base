<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryBasStorage.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryBasStorage" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryBasStorage_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryBasStorage_Window.close();
            return false;
        }
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="usedDuration" DataIndex="UsedDuration" runat="server" Text="启用期间" Flex="1" />
                            <ext:Column ID="usingDuration" DataIndex="UsingDuration" runat="server" Text="当前期间" Flex="1" />
