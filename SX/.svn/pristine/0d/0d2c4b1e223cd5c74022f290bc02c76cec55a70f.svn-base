<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EquipState.aspx.cs" Inherits="Manager_Equipment_EquipState" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var cmdcol_click = function (command, record) {
             if (command == "Edit") {
                 App.direct.pnlList_Edit(record.data.Equip_Code, {
                    success: function () { },
                    failure: function () { }
                });
            }
            ...
            <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                <Store>
                    <ext:Store ID="store" runat="server" PageSize="15">
                        <Sorters>
                            <ext:DataSorter Property="Equip_Code" />
                        </Sorters>
                            <Model>
                                <ext:Model ID="model" runat="server" IDProperty="Equip_Code">
                                    <Fields>
                                        <ext:ModelField Name="Equip_Code"/>
                                        <ext:ModelField Name="Equip_name"/>
                                        <ext:ModelField Name="State2"/>
                                    </Fields>
                                </ext:Model>
                            </Model>
                        </ext:Store>
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column runat="server" ID="Column12" DataIndex="State2" Text="状态" MenuDisabled="true" />
              ...
              <ext:Window ID="winSave" runat="server" Icon="MonitorAdd" Closable="false" Title="设备状态维护" Width="550" Height="500" Resizable="false" Modal="true" BodyStyle="background-color:#fff;" BodyPadding="5" Layout="FormLayout">
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5" Layout="FormLayout">
                            ...
                            <Items>
                                ...
                                <ext:FieldSet ID="FieldSet1" runat="server" Title="设备状态维护">
                                    <Items>
                                        <ext:FieldContainer ID="FieldContainer2"  runat="server" Layout="HBoxLayout"  AnchorHorizontal="100%">
                                            <Items>
                                         <ext:ComboBox ID="cbxState" runat="server" FieldLabel="状态" LabelAlign="left" Width="230" 
                                                    Editable="false">
                                                    <Items>
                                                        <ext:ListItem Text="设备故障" Value="0">
                                                        </ext:ListItem>
                                                        <ext:ListItem Text="运行" Value="1">
                                                        </ext:ListItem>
                                                        <ext:ListItem Text="计划停机" Value="2">
                                                        </ext:ListItem>
                                                        <ext:ListItem Text="PM检修" Value="3">
                                                        </ext:ListItem>
                                                    </Items>
                                                    <Triggers>
