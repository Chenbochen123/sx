<%@ page language="C#" autoeventwireup="true" inherits="Manager_Rubber_ReturnRubber, App_Web_dobmrtlx" %>
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server" ID="tbReturnRubber">
                            <Items>
                                ...
                                <ext:Button runat="server" Icon="LockEdit" Text="返回胶审核" ID="Button1">
                                    <%--<Listeners>
                        ...
                        <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                            <Items>
                                ...
                                <ext:Container ID="container4" runat="server" Layout="FormLayout" ColumnWidth=".25" Padding="5">
                                    <Items>
                                        <ext:ComboBox ID="cbxInStock" OnDirectChange="cbxInStock_change" runat="server" FieldLabel="是否入库" LabelAlign="Right">
                                            <SelectedItems>
                        ...
                        <ColumnModel ID="colModel" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="StockInSign" runat="server" Text="返回状态" DataIndex="StockInSign" Flex="1">
                                   ...
                                   <ext:Column ID="Column1" runat="server" Text="返回原因" DataIndex="ReturnReason" Flex="1" />
