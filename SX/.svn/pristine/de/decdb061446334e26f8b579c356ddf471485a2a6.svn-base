<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Yunzhuan.aspx.cs" Inherits="Manager_Equipment_Yunzhuan" %>
            ...
            <Items>
                ...
                <Items>
                    <ext:GridPanel runat="server" ID="GridPanelCenter" ColumnLines="true" AnchorHeight="100">
                                ...
                                <Model>
                                    <ext:Model runat="server" ID="ModelCenter">
                                            <Fields>
                                                ...
                                                <ext:ModelField Name="rate0" />
                                                <ext:ModelField Name="rate1" />
                                                <ext:ModelField Name="rate2" />
                                                <ext:ModelField Name="rate3" />
                                                <ext:ModelField Name="rate4" />
                                                <ext:ModelField Name="rate5" />
                                                <ext:ModelField Name="rate6" />
                                            </Fields>
                                    </ext:Model>
                                </Model>
                            </ext:Store>
                        ...
                        <ColumnModel>
                            <Columns>
                                    <ext:Column ID="Column1" DataIndex="equipName" runat="server" Text="机台名称" Align="Center" Width="100" />
                                    <ext:Column ID="Column2" DataIndex="rate0" runat="server" Text="设备运转率%" Align="Center" Width="150"/>
                                    <ext:Column ID="Column3" DataIndex="rate1" runat="server" Text="计划停机率%" Align="Center" Width="100" />
                                    <ext:Column ID="Column4" DataIndex="rate2" runat="server" Text="设备停机率%" Align="Center" Width="150"/>
                                    <ext:Column ID="Column5" DataIndex="rate3" runat="server" Text="工艺停机率%" Align="Center" Width="150"/>
                                    <ext:Column ID="Column6" DataIndex="rate4" runat="server" Text="生产停机率%" Align="Center" Width="150"/>
                                    <ext:Column ID="Column7" DataIndex="rate5" runat="server" Text="其他停机率%" Align="Center" Width="150"/>
                                    <ext:Column ID="Column8" DataIndex="rate6" runat="server" Text="未知" Align="Center" Width="150"/>
