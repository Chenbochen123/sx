<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryPageMenu.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryPageMenu" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryPageMenu_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryPageMenu_Window.close();
            return false;
        }
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="ShowName" DataIndex="ShowName" runat="server" Text="功能模块" Width="120" />
                            <ext:Column ID="Remark" DataIndex="Remark" runat="server" Text="功能描述" Flex="1" />
