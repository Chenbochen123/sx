<%@ page language="C#" autoeventwireup="true" inherits="Manager_Equipment_EquipRepairProtectPlan_EquipRepairProtectPlan, App_Web_4lfqyfcm" %>
        ...
        <ext:Viewport ID="vwUnit" runat="server" Layout="border">
            <Items>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center" Frame="true">
                    <Store>
                        <ext:Store ID="store" runat="server" PageSize="15" GroupField="GroupName">
                            <Proxy>
