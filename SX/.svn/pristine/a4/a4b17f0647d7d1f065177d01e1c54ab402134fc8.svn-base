<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OastReport.aspx.cs" Inherits="Manager_ShopStorage_Report_OastReport" %>
...
<body>
    ...
    <ext:Viewport ID="vpStorage" runat="server" Layout="border">
        <Items>
                        ...
                        <Items>
                            ...
                            <ext:Container ID="container3" runat="server" Layout="FormLayout" ColumnWidth=".34"
                                ...
                                <Items>
                                    ...
                                    <ext:TextField ID="txtCode" runat="server" FieldLabel="条码" LabelAlign="Right"></ext:TextField>
                    ...
                    <ext:GridPanel ID="pnlList" runat="server">
                        <Store>
                            <ext:Store ID="store" runat="server" PageSize="10" AutoLoad="false">
                                ...
                                <Model>
                                    <ext:Model ID="model" runat="server" IDProperty="Barcode,StorageID,StoragePlaceID,MaterCode,">
                                        <Fields>
                                            ...
                                            <ext:ModelField Name="UsedWeight" Type="Float" />
                                            <ext:ModelField Name="LeftWeight" Type="Float" />
                                        </Fields>
                                    </ext:Model>
                                </Model>
                            </ext:Store>
                        ...
                        <ColumnModel ID="colModel" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="TotalWeight" runat="server" Text="当前重量" DataIndex="TotalWeight" Flex="1" />
                                <ext:Column ID="Column1" runat="server" Text="使用重量" DataIndex="UsedWeight" Flex="1" />
                                <ext:Column ID="Column2" runat="server" Text="剩余重量" DataIndex="LeftWeight" Flex="1" />
            ...
            <ext:Panel ID="pnlSouth" runat="server" Region="South" Title="烘胶房明细数据" Height="200" Icon="Basket" Layout="Fit" Collapsible="true" 
                    ...
                    <ext:GridPanel ID="pnlDetailList" runat="server" MarginsSummary="0 5 5 5">
                                ...
                                <Model>
                                    <ext:Model ID="modelDetail" runat="server" IDProperty="Barcode, BarcodeSplit">
                                        <Fields>
                                            ...
                                            <ext:ModelField Name="UsedWeight" />
                                            <ext:ModelField Name="LeftWeight" />
                        ...
                        <ColumnModel ID="ColumnModelDetail" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="Weight1" runat="server" Text="重量" DataIndex="Weight" Width="60" />
                                ...
                                <ext:Column ID="UsedWeight" runat="server" Text="使用重量" DataIndex="UsedWeight" Width="70" />
                                <ext:Column ID="Column4" runat="server" Text="机台" DataIndex="EquipName" Width="70" />
                                <ext:Column ID="Column3" runat="server" Text="剩余重量" DataIndex="LeftWeight" Width="70" />
                                <ext:Column ID="Barcode1" runat="server" Text="条码号" DataIndex="Barcode" Width="150" />
                                <ext:Column ID="BarcodeSplit" runat="server" Text="拆分条码号" DataIndex="BarcodeSplit" Width="190" />
                                <ext:Column ID="Column5" runat="server" Text="架子号" DataIndex="llshelfid" Width="90" />
                            </Columns>
                        </ColumnModel>
                        <BottomBar>
