            ...
            <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="Column34" runat="server" Text="服务公司" DataIndex="fuwu_fac" Width="100">
                                <Editor>
                                    <ext:TextField runat="server" AllowBlank="true" />
                                </Editor>
                            </ext:Column>
                ...
                </ext:Hidden> <ext:Window ID="WinUpLoadBill" runat="server" IconCls="fa fa-upload" Closable="true" Title="Excel导入"
