<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryEqmStopType.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryEqmStopType" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryEqmStopType_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryEqmStopType_Window.close();
            return false;
        }
                                ...
                                <ext:Container ID="container_Query" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container1" runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                                            <Items>
                                                <ext:TextField ID="txtTypeName" runat="server" FieldLabel="停机名称" LabelAlign="Right" >
                                                    <Listeners>
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="type_code" runat="server" Text="停机类型编码" DataIndex="TypeCode" Width="120"  />
                            <ext:Column ID="spare_part_name" runat="server" Text="停机类型名称" DataIndex="TypeName" Width="130"  />
