...
public partial class Manager_RubberQuality_Manage_CheckRubberQualityEquipCPKReport : BasePage
{
    #region 权限定义
    ...
    protected void ButtonNorthQuery_Click(object sender, DirectEventArgs e)
    {
        ...
        IQmtRubberQualityEquipCPKReportParams paras = new QmtRubberQualityEquipCPKReportParams();
        ...
        DataSet ds = bQmtCheckMasterManager.GetCheckRubberQualityEquipCPKReportByParas(paras);
    ...
    protected void ButtonNorthExport_Click(object sender, DirectEventArgs e)
    {
        ...
        new Mesnac.Util.Excel.ExcelDownload().ExcelFileDown(dt, "胶料质检机台CPK日报表");
