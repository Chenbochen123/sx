<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Weight.aspx.cs" Inherits="Manager_Technology_Manage_MaterialRecipeDetail_Weight" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="BorderLayout">
            <Items>
                <ext:Panel ID="pnlWeight" runat="server" Region="Center" Header="false"   AutoHeight="true"  AutoScroll="true">
                    <TopBar>
                    ...
                    <Items>
                        <ext:GridPanel ID="gridPanelWeightCarbon" runat="server" Flex="1" Frame="true" Title="炭黑称量信息" Height="138"  Header="false" Split="true">
                            <Store>
                            ...
                            <ColumnModel ID="ColumnModelCarbon" runat="server" >
                                <Columns>
                                    ...
                                    <ext:Column ID="Column1" DataIndex="RecipeMaterialCode" runat="server" Text="炭黑名称" Hideable="false" Sortable="false" Width="150" SummaryType="Count">
                                        <Editor>
                                    ...
                                    <ext:Column ID="RecipeMaterialCode" DataIndex="MaterialCode" runat="server" Width="300" Text="物料编码"  Sortable="false" hidden="true">
                                    </ext:Column>
                                    <ext:Column ID="RecipeEquipCodeCarbon" DataIndex="RecipeEquipCode" runat="server" Width="80" Text="物料级别" Hideable="false" Sortable="false" Hidden="true">
                                    </ext:Column>
                                      <ext:Column ID="Column9" DataIndex="Supply_code" runat="server" Width="80" Text="原料厂商" Hideable="false" Sortable="false" Hidden="true">
                                    </ext:Column>
                                    <ext:Column ID="ActCodeCarbon" DataIndex="ActCode" runat="server" Text="称量动作" Hideable="false" Sortable="false" Width="80">
                                        <Editor>
                                    ...
                                    <ext:Column ID="SetWeightCarbon" DataIndex="SetWeight" runat="server" Text="设定重量" Hideable="false" Sortable="false" Width="90" SummaryType="Sum">
                                    ...
                                    <ext:Column ID="ErrorAllowCarbon" DataIndex="ErrorAllow" runat="server" Width="90" Text="允许误差" Hideable="false" Sortable="false" SummaryType="Sum">
                                        <Renderer Handler="if (!value){return ''}; if (value==0) {return '';} else {return  parseFloat(value).toFixed(3).toString() +' 千克';}" />
                                        <Editor>
                                    ...
                                    <ext:CommandColumn ID="CommandColumnCarbon" DataIndex="CommandColumnCarbon" runat="server" Width="200" Text="操作" Align="Center" SummaryType="Count">
                                        <Commands>
                        ...
                        <ext:GridPanel ID="gridPanelWeightOil1" runat="server" Flex="1" Frame="true" Title="油称(1)称量信息" Height="138"  Header="false" Split="true">
                            <Store>
                            ...
                            <ColumnModel ID="ColumnModelOil1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="MaterialCodeOil1" DataIndex="RecipeMaterialCode" runat="server" Text="油料名称" Hideable="false" Sortable="false" Width="150" SummaryType="Count">
                                        <Editor>
                                    ...
                                    <ext:Column ID="Column3" DataIndex="MaterialCode" runat="server" Width="300" Text="物料编码"  Sortable="false" hidden="true">
                                    </ext:Column>
                                    <ext:Column ID="MaterialLevelOil1" DataIndex="RecipeEquipCode" runat="server" Width="80" Text="物料级别" Hideable="false" Sortable="false" Hidden="true">
                                    </ext:Column>
                                      <ext:Column ID="Column10" DataIndex="Supply_code" runat="server" Width="80" Text="原料厂商" Hideable="false" Sortable="false" Hidden="true">
                                    </ext:Column>
                                    <ext:Column ID="ActCodeOil1" DataIndex="ActCode" runat="server" Text="称量动作" Hideable="false" Sortable="false" Width="80">
                                        <Editor>
                                    ...
                                    <ext:Column ID="SetWeightOil1" DataIndex="SetWeight" runat="server" Text="设定重量" Hideable="false" Sortable="false" Width="90" SummaryType="Sum">
                                        <Renderer Handler="if (!value){return ''}; if (value==0) {return '';} else {return  parseFloat(value).toFixed(3).toString() +' 千克';}" />
                                        <Editor>
                                    ...
                                    <ext:Column ID="ErrorAllowOil1" DataIndex="ErrorAllow" runat="server" Width="90" Text="允许误差" Hideable="false" Sortable="false" SummaryType="Sum">
                                        <Renderer Handler="if (!value){return ''}; if (value==0) {return '';} else {return  parseFloat(value).toFixed(3).toString() +' 千克';}" />
                                        <Editor>
                                    ...
                                    <ext:CommandColumn ID="CommandColumnOil1" DataIndex="CommandColumnOil1" runat="server" Width="200" Text="操作" Align="Center" SummaryType="Count">
                                        <Commands>
                                            <ext:GridCommand Icon="TableEdit" CommandName="Add" Text="添加">
                                                <ToolTip Text="最后插入一条数据" />
                                            </ext:GridCommand>
                        ...
                        <ext:GridPanel ID="gridPanelWeightOil2" runat="server" Flex="1" Frame="true" Title="油称(2)称量信息" Hidden="true" Split="true">
                            <Store>
                            ...
                            <ColumnModel ID="ColumnModelOil2" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="MaterialCodeOil2" DataIndex="RecipeMaterialCode" runat="server" Text="油料名称" Hideable="false" Sortable="false" Width="150" SummaryType="Count">
                                        <Editor>
                                    ...
                                    <ext:Column ID="Column4" DataIndex="MaterialCode" runat="server" Width="300" Text="物料编码"  Sortable="false" hidden="true">
                                    </ext:Column>
                                    <ext:Column ID="MaterialLevelOil2" DataIndex="RecipeEquipCode" runat="server" Width="80" Text="物料级别" Hideable="false" Sortable="false" Hidden="true">
                                    </ext:Column>
                                      <ext:Column ID="Column11" DataIndex="Supply_code" runat="server" Width="80" Text="原料厂商" Hideable="false" Sortable="false" Hidden="true">
                                    </ext:Column>
                                    <ext:Column ID="ActCodeOil2" DataIndex="ActCode" runat="server" Text="称量动作" Hideable="false" Sortable="false" Width="80">
                                        <Editor>
                                    ...
                                    <ext:Column ID="SetWeightOil2" DataIndex="SetWeight" runat="server" Text="设定重量" Hideable="false" Sortable="false" Width="90" SummaryType="Sum">
                                        <Renderer Handler="if (!value){return ''}; if (value==0) {return '';} else {return  parseFloat(value).toFixed(3).toString() +' 千克';}" />
                                        <Editor>
                                    ...
                                    <ext:Column ID="ErrorAllowOil2" DataIndex="ErrorAllow" runat="server" Width="90" Text="允许误差" Hideable="false" Sortable="false" SummaryType="Sum">
                                        <Renderer Handler="if (!value){return ''}; if (value==0) {return '';} else {return  parseFloat(value).toFixed(3).toString() +' 千克';}" />
                                        <Editor>
                                    ...
                                    <ext:CommandColumn ID="CommandColumnOil2" DataIndex="CommandColumnOil2" runat="server" Width="200" Text="操作" Align="Center" SummaryType="Count">
                                        <Commands>
                                            <ext:GridCommand Icon="TableEdit" CommandName="Add" Text="添加">
                                                <ToolTip Text="最后插入一条数据" />
                                            </ext:GridCommand>
                        ...
                        <ext:GridPanel ID="gridPanelWeightRub" runat="server" Flex="1" Frame="true" Title="胶料称量信息" Height="225"  Header="false" Split="true">
                            <Store>
                            ...
                            <ColumnModel ID="ColumnModelRub" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="MaterialCodeRub" DataIndex="RecipeMaterialCode" runat="server" Text="胶料名称" Hideable="false" Sortable="false" Width="150" SummaryType="Count">
                                        <Editor>
                                       ...
                                       <ext:Column ID="Column7" DataIndex="Into_type" runat="server" Text="投入类型" Hideable="false" Sortable="false" Width="120" Hidden="true">
                                        <Editor>
                                   ...
                                   <Renderer Handler="return RendererGridColumnComboBox(value,metadata,record,rowIndex,colIndex,store,view)"></Renderer>
                                    ...
                                    <ext:Column ID="Column5" DataIndex="MaterialCode" runat="server" Width="300" Text="物料编码"  Sortable="false" hidden="true">
                                    </ext:Column>
                                    <ext:Column ID="MaterialLevelRub" DataIndex="RecipeEquipCode" runat="server" Width="80" Text="物料级别" Hideable="false" Sortable="false" Hidden="true">
                                    </ext:Column>
                                     <ext:Column ID="Column8" DataIndex="Supply_code" runat="server" Width="80" Text="原料厂商" Hideable="false" Sortable="false" Hidden="true">
                                    </ext:Column>
                                    ...
                                    <ext:Column ID="SetWeightRub" DataIndex="SetWeight" runat="server" Text="设定重量" Hideable="false" Sortable="false" Width="90" SummaryType="Sum">
                                        <Renderer Handler="if (!value){return ''}; if (value==0) {return '';} else {return  parseFloat(value).toFixed(3).toString() +' 千克';}" />
                                        <Editor>
                                    ...
                                    <ext:Column ID="ErrorAllowRub" DataIndex="ErrorAllow" runat="server" Width="90" Text="允许误差" Hideable="false" Sortable="false" SummaryType="Sum">
                                        <Renderer Handler="if (!value){return ''}; if (value==0) {return '';} else {return  parseFloat(value).toFixed(3).toString() +' 千克';}" />
                                        <Editor>
                                    ...
                                    <ext:CommandColumn ID="CommandColumnRub" DataIndex="CommandColumnRub" runat="server" Width="200" Text="操作" Align="Center" SummaryType="Count">
                                        <Commands>
                                            <ext:GridCommand Icon="TableEdit" CommandName="Add" Text="添加">
                                                <ToolTip Text="最后插入一条数据" />
                                            </ext:GridCommand>
                        ...
                        <ext:GridPanel ID="gridPanelWeightPowderPackage" runat="server" Flex="1" Frame="true" Title="小料校核称量信息" Hidden="true" Split="true">
                            <Store>
                            ...
                            <ColumnModel ID="ColumnModelPowderPackage" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="MaterialCodePowderPackage" DataIndex="RecipeMaterialCode" runat="server" Text="小料名称" Hideable="false" Sortable="false" Width="150" SummaryType="Count">
                                        <Editor>
                                    ...
                                    <ext:Column ID="Column2" DataIndex="MaterialCode" runat="server" Width="300" Text="物料编码"  Sortable="false" hidden="true">
                                    </ext:Column>
                                    <ext:Column ID="MaterialLevelPowderPackage" DataIndex="RecipeEquipCode" runat="server" Width="80" Text="物料级别" Hideable="false" Sortable="false" Hidden="true">
                                    </ext:Column>
                                      <ext:Column ID="Column12" DataIndex="Supply_code" runat="server" Width="80" Text="原料厂商" Hideable="false" Sortable="false" Hidden="true">
                                    </ext:Column>
                                     <ext:Column ID="ActCodePowderPackage" DataIndex="ActCode" runat="server" Text="称量动作" Hideable="false" Sortable="false" Width="80">
                                        <Editor>
                                    ...
                                    <ext:Column ID="SetWeightPowderPackage" DataIndex="SetWeight" runat="server" Text="设定重量" Hideable="false" Sortable="false" Width="90" SummaryType="Sum">
                                        <Renderer Handler="if (!value){return ''}; if (value==0) {return '';} else {return parseFloat(value).toFixed(3).toString() +' 千克';}" />
                                        <Editor>
                                    ...
                                    <ext:Column ID="ErrorAllowPowderPackage" DataIndex="ErrorAllow" runat="server" Width="90" Text="允许误差" Hideable="false" Sortable="false" SummaryType="Sum">
                                        <Renderer Handler="if (!value){return ''}; if (value==0) {return '';} else {return  parseFloat(value).toFixed(3).toString() +' 千克';}" />
                                        <Editor>
                                    ...
                                    <ext:CommandColumn ID="CommandColumnPowderPackage" DataIndex="CommandColumnPowderPackage" runat="server" Width="200" Text="操作" Align="Center" SummaryType="Count">
                                        <Commands>
                                            <ext:GridCommand Icon="TableEdit" CommandName="Add" Text="添加">
                                                <ToolTip Text="最后插入一条数据" />
                                            </ext:GridCommand>
                        ...
                        <ext:GridPanel ID="gridPanelWeightPowder" runat="server" Flex="1" Frame="true" Title="小料称量信息" Split="true">
                            <Store>
                            ...
                            <ColumnModel ID="ColumnModelPowder" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="MaterialCodePowder" DataIndex="RecipeMaterialCode" runat="server" Text="小料名称" Hideable="false" Sortable="false" Width="150" SummaryType="Count">
                                        <Editor>
                                    ...
                                    <ext:Column ID="Column6" DataIndex="MaterialCode" runat="server" Width="300" Text="物料编码"  Sortable="false" hidden="true">
                                    </ext:Column>
                                    <ext:Column ID="MaterialLevelPowder" DataIndex="RecipeEquipCode" runat="server" Width="80" Text="物料级别" Hideable="false" Sortable="false" Hidden="true">
                                    </ext:Column>
                                      <ext:Column ID="Column13" DataIndex="Supply_code" runat="server" Width="80" Text="原料厂商" Hideable="false" Sortable="false" Hidden="true">
                                    </ext:Column>
                                    <ext:Column ID="ActCodePowder" DataIndex="ActCode" runat="server" Text="称量动作" Hideable="false" Sortable="false" Width="80">
                                        <Renderer Handler="return '称量'"></Renderer>
                                    </ext:Column>
                                    <ext:Column ID="SetWeightPowder" DataIndex="SetWeight" runat="server" Text="设定重量" Hideable="false" Sortable="false" Width="90" SummaryType="Sum">
                                        <Renderer Handler="if (!value){return ''}; if (value==0) {return '';} else {return  parseFloat(value).toFixed(3).toString() +' 千克';}" />
                                        <Editor>
                                    ...
                                    <ext:Column ID="ErrorAllowPowder" DataIndex="ErrorAllow" runat="server" Width="90" Text="允许误差" Hideable="false" Sortable="false" SummaryType="Sum">
                                        <Renderer Handler="if (!value){return ''}; if (value==0) {return '';} else {return  parseFloat(value).toFixed(3).toString() +' 千克';}" />
                                        <Editor>
                                    ...
                                    <ext:CommandColumn ID="CommandColumnPowder" DataIndex="CommandColumnPowder" runat="server" Width="200" Text="操作" Align="Center" SummaryType="Count">
                                        <Commands>
                                            <ext:GridCommand Icon="TableEdit" CommandName="Add" Text="添加">
                                                <ToolTip Text="最后插入一条数据" />
                                            </ext:GridCommand>
                        ...
                        <ext:GridPanel ID="gridPanelWeightPowder2" runat="server" Flex="1" Frame="true" Title="小料检量称量信息"  Visible="false" Split="true">
                            <Store>
                            ...
                            <ColumnModel ID="ColumnModelPowder2" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="MaterialCodePowder2" DataIndex="RecipeMaterialCode" runat="server" Text="小料名称" Hideable="false" Sortable="false" Width="300" SummaryType="Count">
                                    </ext:Column>
                                    <ext:Column ID="Column62" DataIndex="MaterialCode" runat="server" Width="300" Text="物料编码"  Sortable="false" hidden="true">
                                    </ext:Column>
                                    ...
                                    <ext:Column ID="ActCodePowder2" DataIndex="ActCode" runat="server" Text="称量动作" Hideable="false" Sortable="false" Width="80">
                                        <Renderer Handler="return '称量'"></Renderer>
                                    </ext:Column>
                                    <ext:Column ID="SetWeightPowder2" DataIndex="SetWeight" runat="server" Text="设定重量" Hideable="false" Sortable="false" Width="90" SummaryType="Sum">
                                        <Renderer Handler="if (!value){return ''}; if (value==0) {return '';} else {return  parseFloat(value).toFixed(3).toString() +' 千克';}" />
                                        <Editor>
                                    ...
                                    <ext:Column ID="ErrorAllowPowder2" DataIndex="ErrorAllow" runat="server" Width="90" Text="允许误差" Hideable="false" Sortable="false" SummaryType="Sum">
                                        <Renderer Handler="if (!value){return ''}; if (value==0) {return '';} else {return  parseFloat(value).toFixed(3).toString() +' 千克';}" />
                                        <Editor>
