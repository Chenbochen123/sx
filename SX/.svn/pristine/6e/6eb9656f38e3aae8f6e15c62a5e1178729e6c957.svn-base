<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MesManager.aspx.cs" Inherits="Manager_System_UserAction_MesManager" %>
    ...
    <form id="fmUnit" runat="server">
        ...
        <ext:Viewport ID="vwUnit" runat="server" Layout="border">
            <Items>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center"> 
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="obj_id" runat="server" Text="编号" DataIndex="ObjID" Width="120"  />
                            <ext:Column ID="work_name" runat="server" Text="人员名称" DataIndex="WorkName" Width="120"  />
                            <ext:Column ID="hr_code" runat="server" Text="电话号码" DataIndex="PhoneNum" Width="120"  />
                            <ext:Column ID="erp_code" runat="server" Text="班次" DataIndex="ShiftName" Width="120"  />
                ...
                <ext:Window ID="winAdd" runat="server" Icon="MonitorAdd" Closable="false" Title="添加MES管理信息"
                    ...
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5">
                            ...
                            <Items>
                                <ext:TextField ID="add_work_name" runat="server" FieldLabel="人员名称" LabelAlign="Left" MaxLength="50" AllowBlank=false IndicatorText="*" IndicatorCls="red-text">
                                
                                </ext:TextField>
                                <ext:TextField ID="add_hr_code" runat="server" FieldLabel="电话号码"   LabelAlign="Left" MaxLength="99" Enabled="true" />
                                  <ext:ComboBox ID="txtshift" runat="server" Flex="1" SelectOnTab="true" Editable="false" LabelAlign="Right" FieldLabel="班次">
