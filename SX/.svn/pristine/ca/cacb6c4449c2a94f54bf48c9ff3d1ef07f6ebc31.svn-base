...
namespace Mesnac.Util
{
    ...
    public class CommonUtil
    {
        ...
        #region "显示出错详细信息正用户页面(用户开发调试,在生产环境请设置为false)"
        /// <summary>
        /// 显示出错详细信息正用户页面(用户开发调试,在生产环境请设置为false)
        /// </summary>
