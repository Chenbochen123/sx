<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RubberTypeInfo.aspx.cs" Inherits="Manager_BasicInfo_RubberInfo_RubberTypeInfo" %>
...
<body>
    <form id="fmRubberType" runat="server">
        <ext:ResourceManager ID="rmRubberType" runat="server" />
        <ext:Viewport ID="vwUnit" runat="server" Layout="border">
            <Items>
                <ext:Panel ID="pnlRubberTypeTitle" runat="server" Region="North" AutoHeight="true">
                    <TopBar>
                    ...
                    <Items>
                        <ext:Panel ID="pnlRubberTypeQuery" runat="server" AutoHeight="true">
                            <Items>
                                <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container_1" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:TextField ID="txt_obj_id" Vtype="integer" runat="server" FieldLabel="胶料类别编号" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                                        <ext:Container ID="container_2" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:TextField ID="txt_rub_type_name" runat="server" FieldLabel="胶料类别名称" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="obj_id" runat="server" Text="胶料类别编号" DataIndex="ObjID" Width="220" />
                            <ext:Column ID="rubber_type_name" runat="server" Text="胶料类别名称" DataIndex="RubTypeName" Width="220" />
                            <ext:Column ID="delete_flag" runat="server" Text="删除标志" DataIndex="DeleteFlag" Width="150" Hidden="true" />
                            <ext:Column ID="remark" runat="server" Text="备注" DataIndex="Remark" Width="220" />
                ...
                <ext:Window ID="winModify" runat="server" Icon="MonitorEdit" Closable="false" Title="修改胶料类别信息"
                    ...
                    <Items>
                        <ext:FormPanel ID="pnlEdit" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                <ext:TextField ID="modify_obj_id" runat="server" FieldLabel="胶料类别编号" LabelAlign="Left" ReadOnly="true" Hidden="true" Enabled="true" />
                                <ext:TextField ID="modify_rub_type_name" runat="server" FieldLabel="胶料类别名称" MaxLength="25" AllowBlank="false" LabelAlign="Left" IsRemoteValidation="true" IndicatorText="*" IndicatorCls="red-text">
                                    <RemoteValidation OnValidation="CheckRubType" />
                                </ext:TextField>
                                <ext:TextField ID="modify_remark" runat="server" FieldLabel="备注" MaxLength="50" LabelAlign="Left" />
                            </Items>
                            <Listeners>
                ...
                <ext:Window ID="winAdd" runat="server" Icon="MonitorAdd" Closable="false" Title="添加胶料类别信息"
                    Width="320" Height="240" Resizable="false" Hidden="true" Modal="false" BodyStyle="background-color:#fff;"
                    BodyPadding="5" Layout="Form">
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5">
                            ...
                            <Items>
                                <ext:TextField ID="add_rub_type_name" runat="server" FieldLabel="胶料类别名称" MaxLength="25" AllowBlank="false" LabelAlign="Left" IsRemoteValidation="true" IndicatorText="*" IndicatorCls="red-text">
                                    <RemoteValidation OnValidation="CheckRubType" />
                                </ext:TextField>
                                <ext:TextField ID="add_remark" runat="server" FieldLabel="备注" MaxLength="50" LabelAlign="Left" />
                            </Items>
                            <Listeners>
                ...
                <ext:Hidden ID="hidden_rub_type_name" runat="server" />
