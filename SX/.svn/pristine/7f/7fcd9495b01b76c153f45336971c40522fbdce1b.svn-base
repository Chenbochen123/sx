...
public partial class Manager_RubberQuality_Manage_CheckRubberAssessQSReport : BasePage
{
    #region 权限定义
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!X.IsAjaxRequest)
        {
            ...
            scriptLink.Attributes.Add("src", "CheckRubberAssessQSReport.js?" + DateTime.Now.Ticks.ToString());
    ...
    private DataSet ReadDataSet()
    {
        ...
        DataSet ds = bQmtCheckAssessMasterManager.GetCheckRubberAssessQSQueryByParas(paras);
    ...
    protected void RowSelectionModel_SelectionChange(object sender, DirectEventArgs e)
    {
        ...
        DataSet ds = bQmtCheckAssessMasterManager.GetCheckRubberAssessQSReportByParas(paras);
        ...
        report.SetParameterValue("CheckClassName", shiftCheckGroupName + "班");
    ...
    protected void ButtonNorthExport_Click(object sender, EventArgs e)
    {
        ...
        using (System.IO.MemoryStream strm = new System.IO.MemoryStream())
        {
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=胶料考核快检报表.xlsx");
