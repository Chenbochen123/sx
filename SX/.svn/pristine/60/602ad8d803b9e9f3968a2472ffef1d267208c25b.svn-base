...
public partial class Manager_ProducingPlan_Statistics_ClassStatistics : Mesnac.Web.UI.Page
{
    ...
    private PageResult<PptLotData> GetPageResultData(PageResult<PptLotData> pageParams)
    {
        ...
        return pptLotDataManager.GetTablePageClassStatisticsBySql(queryParams);
    }
