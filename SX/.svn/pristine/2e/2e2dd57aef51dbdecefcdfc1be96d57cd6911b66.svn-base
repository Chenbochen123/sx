<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowActionAllUser.aspx.cs" Inherits="Manager_System_ShowRoleAction_ShowActionAllUser" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var getTitle = function (node) {
            ...
            Result = Result + node.data.ShowName + "-";
            return Result;
        }
                                ...
                                <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container_2" runat="server" Layout="FormLayout" ColumnWidth=".2" Padding="5">
                                            <Items>
                                                <ext:TextField ID="txt_hr_code" runat="server" FieldLabel="HR编码" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                                    </Items>
                                </ext:FormPanel>
                        ...
                        <ext:GridPanel ID="GridPanel1" runat="server" Flex="2" Region="Center" Collapsible="false" MultiSelect="false" FolderSort="true"
                            ...
                            <ColumnModel ID="columnModel" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="RemarkMode" DataIndex="Remark" runat="server" Text="备注" Flex="1" />
                                </Columns>
                            </ColumnModel>
                        </ext:GridPanel>
                        <ext:TreePanel ID="TreePanel1" runat="server" Flex="2" Region="West" Collapsible="false" RootVisible="false" MultiSelect="false"
                            ...
                            <ColumnModel>
                                <Columns>
                                    ...
                                    <ext:Column ID="Remark" DataIndex="Remark" runat="server" Sortable="false" Hideable="false" Text="权限备注" Flex="1" />
                                </Columns>
                            </ColumnModel>
                            <Listeners>
