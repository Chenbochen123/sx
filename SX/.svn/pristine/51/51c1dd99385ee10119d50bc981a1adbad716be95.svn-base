<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Department.aspx.cs" Inherits="Manager_BasicInfo_DepartmentInfo_Department" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        //-------部门-----查询带回弹出框--BEGIN
        var Manager_BasicInfo_CommonPage_QueryDepartmentErp_Request = function (record) {//部门返回值处理
            if (!App.winAdd.hidden) {
                App.add_erp_code.setValue(record.data.DepName);
                App.hidden_erp_code.setValue(record.data.ERPCode);
            }
            else if (!App.winModify.hidden) {
                App.modify_erp_code.setValue(record.data.DepName);
                App.hidden_erp_code.setValue(record.data.ERPCode);
            }
        }
        ...
        var SelectDepartment = function (field, trigger, index) {//部门查询
            switch (index) {
                case 0:
                    ...
                    break;
                case 1:
                    App.Manager_BasicInfo_CommonPage_QueryDepartmentErp_Window.show();
                    break;
            }
        }
        ...
        Ext.create("Ext.window.Window", {//部门查询带回窗体
            id: "Manager_BasicInfo_CommonPage_QueryDepartmentErp_Window",
            height: 460,
            hidden: true,
            width: 360,
            html: "<iframe src='../../BasicInfo/CommonPage/QueryDepartmentErp.aspx' width=100% height=100% scrolling=no  frameborder=0></iframe>",
...
<body>
    <form id="fmUnit" runat="server">
        ...
        <ext:Viewport ID="vwUnit" runat="server" Layout="BorderLayout">
                                ...
                                <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        ...
                                        <ext:Container ID="container_3" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:TextField ID="txt_erp_code" runat="server" FieldLabel="ERP编码" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                                    </Items>
                                </ext:FormPanel>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="dep_code" runat="server" Text="部门代码" DataIndex="DepCode" Width="80"  />
                            <ext:Column ID="dep_name" runat="server" Text="部门名称" DataIndex="DepName" Width="150"  />
                            <ext:Column ID="parent_num" runat="server" Text="父级部门" DataIndex="ParentNum" Width="150"  />
                            <ext:Column ID="erp_code" runat="server" Text="ERP编码" DataIndex="ERPCode" Width="80"  />
                         
                            <ext:Column ID="display_id" runat="server" Text="显示序号" DataIndex="DisplayId" Width="80" Hidden="true" />
                    ...
                    <Items> 
                        <ext:FormPanel ID="pnlEdit" runat="server" Flex="1" BodyPadding="5">
                            ...
                            <Items>
                                    ...
                                    <ext:ComboBox ID="modify_dep_level" runat="server" FieldLabel="部门层级" LabelAlign="Left" ReadOnly="true"  Hidden="true"/>
                                <ext:TextField ID="modify_parent_num" runat="server" FieldLabel="父级部门" LabelAlign="Left" ReadOnly="true"/>
                               
                               
                                <ext:TextField ID="modify_erp_code" runat="server" FieldLabel="erp编码" LabelAlign="Left" />
                                <ext:TextField ID="modify_display_id" runat="server" FieldLabel="显示序号" LabelAlign="Left" IsRemoteValidation="true"  Hidden="true">
                    ...
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" MonitorValid="true" BodyPadding="5">
                            ...
                            <Items>
                                ...
                                <ext:TextField ID="add_erp_code" runat="server" FieldLabel="ERP编码" LabelAlign="Left" />
                                <ext:TextField ID="add_display_id" runat="server" FieldLabel="显示序号" LabelAlign="Left"  IsRemoteValidation="true" Hidden="true">
                                    <RemoteValidation OnValidation="CheckFieldInt"></RemoteValidation>
                                </ext:TextField>
            ...
            <ext:Hidden ID="hidden_erp_code" runat="server"></ext:Hidden>
            </Items>
        </ext:Viewport>
    </form>
</body>
