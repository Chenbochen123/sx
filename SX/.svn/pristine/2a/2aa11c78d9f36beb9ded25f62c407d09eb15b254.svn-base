<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryFactoryType.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryFactoryType" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryFactoryType_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryFactoryType_Window.close();
            return false;
        }
                                ...
                                <ext:Container ID="container_Query" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container1" runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                                            <Items>
                                                <ext:TextField ID="txtFactoryTypeName" runat="server" FieldLabel="厂商类别名称" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                                    </Items>
                                </ext:Container>
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="FactoryTypeName" DataIndex="FactoryTypeName" runat="server" Text="厂商类别名称" Width="120" />
