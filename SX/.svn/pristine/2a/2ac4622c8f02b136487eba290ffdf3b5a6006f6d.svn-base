            ...
            <Items>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            <ext:Column ID="JL_code" runat="server" Text="JL_code" DataIndex="JL_code" Width="40" hidden="true"/>
                            <ext:Column ID="clEquip" runat="server" Text="编号" DataIndex="JL_IDNO" Width="100"/>
                            <ext:Column ID="clShiftName" runat="server" Text="代码" DataIndex="JL_code" Width="70"/>
                            <ext:Column ID="clClassName" runat="server" Text="名称" DataIndex="JL_name" Width="100"/>
                            ...
                            <ext:Column ID="Column2" runat="server" Text="录入人" DataIndex="UserName" Width="120"/>
                            ...
                            <ext:Column ID="DateColumn1" runat="server" Text="有效日期" DataIndex="YX_Date1" Width="120">
                                ...
                                <ext:FieldSet ID="FieldSet1" runat="server" Title="计量器具信息维护">
                                    <Items>
                                        ...
                                        <ext:FieldContainer ID="FieldContainer112"  runat="server" Layout="HBoxLayout"  AnchorHorizontal="100%">
                                            <Items>
                                                <ext:ComboBox ID="cbxHandleName" runat="server" Disabled="false" Width="208"  FieldLabel="录入人"/>
                                                 <%--<ext:FieldContainer ID="FieldContainer19" runat="server" FieldLabel="录入人">
                                                    <Items>
                                                        <ext:TextField ID="txtHandleName" runat="server" Width="100" />
                                                    </Items>
                                                </ext:FieldContainer>--%>
                                                 <ext:DateField ID="txtMemNote" runat="server" FieldLabel="检定日期" Width="208"  Editable="false"  AllowBlank="false"/>
                                        ...
                                        <ext:FieldContainer ID="FieldContainer21"  runat="server" Layout="HBoxLayout"  AnchorHorizontal="100%">
                                            <Items>
                                                <ext:DateField ID="txtYXdate" runat="server" FieldLabel="有效日期" Width="208" Editable="false"  AllowBlank="false"/>
                                                <ext:DateField ID="txtConfirmDate" runat="server" FieldLabel="确认日期" Width="208"  Editable="false"  AllowBlank="false" />
                                        ...
                                        <ext:FieldContainer ID="FieldContainer24"  runat="server" Layout="HBoxLayout"  AnchorHorizontal="100%">
                                            <Items>
                                                <ext:DateField ID="txtBeginDate" runat="server" FieldLabel="启用日期" Width="208"  Editable="false"  AllowBlank="false"/>
                                                <ext:DateField ID="txtLastCheckDate" runat="server" FieldLabel="最后检定日期" Width="208" Editable="false"  AllowBlank="false"/>
