<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryDepartment.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryDepartment" %>
...
<head id="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        //window.onload = function () { alert(parent.document.getElementById("Manager_BasicInfo_CommonPage_QueryDepartment_Window").getElementsByTagName("iframe")[0].contentWindow == window); };
...
//        };
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryDepartment_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryDepartment_Window.close();
            return false;
        }
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="dep_code" runat="server" Text="部门代码" DataIndex="DepCode" Width="70"  />
                            <ext:Column ID="dep_name" runat="server" Text="部门名称" DataIndex="DepName" Width="90"  />
                            <ext:Column ID="dep_level" runat="server" Text="部门层级" DataIndex="DepLevel" Width="90"  />
