<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StoreNow.aspx.cs" Inherits="Manager_Rubber_StoreNow" %>
            ...
            <Items>
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server" ID="barStopType">
                            <Items>
                                ...
                                <ext:ToolbarSeparator />
                                <ext:Button runat="server" Icon="Find" Text="未使用物料查询" ID="StoreNow">
                                    <ToolTips><ext:ToolTip ID="ToolTip2" runat="server" Html="点击进行查询" /></ToolTips>
                                    <DirectEvents><Click OnEvent="ShiftConfig_Click">
                                        <EventMask ShowMask="true" Target="Page"></EventMask>
                                    </Click></DirectEvents>
                                </ext:Button>
                            </Items>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="Barcode" runat="server">
                        <Columns>
                            <ext:Column ID="JL_code" runat="server" Text="Barcode" DataIndex="Barcode" Width="40" hidden="true"/>
                            <ext:Column ID="clStartTime" runat="server" Text="物料名称" DataIndex="mater_name"  Width="140"/>
                            <ext:Column ID="clEndTime" runat="server" Text="数量" DataIndex="num"  Width="140"/>
                            <ext:Column ID="Column1" runat="server" Text="库存重量" DataIndex="weight"  Width="140" />
                        </Columns>
                    </ColumnModel>
                    <SelectionModel>
