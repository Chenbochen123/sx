<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Detail.aspx.cs" Inherits="Manager_Technology_ProductReview_Detail" %>
                                        ...
                                        <ColumnModel ID="ColumnModel3" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column ID="Column17" DataIndex="WeighType" runat="server" Text="物料类型" Width="120"
                                                    Sortable="true">
                                                    <Renderer Handler="if (!value){return ''};if (value==1) {return '炭黑';}  else if (value==2) {return '油';} else if (value==3) {return '胶料';} else if (value==4) {return '小料';} else {return value;}" />
                                                </ext:Column>
