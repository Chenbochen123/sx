<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AlarmItem.aspx.cs" Inherits="Manager_Equipment_AlarmItem" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_edit = function (record) {
            ...
            App.TextField6.setValue(record.data.AlarmNo);
            App.TextField7.setValue(record.data.AlarmName);
            App.TextField8.setValue(record.data.AlarmAddress);
            App.TextField9.setValue(record.data.Remark);

            App.NumberField1.setValue(record.data.ZiAddress);
            App.NumberField2.setValue(record.data.WeiAddress);
    ...
    <form id="fmUnit" runat="server">
        ...
        <ext:Viewport ID="vwUnit" runat="server" Layout="border">
            <Items>
                                ...
                                <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container_1" runat="server" Layout="FormLayout" ColumnWidth=".33"
                                            Padding="5">
                                            <Items>
                                                <ext:TextField ID="txt_obj_id" Vtype="integer" runat="server" FieldLabel="物料名称" LabelAlign="Right"  Hidden ="true"/>
                                            </Items>
                                        </ext:Container>
                ...
                <ext:GridPanel ID="pnlList" runat="server" Region="Center">
                            ...
                            <Model>
                                <ext:Model ID="model" runat="server">
                                    <Fields>
                                        ...
                                        <ext:ModelField Name="ZiAddress" />
                                         <ext:ModelField Name="WeiAddress" />
                               
                                           <ext:ModelField Name="AlarmNo" />
                                                <ext:ModelField Name="AlarmName" />
                                        <ext:ModelField Name="AlarmAddress" />
                    ...
                    <ColumnModel ID="colModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="ZiAddress" runat="server" Text="字地址" DataIndex="ZiAddress" Width="150"  />
                            <ext:Column ID="WeiAddress" runat="server" Text="位地址" DataIndex="WeiAddress" Width="150"  />
                             <ext:Column ID="AlarmNo" runat="server" Text="报警编号" DataIndex="AlarmNo" Width="150"  />
                              <ext:Column ID="AlarmName" runat="server" Text="报警名称" DataIndex="AlarmName" Width="150"  />
                               <ext:Column ID="AlarmAddress" runat="server" Text="报警地址" DataIndex="AlarmAddress" Width="150"  />
                ...
                <ext:Window ID="winAdd" runat="server" Icon="MonitorAdd" Closable="false" Title="添加报警信息"
                    ...
                    <Items>
                        <ext:FormPanel ID="pnlAdd" runat="server" BodyPadding="5">
                            ...
                            <Items>
                                ...
                                <ext:NumberField ID="TextField0" runat="server" FieldLabel="字地址" LabelAlign="Left" />
                                <ext:NumberField ID="TextField1" runat="server" FieldLabel="位地址" LabelAlign="Left" />
                                <ext:TextField ID="TextField2" runat="server" FieldLabel="报警编号" LabelAlign="Left" />
                                <ext:TextField ID="TextField3" runat="server" FieldLabel="报警名称" LabelAlign="Left" />
                                <ext:TextField ID="TextField4" runat="server" FieldLabel="报警地址" LabelAlign="Left" />
                                <ext:TextField ID="TextField5" runat="server" FieldLabel="备注" LabelAlign="Left" />
