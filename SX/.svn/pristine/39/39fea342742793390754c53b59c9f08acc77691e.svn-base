<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryShiftClass.aspx.cs" Inherits="Manager_BasicInfo_CommonPage_QueryShiftClass" %>
...
<head id="head" runat="server">
    ...
    <script type="text/javascript">
        var response = function (command, record) {
            parent.Manager_BasicInfo_CommonPage_QueryShiftClass_Request(record);
            parent.App.Manager_BasicInfo_CommonPage_QueryShiftClass_Window.close();
            return false;
        }
                                ...
                                <ext:Container ID="container_Query" runat="server" Layout="ColumnLayout" AutoHeight="true">
                                    <Items>
                                        <ext:Container ID="container1" runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                                            <Items>
                                                <ext:TextField ID="txt_shiftclass_name" runat="server" FieldLabel="班组名称" LabelAlign="Right" />
                                            </Items>
                                        </ext:Container>
                                    </Items>
                                </ext:Container>
                ...
                <ext:GridPanel ID="gridPanelCenter" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="obj_id" runat="server" Text="班组编号" DataIndex="ObjID" Width="70"  />
                            <ext:Column ID="dep_name" runat="server" Text="班组名称" DataIndex="ClassName" Width="90"  />
