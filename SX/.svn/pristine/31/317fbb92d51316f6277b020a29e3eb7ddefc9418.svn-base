<%@ page language="C#" autoeventwireup="true" inherits="Manager_BasicInfo_MaterialInfo_MaterialInfo, App_Web_mbidu024" %>
...
//                }
    ...
    <script type="text/javascript">
        ...
        var commandcolumn_direct_edit = function (record) {
            ...
            App.direct.commandcolumn_direct_edit(MaterialCode, browser, {
...
<%--                        <ext:Column ID="material_group" runat="server" Text="物料分组" DataIndex="MaterialGroup"
                        ...
                        <ext:Column ID="user_code" runat="server" Text="用户自定代码" DataIndex="UserCode" Width="160" />
                                ...
                                <Items>
                                    <ext:FieldSet ID="FieldSet3" runat="server" Title="基本信息" Layout="AnchorLayout" DefaultAnchor="100%"
                                        ...
                                        <Items>
                                            ...
                                            <ext:FieldSet ID="FieldSet4"  runat="server" Title="其他信息" Layout="AnchorLayout" DefaultAnchor="100%" Pmodifying="5">
                                                <Items>--%>
                                      <%--      <ext:Container ID="Container21" runat="server" Layout="HBoxLayout" MarginSpec="5 5 5 5">
                                                <Items>
                                                    <ext:NumberField ID="modify_valid_date" runat="server" Flex="1" FieldLabel="保质期" Vtype="integer"
                                                        LabelAlign="Right" Enabled="true" IndicatorText="天" />
                                                </Items>
                                            </ext:Container>--%>
                                            ...
                                            <ext:Container ID="Container24" runat="server" Layout="HBoxLayout" MarginSpec="5 5 5 5">
                                                <Items>
    ...
    <ext:TextField ID="add_price_code" runat="server" Flex="1" FieldLabel="价格" MaxLength="10"
                                        ...
                                        <ext:FieldSet ID="FieldSet2"  runat="server" Title="其他信息" Layout="AnchorLayout" DefaultAnchor="100%" Padding="5">
                                            ...
                                            <ext:Container ID="Container10" runat="server" Layout="HBoxLayout" MarginSpec="5 5 5 5">
                                                <Items>
                                                    <ext:TextField ID="add_user_code" runat="server" Flex="1" FieldLabel="用户代码" MaxLength="20"
                                                        LabelAlign="Right" Enabled="true" />
