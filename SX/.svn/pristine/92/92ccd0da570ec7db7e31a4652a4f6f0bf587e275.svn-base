...
namespace Mesnac.Util.Module.ErrorLogModule
{
    public static class FileTxtLogs
    {
        ...
        /// 日志目录
        /// </summary>
        public static string LogPath = CommonUtil.LogDir;
        ...
        {
            return WriteLog(input, "AppError", CommonUtil.GetIPAddress(), CommonUtil.GetScriptUrl);
        }
        ...
        public static bool WriteLog(string input, string FileName, string ip, string url)
        {
            ...
            try
            {
                ...
                if (logFile.Exists)
                {
                    ...
                    {
                        logFile.CopyTo(filePath.Replace("Log.txt", CommonUtil.RndNum(5) + "Log.txt"));
