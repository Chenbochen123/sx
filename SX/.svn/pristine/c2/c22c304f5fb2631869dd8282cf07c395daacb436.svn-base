<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlanMonitoring.aspx.cs" Inherits="Manager_ProducingPlan_PlanExecMonitoring_PlanMonitoring" %>
...
<body>
        ...
        <Model>
            <ext:Model ID="Model1" runat="server" Name="gridPanelZaoStoreModel" IDProperty="PlanID">
                <Fields>
                    ...
                    <ext:ModelField Name="RealEndtime"  Mapping="RealEndtime" />
                    <ext:ModelField Name="PlanID" Type="String" Mapping="PlanID" />
                    <ext:ModelField Name="Mem_note" Type="String" Mapping="Mem_note" />
                    <ext:ModelField Name="RealStartTime" Mapping="RealStartTime" />
                </Fields>
            </ext:Model>
        </Model>
    </ext:Store>
                        ...
                        <Items>
                            <ext:Panel ID="Zao" runat="server" Region="Center" AutoScroll="true">
                                ...
                                <Items>
                                    ...
                                    <ext:GridPanel ID="ZaoPlanGridPanel" Height="400" runat="server" Frame="true" StoreID="ZaoPlanStore"
                                        ...
                                        <ColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column ID="Column7" runat="server" Text="开始时间" DataIndex="RealStartTime"
                                                    Width="180">
                                                </ext:Column>
                                                <ext:Column ID="SummaryColumn6" runat="server" Text="完成时间" DataIndex="RealEndtime"
                                                    Width="180">
                                                </ext:Column>
                                                  <ext:Column ID="Column8" runat="server" Width="90" Text="差异原因" DataIndex="Mem_note">
                                                </ext:Column>
                                        ...
                                        <ColumnModel ID="ColumnModel4" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column ID="Column3" runat="server" DataIndex="RealPlanNum" Width="90" Text="完成数/计划数">
                                                   ...
                                                   <ext:Column ID="Column9" runat="server" Text="开始时间" DataIndex="RealStartTime"
                                                    Width="180">
                                                </ext:Column>
                                                <ext:Column ID="Column6" runat="server" Text="完成时间" DataIndex="RealEndtime" Width="180">
                                                </ext:Column>
                                                     <ext:Column ID="Column11" runat="server" Width="90" Text="差异原因" DataIndex="Mem_note">
                                                </ext:Column>
                            ...
                            <ext:Panel ID="Ye" runat="server" AutoScroll="true" Region="Center">
                                ...
                                <Items>
                                    ...
                                    <ext:GridPanel ID="YeGridPanel" Height="400" runat="server" Frame="true" StoreID="YePlanStore"
                                        ...
                                        <ColumnModel ID="ColumnModel2" runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column ID="Column4" runat="server" DataIndex="RealPlanNum" Width="90" Text="完成数/计划数">
                                                   ...
                                                   <ext:Column ID="Column10" runat="server" Text="开始时间" DataIndex="RealStartTime"
                                                    Width="180">
                                                </ext:Column>
                                                <ext:Column ID="Column5" runat="server" Text="完成时间" DataIndex="RealEndtime" Width="180">
                                                </ext:Column>
                                                     <ext:Column ID="Column12" runat="server" Width="90" Text="差异原因" DataIndex="Mem_note">
                                                </ext:Column>
    ...
    <ext:Window ID="winModify" runat="server" Icon="MonitorEdit" Closable="false" Title="计划执行详情信息"
        Width="300" Height="400" Resizable="false" Hidden="true" Modal="false" BodyStyle="background-color:#fff;"
                ...
                <Items>
                    ...
                    <ext:TextField ID="txtRealWeight" runat="server" FieldLabel="实际完成重量" LabelAlign="Left"
                        AllowBlank="false" Disabled="true" MaskRe="/[0-9\$\.]/" />
                          <ext:TextField ID="TextNote"  runat="server"  FieldLabel="差异原因"
                        LabelAlign="Left" />
