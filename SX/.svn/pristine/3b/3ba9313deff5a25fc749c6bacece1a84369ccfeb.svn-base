<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReturnRubber.aspx.cs" Inherits="Manager_Rubber_ReturnRubber" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        Ext.create("Ext.window.Window", {//物料带窗体
            ...
            hidden: true,
            width: 360,
            html: "<iframe src='../BasicInfo/CommonPage/QueryMaterial.aspx?MajorTypeID=6' width=100% height=100% scrolling=no  frameborder=0></iframe>",
            bodyStyle: "background-color: #fff;",
            closable: true,
            title: "请选择物料",
            modal: true
                    ...
                    <TopBar>
                        <ext:Toolbar runat="server" ID="tbReturnRubber">
                            <Items>
                                ...
                                <ext:Button runat="server" Icon="LockEdit" Text="返回胶审核" ID="Button1" Hidden="true">
                                    <%--<Listeners>
                                ...
                                <ext:Button runat="server" Icon="LockEdit" Text="撤销返回" ID="Button2" Hidden="true">
                                    <Listeners>
                        ...
                        <ext:FormPanel ID="container_top" runat="server" Layout="ColumnLayout" AutoHeight="true">
                            <Items>
                                ...
                                <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth=".25"
                                    ...
                                    <Items>
                                      <ext:DateField ID="txtEndTime" runat="server" FieldLabel="结束时间" LabelAlign="Right" />
                                        <ext:ComboBox ID="cbxEquip" Editable="false" runat="server" OnDirectChange="cbxChejian_change" FieldLabel="返回部门" LabelAlign="Right" />
                                ...
                                <ext:Container ID="container4" runat="server" Layout="FormLayout" ColumnWidth=".25" Padding="5">
                                    <Items>
                                        <ext:ComboBox ID="cbxInStock" OnDirectChange="cbxInStock_change" runat="server" FieldLabel="是否入库" LabelAlign="Right" Hidden="true">
                                            <SelectedItems>
                                            ...
                                            <Items>
                                              ...
                                              <ext:ComboBox ID="cbxChejian" runat="server" OnDirectChange="cbxChejian_change" FieldLabel="分厂名称" LabelAlign="Right" Hidden="true">
                                            <Items>
                                                <ext:ListItem Text="全部" Value="all"></ext:ListItem>
                                                  <ext:ListItem Text="一厂" Value="11"></ext:ListItem>
                        ...
                        <ColumnModel ID="colModel" runat="server">
                            <Columns>
                               ...
                               <%-- <ext:Column ID="WorkShopName" runat="server" Text="分厂" DataIndex="WorkShopName" Flex="1" />--%>
                                ...
                                <ext:Column ID="BarcodeStart" runat="server" Text="开始车次" DataIndex="BarcodeStart" Flex="1"  Width="40"/>
                                <ext:Column ID="BarcodeEnd" runat="server" Text="截止车次" DataIndex="BarcodeEnd" Flex="1"  Width="40"/>
                                <ext:Column ID="MadeLine" runat="server" Text="接受部门" DataIndex="DepName" Width="150" />
                                    <ext:Column ID="Column2" runat="server" Text="返回部门" DataIndex="DepName2" Width="150" />
                                <ext:Column ID="MaterialName" runat="server" Text="物料名称" DataIndex="MaterialName" Width="160" />
                          ...
                          <%--         <ext:Column ID="Column1" runat="server" Text="返回原因" DataIndex="ReturnReason" Flex="1"   Hidden="true"/>--%>
                             <%--   <ext:Column ID="ScanPerson" runat="server" Text="扫描人" DataIndex="ScanPerson" Flex="1"   Hidden="true"/>--%>
                            ...
                            <ext:RowSelectionModel ID="rowSelectMuti" runat="server" Mode="Single">
                                <DirectEvents>
                                    <SelectionChange OnEvent="rowSelectMuti_SelectionChange">
                                        <ExtraParams>
                                            <ext:Parameter Name="StockInSign" Value="selected[0].get('StockInSign')" Mode="Raw" />
