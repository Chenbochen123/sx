...
left join Pmt_equip t4 on t4.Equip_code=t1.Equip_Code");
        ...
        if (!string.IsNullOrEmpty(hiddenRecipeEquipCode.Text))
        {
            sb.AppendLine("AND t1.Equip_Code='" + hiddenRecipeEquipCode.Text + "'");
        }
        #endregion
...
left join Ppt_ShiftClass t3 on t3.shift_ClassId = t.shift");
        ...
        if (!string.IsNullOrEmpty(hiddenRecipeEquipCode.Text))
        {
            sb.AppendLine("AND t.equip_Code='" + hiddenRecipeEquipCode.Text + "'");
        }
        #endregion
