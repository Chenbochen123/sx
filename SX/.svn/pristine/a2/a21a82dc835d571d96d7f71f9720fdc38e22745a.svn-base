...
public partial class Manager_Equipment_Yunzhuan : Mesnac.Web.UI.Page
{
    ...
    public System.Data.DataSet GetDataByParas()
    {
        ...
        #region
        sb.AppendLine(@"exec proc_EquipRunRate '" + daDateTime.SelectedDate.ToShortDateString() + "','" + daDateTimeEnd.SelectedDate.ToShortDateString() + "',0");
    ...
    protected void btnExportSubmit_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            new Mesnac.Util.Excel.ExcelDownload().ExcelFileDown(ds, "设备运转率");
        }
    }
